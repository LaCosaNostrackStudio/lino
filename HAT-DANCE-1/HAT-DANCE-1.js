...
lib.ssMetadata = [
		{name:"HAT_DANCE_1_atlas_", frames: [[0,0,1920,1080],[1922,0,82,82],[1810,1557,164,40],[1401,1669,206,68],[1401,1391,251,164],[1654,1391,251,164],[1401,1225,251,164],[1654,1225,251,164],[1401,1557,407,58],[1401,1082,523,141],[0,1082,1399,802],[1401,1617,470,50]]}
];
...
(lib.bgjpgcopy = function() {
	this.spriteSheet = ss["HAT_DANCE_1_atlas_"];
	this.gotoAndStop(0);
...
(lib.Symbol53 = function(mode,startPosition,loop) {
	...
	this.shape.graphics.f("#000000").s().p("AsTIoQlGh7gBivQABivFGh7QBtgpB7gcQgBkYBzicQByidDqAnQDqAmCtgSQCtgSAJIcQCeAeCGAzQFHB7AACvQAACvlHB7QlGB8nOAAQnNAAlGh8g");
	this.shape.setTransform(111.5,67.6);

	this.timeline.addTween(cjs.Tween.get(this.shape).wait(1));

}).prototype = getMCSymbolPrototype(lib.Symbol53, new cjs.Rectangle(0,0,222.9,135.2), null);
...
(lib.Symbol12_1 = function(mode,startPosition,loop) {
	...
	this.instance.parent = this;
	this.instance.setTransform(-117,-53);

	this.instance_1 = new lib.Bitmap28();
	this.instance_1.parent = this;
	this.instance_1.setTransform(-117,-53);

	this.instance_2 = new lib.Bitmap29();
	this.instance_2.parent = this;
	this.instance_2.setTransform(-117,-53);

	this.instance_3 = new lib.Bitmap30();
	this.instance_3.parent = this;
	this.instance_3.setTransform(-117,-53);
	...
	this.instance_4.setTransform(7.6,28,1,1,0,0,0,111.5,67.6);

	this.timeline.addTween(cjs.Tween.get(this.instance_4).wait(4));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(-117,-53,288.4,164);
...
// stage content:
(lib.HATDANCE1 = function(mode,startPosition,loop) {
	this.initialize(mode,startPosition,loop,{});
	...
	this.bt13.setTransform(-211.9,447.9,0.984,0.984,0,0,0,-0.1,0);

	this.bt12 = new lib.Symbol12_1();
	this.bt12.parent = this;
	this.bt12.setTransform(-444.3,381.1,0.974,0.974,0,0,0,-0.1,0.1);

	this.bt11 = new lib.Symbol12_1();
	this.bt11.parent = this;
	this.bt11.setTransform(-655,452.1,0.942,0.942,0,0,0,-0.2,0.1);
	...
	this.bt10.setTransform(-877.9,409.1,0.986,0.986,0,0,0,-0.2,0.1);

	this.bt9 = new lib.Symbol12_1();
	this.bt9.parent = this;
	this.bt9.setTransform(-1111,389.6,0.888,0.888,0,0,0,0,0.3);

	this.bt8 = new lib.Symbol12_1();
	this.bt8.parent = this;
	this.bt8.setTransform(-285.6,210.9,1.06,1.06,0,0,0,-0.1,0.1);

	this.bt7 = new lib.Symbol12_1();
	this.bt7.parent = this;
	this.bt7.setTransform(421.2,491.1,0.767,0.767,0,0,0,2.5,25.7);

	this.bt6 = new lib.Symbol12_1();
	this.bt6.parent = this;
	this.bt6.setTransform(651.2,540.2,0.772,0.772);

	this.bt5 = new lib.Symbol12_1();
	this.bt5.parent = this;
	this.bt5.setTransform(879.6,466.2,0.821,0.821,0,0,0,-0.1,0.2);

	this.bt4 = new lib.Symbol12_1();
	this.bt4.parent = this;
	this.bt4.setTransform(934.3,297.7,0.886,0.886,0,0,0,0,0.3);

	this.bt3 = new lib.Symbol12_1();
	this.bt3.parent = this;
	this.bt3.setTransform(793.4,121.6,0.909,0.908,0,0,0,-0.3,0.5);

	this.bt2 = new lib.Symbol12_1();
	this.bt2.parent = this;
	this.bt2.setTransform(498.5,121.5,0.906,0.906);

	this.bt1 = new lib.Symbol12_1();
	this.bt1.parent = this;
	this.bt1.setTransform(328.2,290.2,0.868,0.868,0,0,0,-0.1,0.1);
	...
	// Layer 3
	this.instance_1 = new lib.bgjpgcopy();
	this.instance_1.parent = this;
...
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/HAT_DANCE_1_atlas_.png?1653663692837", id:"HAT_DANCE_1_atlas_"},
		{src:"sounds/CORNETAPERDIO.mp3?1653663692911", id:"CORNETAPERDIO"},
		{src:"sounds/CORNETAUNAVEZ.mp3?1653663692911", id:"CORNETAUNAVEZ"},
		{src:"https://code.jquery.com/jquery-2.2.4.min.js?1653663692911", id:"lib/jquery-2.2.4.min.js"},
		{src:"components/sdk/anwidget.js?1653663692911", id:"sdk/anwidget.js"},
		{src:"components/video/src/video.js?1653663692911", id:"an.Video"}
	],
	preloads: []
};
