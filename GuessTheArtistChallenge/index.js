...
lib.ssMetadata = [
		{name:"index_atlas_1", frames: [[3025,804,82,82],[3109,804,164,40],[2817,804,206,68],[1936,804,407,58],[3337,699,523,141],[1936,0,1399,802],[2345,804,470,50],[3862,699,200,148],[0,0,1934,1289],[3337,0,697,697]]}
];
...
if (reversed == null) { reversed = false; }
	...
	this.etiketa = new cjs.Text("", "90px 'Impact'", "#6600FF");
	this.etiketa.name = "etiketa";
	this.etiketa.textAlign = "center";
	this.etiketa.lineHeight = 112;
	this.etiketa.lineWidth = 119;
	this.etiketa.parent = this;
	this.etiketa.setTransform(-5.5547,-31.9068,1.777,1.6799);
	...
	this.instance.setTransform(-183,-133,0.5073,0.5073);
...
p.nominalBounds = new cjs.Rectangle(-183,-133,354.4,353.6);
...
if (reversed == null) { reversed = false; }
	...
	this.bt10.name = "bt10";
	this.bt10.setTransform(1124.95,487.9,0.8676,0.8676,0,0,0,-0.1,0.1);

	this.bt9 = new lib.Symbol12();
	this.bt9.name = "bt9";
	this.bt9.setTransform(858.25,487.25,0.8676,0.8676,0,0,0,-0.1,0.1);

	this.bt8 = new lib.Symbol12();
	this.bt8.name = "bt8";
	this.bt8.setTransform(620.85,487.25,0.8676,0.8676,0,0,0,-0.1,0.1);
	...
	this.bt6.name = "bt6";
	this.bt6.setTransform(141.75,487.25,0.8676,0.8676,0,0,0,-0.1,0.1);

	this.bt5 = new lib.Symbol12();
	this.bt5.name = "bt5";
	this.bt5.setTransform(924.95,281.95,0.8676,0.8676,0,0,0,-0.1,0.1);

	this.bt4 = new lib.Symbol12();
	this.bt4.name = "bt4";
	this.bt4.setTransform(607.7,281.95,0.8676,0.8676,0,0,0,-0.1,0.1);

	this.bt3 = new lib.Symbol12();
	this.bt3.name = "bt3";
	this.bt3.setTransform(302.15,281.95,0.8676,0.8676,0,0,0,-0.1,0.1);

	this.bt2 = new lib.Symbol12();
	this.bt2.name = "bt2";
	this.bt2.setTransform(747.25,83,0.8676,0.8676,0,0,0,-0.1,0.1);
	...
	this.bt1.name = "bt1";
	this.bt1.setTransform(438.3,83,0.8676,0.8676,0,0,0,-0.1,0.1);
	...
	this.instance_2.setTransform(-34,-89,0.6927,0.6927);
...
p.nominalBounds = new cjs.Rectangle(-475.5,-231.8,1820.3,1143.9);
// library properties:
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/index_atlas_1.png?1773240879043", id:"index_atlas_1"},
		{src:"sounds/CORNETAPERDIO.mp3?1773240879155", id:"CORNETAPERDIO"},
		{src:"sounds/CORNETAUNAVEZ.mp3?1773240879155", id:"CORNETAUNAVEZ"},
		{src:"https://code.jquery.com/jquery-3.4.1.min.js?1773240879155", id:"lib/jquery-3.4.1.min.js"},
		{src:"components/sdk/anwidget.js?1773240879155", id:"sdk/anwidget.js"},
		{src:"components/video/src/video.js?1773240879155", id:"an.Video"}
	],
	preloads: []
};
