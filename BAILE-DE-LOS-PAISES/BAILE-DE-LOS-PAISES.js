...
lib.ssMetadata = [
		{name:"BAILE_DE_LOS_PAISES_atlas_", frames: [[0,0,1920,1080],[1401,1407,82,82],[1810,1225,164,40],[1401,1337,206,68],[1401,1225,407,58],[1401,1082,523,141],[0,1082,1399,802],[1401,1285,470,50]]}
];
...
(lib.bgrekrea2022banderas = function() {
	this.spriteSheet = ss["BAILE_DE_LOS_PAISES_atlas_"];
	this.gotoAndStop(0);
...
// stage content:
(lib.BAILEDELOSPAISES = function(mode,startPosition,loop) {
	this.initialize(mode,startPosition,loop,{});
...
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/BAILE_DE_LOS_PAISES_atlas_.png?1653657360555", id:"BAILE_DE_LOS_PAISES_atlas_"},
		{src:"sounds/CORNETAPERDIO.mp3?1653657360639", id:"CORNETAPERDIO"},
		{src:"sounds/CORNETAUNAVEZ.mp3?1653657360639", id:"CORNETAUNAVEZ"},
		{src:"https://code.jquery.com/jquery-2.2.4.min.js?1653657360639", id:"lib/jquery-2.2.4.min.js"},
		{src:"components/sdk/anwidget.js?1653657360639", id:"sdk/anwidget.js"},
		{src:"components/video/src/video.js?1653657360639", id:"an.Video"}
	],
	preloads: []
};
