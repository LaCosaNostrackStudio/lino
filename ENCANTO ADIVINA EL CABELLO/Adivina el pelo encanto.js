...
lib.ssMetadata = [
		{name:"Adivina el pelo encanto_atlas_", frames: [[1568,1407,82,82],[1810,1225,164,40],[1568,1337,206,68],[1401,1337,165,140],[1401,1479,165,140],[1401,1621,165,140],[1401,1763,165,140],[1401,1225,407,58],[1401,1082,523,141],[0,1082,1399,802],[1401,1285,470,50],[0,0,1920,1080]]}
];
...
(lib.Bitmap10 = function() {
	this.spriteSheet = ss["Adivina el pelo encanto_atlas_"];
	this.gotoAndStop(0);
...
(lib.EditableENCANTOAdivinaelcabelloremodelado = function() {
	this.spriteSheet = ss["Adivina el pelo encanto_atlas_"];
	this.gotoAndStop(11);
}).prototype = p = new cjs.Sprite();
// helper functions:
...
(lib.Symbol12 = function(mode,startPosition,loop) {
	...
	this.etiketa = new cjs.Text("", "55px 'Arial'", "#FFFFFF");
	this.etiketa.name = "etiketa";
	this.etiketa.textAlign = "center";
	this.etiketa.lineHeight = 63;
	this.etiketa.lineWidth = 119;
	this.etiketa.parent = this;
	this.etiketa.setTransform(12.9,-13,1.777,1.68);
	this.etiketa.shadow = new cjs.Shadow("rgba(255,204,0,1)",0,0,12);
	...
	this.instance.parent = this;
	this.instance.setTransform(-71,-32);

	this.shape = new cjs.Shape();
	this.shape.graphics.f("#FFF7F7").s().p("AowOVIoQuSIImuXIRTAAIIIObIo9OOgAvaAIIHgM6IPUAAIIFtJInjs+IvZAAg");
	this.shape.setTransform(11.2,38.9);

	this.shape_1 = new cjs.Shape();
	this.shape_1.graphics.f("#9A33CC").s().p("An8NEIngs5IH9tOIPZAAIHjM+IoFNJgAs3AFIGPKzINBAAIGiqnImkrTIsnAAg");
	this.shape_1.setTransform(11.4,38.7);
	...
	this.shape_2.graphics.f("#35CCC5").s().p("An8NEIngs5IH9tOIPZAAIHjM+IoFNJgAs3AFIGPKzINBAAIGiqnImkrTIsnAAg");
	...
	this.shape_3.graphics.f("#CB6798").s().p("An8NEIngs5IH9tOIPZAAIHjM+IoFNJgAs3AFIGPKzINBAAIGiqnImkrTIsnAAg");
	...
	this.shape_4.graphics.f("#FFCF32").s().p("An8NEIngs5IH9tOIPZAAIHjM+IoFNJgAs3AFIGPKzINBAAIGiqnImkrTIsnAAg");
	this.shape_4.setTransform(11.4,38.7);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.shape_1},{t:this.shape},{t:this.instance}]}).to({state:[{t:this.shape},{t:this.shape_2},{t:this.instance_1}]},1).to({state:[{t:this.shape},{t:this.shape_3},{t:this.instance_2}]},1).to({state:[{t:this.shape},{t:this.shape_4},{t:this.instance_3}]},1).wait(1));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(-118.9,-52.7,290.3,204.5);
...
(lib.Symbol12_1 = function(mode,startPosition,loop) {
	...
	this.shape_5.graphics.f().s("#000000").ss(12.1,1,1).p("ACKClIkTAAIAAlJ");
	this.shape_5.setTransform(13.8,16.5);
...
(lib.Symbol2 = function(mode,startPosition,loop) {
	...
	this.instance_2.parent = this;
	this.instance_2.setTransform(491.5,-150.8,1.183,0.749,0,0,0,523.6,0);
...
// stage content:
(lib.Adivinaelpeloencanto = function(mode,startPosition,loop) {
	this.initialize(mode,startPosition,loop,{});
	...
	this.bt25.setTransform(-438.2,352.8,0.868,0.868,0,0,0,-0.1,0.1);

	this.bt24 = new lib.Symbol12();
	this.bt24.parent = this;
	this.bt24.setTransform(-566.9,352.8,0.868,0.868,0,0,0,-0.1,0.1);

	this.bt23 = new lib.Symbol12();
	this.bt23.parent = this;
	this.bt23.setTransform(-698.4,352.8,0.868,0.868,0,0,0,-0.1,0.1);

	this.bt22 = new lib.Symbol12();
	this.bt22.parent = this;
	this.bt22.setTransform(-826.8,352.8,0.868,0.868,0,0,0,-0.1,0.1);

	this.bt21 = new lib.Symbol12();
	this.bt21.parent = this;
	this.bt21.setTransform(-956.8,352.8,0.868,0.868,0,0,0,-0.1,0.1);

	this.bt20 = new lib.Symbol12();
	this.bt20.parent = this;
	this.bt20.setTransform(-428.6,165.9,0.868,0.868,0,0,0,-0.1,0.1);

	this.bt19 = new lib.Symbol12();
	this.bt19.parent = this;
	this.bt19.setTransform(-557.3,165.9,0.868,0.868,0,0,0,-0.1,0.1);

	this.bt18 = new lib.Symbol12();
	this.bt18.parent = this;
	this.bt18.setTransform(-688.9,165.9,0.868,0.868,0,0,0,-0.1,0.1);

	this.bt17 = new lib.Symbol12();
	this.bt17.parent = this;
	this.bt17.setTransform(-817.3,165.9,0.868,0.868,0,0,0,-0.1,0.1);

	this.bt16 = new lib.Symbol12();
	this.bt16.parent = this;
	this.bt16.setTransform(-947.3,165.9,0.868,0.868,0,0,0,-0.1,0.1);

	this.bt15 = new lib.Symbol12();
	this.bt15.parent = this;
	this.bt15.setTransform(-947.3,-6.9,0.868,0.868,0,0,0,-0.1,0.1);

	this.bt14 = new lib.Symbol12();
	this.bt14.parent = this;
	this.bt14.setTransform(939.4,520.7,0.868,0.868,0,0,0,-0.1,0.1);

	this.bt13 = new lib.Symbol12();
	this.bt13.parent = this;
	this.bt13.setTransform(743.4,520.7,0.868,0.868,0,0,0,-0.1,0.1);

	this.bt12 = new lib.Symbol12();
	this.bt12.parent = this;
	this.bt12.setTransform(540.9,520.7,0.868,0.868,0,0,0,-0.1,0.1);

	this.bt11 = new lib.Symbol12();
	this.bt11.parent = this;
	this.bt11.setTransform(330.5,520.7,0.868,0.868,0,0,0,-0.1,0.1);

	this.bt10 = new lib.Symbol12();
	this.bt10.parent = this;
	this.bt10.setTransform(1043.4,330.8,0.868,0.868,0,0,0,-0.1,0.1);

	this.bt9 = new lib.Symbol12();
	this.bt9.parent = this;
	this.bt9.setTransform(846.5,330.2,0.868,0.868,0,0,0,-0.1,0.1);

	this.bt8 = new lib.Symbol12();
	this.bt8.parent = this;
	this.bt8.setTransform(644.7,330.2,0.868,0.868,0,0,0,-0.1,0.1);

	this.bt7 = new lib.Symbol12();
	this.bt7.parent = this;
	this.bt7.setTransform(438.3,330.2,0.868,0.868,0,0,0,-0.1,0.1);

	this.bt6 = new lib.Symbol12();
	this.bt6.parent = this;
	this.bt6.setTransform(232.3,330.2,0.868,0.868,0,0,0,-0.1,0.1);

	this.bt5 = new lib.Symbol12();
	this.bt5.parent = this;
	this.bt5.setTransform(1101.9,132.1,0.868,0.868,0,0,0,-0.1,0.1);

	this.bt4 = new lib.Symbol12();
	this.bt4.parent = this;
	this.bt4.setTransform(855.9,132.1,0.868,0.868,0,0,0,-0.1,0.1);

	this.bt3 = new lib.Symbol12();
	this.bt3.parent = this;
	this.bt3.setTransform(615.1,132.1,0.868,0.868,0,0,0,-0.1,0.1);

	this.bt2 = new lib.Symbol12();
	this.bt2.parent = this;
	this.bt2.setTransform(383.3,132.1,0.868,0.868,0,0,0,-0.1,0.1);
	...
	this.bt1.setTransform(153.4,132.1,0.868,0.868,0,0,0,-0.1,0.1);
	...
	// Layer 3
	this.instance_1 = new lib.EditableENCANTOAdivinaelcabelloremodelado();
	this.instance_1.parent = this;
...
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/Adivina el pelo encanto_atlas_.png?1656945772158", id:"Adivina el pelo encanto_atlas_"},
		{src:"sounds/CORNETAPERDIO.mp3?1656945772236", id:"CORNETAPERDIO"},
		{src:"sounds/CORNETAUNAVEZ.mp3?1656945772236", id:"CORNETAUNAVEZ"},
		{src:"https://code.jquery.com/jquery-2.2.4.min.js?1656945772236", id:"lib/jquery-2.2.4.min.js"},
		{src:"components/sdk/anwidget.js?1656945772236", id:"sdk/anwidget.js"},
		{src:"components/video/src/video.js?1656945772236", id:"an.Video"}
	],
	preloads: []
};
