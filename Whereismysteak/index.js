...
lib.ssMetadata = [
		{name:"index_atlas_1", frames: [[512,3684,82,82],[310,3754,164,40],[782,3632,206,68],[310,3684,200,68],[0,2828,1399,802],[310,3632,470,50],[0,3632,308,429],[0,1802,1536,1024],[0,0,1799,1800]]}
];
...
if (reversed == null) { reversed = false; }
	...
	// Capa_1
	this.instance = new lib.ogor();
	this.instance.setTransform(0,0,0.3718,0.3718);

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(1));

	this._renderFirstFrame();

}).prototype = getMCSymbolPrototype(lib.Símbolo19, new cjs.Rectangle(0,0,668.9,669.3), null);
...
if (reversed == null) { reversed = false; }
	...
	// Capa_3
	this.shape = new cjs.Shape();
	this.shape.graphics.f().s("#FF0000").ss(8,1,1).p("AvEttIeJAAQC1AAAAC1IAAVxQAAC1i1AAI+JAAQi1AAAAi1IAA1xQAAi1C1AAg");
	this.shape.setTransform(92.25,129.925);

	this.shape_1 = new cjs.Shape();
	var sprImg_shape_1 = cjs.SpriteSheetUtils.extractFrame(ss["index_atlas_1"],6);
	sprImg_shape_1.onload = function(){
		this.shape_1.graphics.bf(sprImg_shape_1, null, new cjs.Matrix2D(0,0.65,-0.65,0,136.4,-97.6)).s().p("AvENuQi1AAAAi1IAA1xQAAi1C1AAIeJAAQC1AAAAC1IAAVxQAAC1i1AAg")
	}.bind(this);
	this.shape_1.setTransform(92.25,129.925);

	this.shape_2 = new cjs.Shape();
	this.shape_2.graphics.f().s("#0033FF").ss(8,1,1).p("AvEttIeJAAQC1AAAAC1IAAVxQAAC1i1AAI+JAAQi1AAAAi1IAA1xQAAi1C1AAg");
	this.shape_2.setTransform(92.25,129.925);

	this.shape_3 = new cjs.Shape();
	this.shape_3.graphics.f().s("#66CC00").ss(8,1,1).p("AvEttIeJAAQC1AAAAC1IAAVxQAAC1i1AAI+JAAQi1AAAAi1IAA1xQAAi1C1AAg");
	this.shape_3.setTransform(92.25,129.925);
...
p.nominalBounds = new cjs.Rectangle(-26.3,38.2,237.20000000000002,183.5);
...
}).prototype = getMCSymbolPrototype(lib.Símbolo3, new cjs.Rectangle(-40.8,0,733.4,408), null);
...
if (reversed == null) { reversed = false; }
	...
	this.instance.setTransform(55.6,43.75,0.2965,0.2965,0,0,0,334.4,334.6);

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(1));

	this._renderFirstFrame();

}).prototype = getMCSymbolPrototype(lib.Símbolo3_1, new cjs.Rectangle(-43.5,-55.4,198.3,198.4), null);
...
if (reversed == null) { reversed = false; }
	...
	this.numero.lineWidth = 145;
	this.numero.parent = this;
	this.numero.setTransform(88.55,62.25);

	this.timeline.addTween(cjs.Tween.get(this.numero).to({_off:true},1).wait(59));

	// Capa_2
	this.bt = new lib.Símbolo6();
	this.bt.name = "bt";
	this.bt.setTransform(91.4,102.95);
...
p.nominalBounds = new cjs.Rectangle(-26.3,-169.8,237.20000000000002,394.70000000000005);
...
if (reversed == null) { reversed = false; }
	...
	this.confeti2 = new lib.Símbolo3();
	this.confeti2.name = "confeti2";
	this.confeti2.setTransform(85.25,120.55,1.8134,1.6693,0,-44.9993,135.001,316.9,198.3);

	this.confeti = new lib.Símbolo3();
	this.confeti.name = "confeti";
	this.confeti.setTransform(60.95,94.25,1.7451,1.765,0,0,0,317,198.3);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.numero}]}).to({state:[]},1).to({state:[{t:this.confeti},{t:this.confeti2}]},45).wait(14));

	// Capa_2
	this.bt = new lib.Símbolo6();
	this.bt.name = "bt";
	this.bt.setTransform(93.9,102.95);
	new cjs.ButtonHelper(this.bt, 0, 1, 2, false, new lib.Símbolo6(), 3);
	...
	this.instance.setTransform(93.45,147.45,1,1,0,0,0,60.6,60.6);
...
p.nominalBounds = new cjs.Rectangle(-407.4,38.2,618.3,866);
...
p.nominalBounds = new cjs.Rectangle(-104.1,-116,198.3,529.9);
...
if (reversed == null) { reversed = false; }
	...
	this.frame_162 = function() {
		...
		this.c1.numero.text = "2";
		this.c2.numero.text = "1";
		this.c3.numero.text = "3";
	}
	this.frame_163 = function() {
		...
		this.c1.numero.text = "1";
		this.c2.numero.text = "2";
		this.c3.numero.text = "3";
	}
	this.frame_164 = function() {
		...
		this.c1.numero.text = "3";
		this.c2.numero.text = "2";
		this.c3.numero.text = "1";
	}
	...
	// Capa_1
	this.cajaa = new lib.Símbolo2();
	this.cajaa.name = "cajaa";
	this.cajaa.setTransform(359.8,220.35,1,1,0,0,0,116,112.4);
	this.cajaa._off = true;

	this.timeline.addTween(cjs.Tween.get(this.cajaa).wait(1).to({_off:false},0).to({y:355.25},28,cjs.Ease.get(1)).wait(1).to({regX:92.2,regY:471.2,x:341.3,y:714.05},0).wait(1).to({x:357.2},0).wait(1).to({x:383.75},0).wait(1).to({x:420.95},0).wait(1).to({x:468.75},0).wait(1).to({x:527.15},0).wait(1).to({x:596.2},0).wait(1).to({x:675.9},0).wait(1).to({x:766.15},0).wait(1).to({regX:116,regY:112.4,x:890.9,y:355.25},0).wait(1).to({regX:92.2,regY:471.2,x:835.55,y:723.9},0).wait(1).to({x:803.7,y:733.85},0).wait(1).to({x:771.45,y:743.95},0).wait(1).to({x:738.9,y:754.15},0).wait(1).to({x:706,y:764.45},0).wait(1).to({x:672.75,y:774.85},0).wait(1).to({x:639.15,y:785.35},0).wait(1).to({regX:116,regY:112.4,x:629,y:437.2},0).wait(1).to({regX:92.2,regY:471.2,x:566.9,y:784.3},0).wait(1).to({x:528.55,y:772.65},0).wait(1).to({x:490.15,y:760.95},0).wait(1).to({x:451.7,y:749.25},0).wait(1).to({x:413.15,y:737.5},0).wait(1).to({regX:92.3,x:374.7,y:725.8},0).wait(1).to({regX:116,regY:112.4,x:359.8,y:355.25},0).wait(1).to({regX:92.2,regY:471.2,x:341.3,y:714.05},0).wait(1).to({x:357.2},0).wait(1).to({x:383.75},0).wait(1).to({regX:92.3,x:421.05},0).wait(1).to({regX:92.2,x:468.75},0).wait(1).to({regX:92.3,x:527.25},0).wait(1).to({regX:92.2,x:596.2},0).wait(1).to({regX:92.3,x:676},0).wait(1).to({x:766.25},0).wait(1).to({regX:116,regY:112.4,x:890.9,y:355.25},0).wait(1).to({regX:92.3,regY:471.2,x:856.25,y:717.45},0).wait(1).to({regX:92.2,x:845.2,y:720.85},0).wait(1).to({x:834.2,y:724.3},0).wait(1).to({x:823.15,y:727.8},0).wait(1).to({x:812.05,y:731.25},0).wait(1).to({x:800.9,y:734.75},0).wait(1).to({regX:92.3,x:789.85,y:738.25},0).wait(1).to({regX:92.2,x:778.5,y:741.75},0).wait(1).to({regX:92.3,x:767.35,y:745.25},0).wait(1).to({regX:92.2,x:755.95,y:748.8},0).wait(1).to({x:744.6,y:752.35},0).wait(1).to({x:733.2,y:755.9},0).wait(1).to({x:721.8,y:759.5},0).wait(1).to({x:710.3,y:763.1},0).wait(1).to({x:698.8,y:766.7},0).wait(1).to({x:687.25,y:770.3},0).wait(1).to({x:675.65,y:773.9},0).wait(1).to({x:664,y:777.55},0).wait(1).to({x:652.3,y:781.2},0).wait(1).to({x:640.6,y:784.9},0).wait(1).to({x:628.85,y:788.55},0).wait(1).to({x:617.05,y:792.25},0).wait(1).to({regX:116,regY:112.4,x:629,y:437.2},0).wait(1).to({regX:92.2,regY:471.2,x:601.55,y:794.85},0).wait(1).to({x:597.95,y:793.75},0).wait(1).to({x:594.3,y:792.65},0).wait(1).to({x:590.7,y:791.55},0).wait(1).to({x:587.05,y:790.45},0).wait(1).to({x:583.45,y:789.35},0).wait(1).to({x:579.85,y:788.25},0).wait(1).to({x:576.2,y:787.15},0).wait(1).to({x:572.6,y:786.05},0).wait(1).to({x:568.95,y:784.95},0).wait(1).to({x:565.35,y:783.85},0).wait(1).to({x:561.7,y:782.75},0).wait(1).to({x:558.1,y:781.65},0).wait(1).to({x:554.45,y:780.55},0).wait(1).to({x:550.85,y:779.45},0).wait(1).to({x:547.2,y:778.35},0).wait(1).to({x:543.55,y:777.2},0).wait(1).to({x:539.95,y:776.1},0).wait(1).to({x:536.3,y:775},0).wait(1).to({x:532.7,y:773.9},0).wait(1).to({x:529.05,y:772.8},0).wait(1).to({x:525.45,y:771.7},0).wait(1).to({x:521.8,y:770.6},0).wait(1).to({x:518.15,y:769.5},0).wait(1).to({x:514.55,y:768.4},0).wait(1).to({x:510.9,y:767.3},0).wait(1).to({x:507.25,y:766.15},0).wait(1).to({x:503.65,y:765.05},0).wait(1).to({x:500,y:763.95},0).wait(1).to({x:496.35,y:762.85},0).wait(1).to({x:492.75,y:761.75},0).wait(1).to({x:489.1,y:760.65},0).wait(1).to({x:485.45,y:759.55},0).wait(1).to({x:481.85,y:758.45},0).wait(1).to({x:478.2,y:757.3},0).wait(1).to({x:474.55,y:756.2},0).wait(1).to({x:470.9,y:755.1},0).wait(1).to({x:467.3,y:754},0).wait(1).to({x:463.65,y:752.9},0).wait(1).to({x:460,y:751.8},0).wait(1).to({x:456.35,y:750.65},0).wait(1).to({x:452.7,y:749.55},0).wait(1).to({x:449.1,y:748.45},0).wait(1).to({x:445.45,y:747.35},0).wait(1).to({x:441.8,y:746.25},0).wait(1).to({x:438.15,y:745.15},0).wait(1).to({x:434.5,y:744},0).wait(1).to({x:430.85,y:742.9},0).wait(1).to({x:427.25,y:741.8},0).wait(1).to({x:423.6,y:740.7},0).wait(1).to({x:419.95,y:739.6},0).wait(1).to({x:416.3,y:738.5},0).wait(1).to({x:412.65,y:737.35},0).wait(1).to({x:409,y:736.25},0).wait(1).to({x:405.35,y:735.15},0).wait(1).to({x:401.7,y:734.05},0).wait(1).to({x:398.05,y:732.9},0).wait(1).to({x:394.4,y:731.8},0).wait(1).to({x:390.75,y:730.7},0).wait(1).to({x:387.1,y:729.6},0).wait(1).to({x:383.45,y:728.5},0).wait(1).to({x:379.8,y:727.35},0).wait(1).to({x:376.15,y:726.25},0).wait(1).to({x:372.5,y:725.15},0).wait(1).to({x:368.85,y:724.05},0).wait(1).to({x:365.2,y:722.9},0).wait(1).to({x:361.55,y:721.8},0).wait(1).to({x:357.9,y:720.7},0).wait(1).to({x:354.25,y:719.6},0).wait(1).to({x:350.6,y:718.5},0).wait(1).to({x:346.95,y:717.35},0).wait(1).to({x:343.3,y:716.25},0).wait(1).to({x:339.65,y:715.15},0).wait(1).to({regX:116,regY:112.4,x:359.8,y:355.25},0).to({_off:true},1).wait(3));

	// Capa_3
	this.cajab = new lib.Símbolo2();
	this.cajab.name = "cajab";
	this.cajab.setTransform(629,221.85,1,1,0,0,0,116,112.4);
	this.cajab._off = true;

	this.timeline.addTween(cjs.Tween.get(this.cajab).wait(1).to({_off:false},0).to({y:437.2},28,cjs.Ease.get(1)).wait(1).to({regX:92.2,regY:471.2,x:602.5,y:795.15},0).wait(1).to({x:594.45,y:792.7},0).wait(1).to({x:581,y:788.6},0).wait(1).to({x:562.2,y:782.85},0).wait(1).to({x:538.05,y:775.5},0).wait(1).to({x:508.5,y:766.45},0).wait(1).to({x:473.6,y:755.8},0).wait(1).to({x:433.3,y:743.55},0).wait(1).to({x:387.65,y:729.6},0).wait(1).to({regX:116,regY:112.4,x:360.45,y:355.25},0).wait(1).to({regX:92.2,regY:471.2,x:400.6,y:713.95},0).wait(1).to({x:465.3,y:713.85},0).wait(1).to({x:530.7,y:713.75},0).wait(1).to({x:596.8,y:713.7},0).wait(1).to({x:663.65,y:713.6},0).wait(1).to({x:731.15,y:713.5},0).wait(1).to({x:799.4,y:713.4},0).wait(1).to({regX:116,regY:112.4,x:892.15,y:354.55},0).wait(1).to({regX:92.2,regY:471.2,x:830.9,y:725.1},0).wait(1).to({x:793.4,y:736.85},0).wait(1).to({x:755.85,y:748.65},0).wait(1).to({regX:92.3,x:718.4,y:760.45},0).wait(1).to({regX:92.2,x:680.65,y:772.3},0).wait(1).to({x:642.95,y:784.1},0).wait(1).to({regX:116,regY:112.4,x:629,y:437.2},0).wait(1).to({regX:92.2,regY:471.2,x:602.5,y:795.15},0).wait(1).to({x:594.45,y:792.7},0).wait(1).to({x:581,y:788.6},0).wait(1).to({x:562.2,y:782.85},0).wait(1).to({x:538.05,y:775.5},0).wait(1).to({x:508.5,y:766.45},0).wait(1).to({x:473.6,y:755.8},0).wait(1).to({x:433.3,y:743.55},0).wait(1).to({x:387.65,y:729.6},0).wait(1).to({regX:116,regY:112.4,x:360.45,y:355.25},0).wait(1).to({regX:92.2,regY:471.2,x:358.8,y:714},0).wait(1).to({x:381.05,y:713.95},0).wait(1).to({x:403.4},0).wait(1).to({x:425.85,y:713.9},0).wait(1).to({x:448.35},0).wait(1).to({regX:92.3,x:471.05,y:713.85},0).wait(1).to({regX:92.2,x:493.65,y:713.8},0).wait(1).to({x:516.45},0).wait(1).to({x:539.3,y:713.75},0).wait(1).to({x:562.25},0).wait(1).to({x:585.25,y:713.7},0).wait(1).to({x:608.4,y:713.65},0).wait(1).to({x:631.6},0).wait(1).to({x:654.9,y:713.6},0).wait(1).to({x:678.25},0).wait(1).to({x:701.7,y:713.55},0).wait(1).to({x:725.25,y:713.5},0).wait(1).to({x:748.9},0).wait(1).to({x:772.6,y:713.45},0).wait(1).to({x:796.4,y:713.4},0).wait(1).to({x:820.3},0).wait(1).to({x:844.25,y:713.35},0).wait(1).to({regX:116,regY:112.4,x:892.15,y:354.55},0).wait(1).to({regX:92.2,regY:471.2,x:864.8,y:714.45},0).wait(1).to({x:861.25,y:715.55},0).wait(1).to({x:857.7,y:716.65},0).wait(1).to({x:854.15,y:717.75},0).wait(1).to({x:850.65,y:718.9},0).wait(1).to({x:847.1,y:720},0).wait(1).to({x:843.55,y:721.1},0).wait(1).to({x:840,y:722.2},0).wait(1).to({x:836.45,y:723.35},0).wait(1).to({x:832.9,y:724.45},0).wait(1).to({x:829.4,y:725.55},0).wait(1).to({x:825.85,y:726.65},0).wait(1).to({x:822.3,y:727.8},0).wait(1).to({x:818.75,y:728.9},0).wait(1).to({x:815.2,y:730},0).wait(1).to({x:811.65,y:731.1},0).wait(1).to({x:808.1,y:732.25},0).wait(1).to({x:804.55,y:733.35},0).wait(1).to({x:801,y:734.45},0).wait(1).to({x:797.45,y:735.6},0).wait(1).to({x:793.9,y:736.7},0).wait(1).to({x:790.35,y:737.8},0).wait(1).to({x:786.8,y:738.9},0).wait(1).to({x:783.25,y:740.05},0).wait(1).to({x:779.7,y:741.15},0).wait(1).to({x:776.15,y:742.25},0).wait(1).to({x:772.6,y:743.4},0).wait(1).to({x:769.05,y:744.5},0).wait(1).to({x:765.5,y:745.6},0).wait(1).to({x:761.95,y:746.75},0).wait(1).to({x:758.4,y:747.85},0).wait(1).to({x:754.85,y:748.95},0).wait(1).to({x:751.3,y:750.1},0).wait(1).to({x:747.75,y:751.2},0).wait(1).to({x:744.2,y:752.3},0).wait(1).to({x:740.65,y:753.45},0).wait(1).to({x:737.1,y:754.55},0).wait(1).to({x:733.55,y:755.65},0).wait(1).to({x:729.95,y:756.8},0).wait(1).to({x:726.4,y:757.9},0).wait(1).to({x:722.85,y:759},0).wait(1).to({x:719.3,y:760.15},0).wait(1).to({x:715.75,y:761.25},0).wait(1).to({x:712.2,y:762.35},0).wait(1).to({x:708.6,y:763.5},0).wait(1).to({x:705.05,y:764.6},0).wait(1).to({x:701.5,y:765.7},0).wait(1).to({x:697.95,y:766.85},0).wait(1).to({x:694.4,y:767.95},0).wait(1).to({x:690.8,y:769.1},0).wait(1).to({x:687.25,y:770.2},0).wait(1).to({x:683.7,y:771.3},0).wait(1).to({x:680.1,y:772.45},0).wait(1).to({x:676.55,y:773.55},0).wait(1).to({x:673,y:774.65},0).wait(1).to({x:669.45,y:775.8},0).wait(1).to({x:665.85,y:776.9},0).wait(1).to({x:662.3,y:778.05},0).wait(1).to({x:658.75,y:779.15},0).wait(1).to({x:655.15,y:780.25},0).wait(1).to({x:651.6,y:781.4},0).wait(1).to({x:648.05,y:782.5},0).wait(1).to({x:644.45,y:783.65},0).wait(1).to({x:640.9,y:784.75},0).wait(1).to({x:637.3,y:785.9},0).wait(1).to({x:633.75,y:787},0).wait(1).to({x:630.2,y:788.1},0).wait(1).to({x:626.6,y:789.25},0).wait(1).to({x:623.05,y:790.35},0).wait(1).to({x:619.45,y:791.5},0).wait(1).to({x:615.9,y:792.6},0).wait(1).to({x:612.3,y:793.75},0).wait(1).to({x:608.75,y:794.85},0).wait(1).to({regX:116,regY:112.4,x:629,y:437.2},0).to({_off:true},1).wait(3));

	// Capa_2
	this.cajac = new lib.Símbolo2();
	this.cajac.name = "cajac";
	this.cajac.setTransform(890.9,220.35,1,1,0,0,0,116,112.4);
	this.cajac._off = true;

	this.timeline.addTween(cjs.Tween.get(this.cajac).wait(1).to({_off:false},0).to({y:355.25},28,cjs.Ease.get(1)).wait(1).to({regX:92.2,regY:471.2,x:864.45,y:714.85},0).wait(1).to({x:856.6,y:717.3},0).wait(1).to({x:843.5,y:721.4},0).wait(1).to({x:825.15,y:727.15},0).wait(1).to({x:801.6,y:734.5},0).wait(1).to({x:772.8,y:743.55},0).wait(1).to({x:738.75,y:754.2},0).wait(1).to({x:699.45,y:766.45},0).wait(1).to({x:654.95,y:780.4},0).wait(1).to({regX:116,regY:112.4,x:629,y:437.2},0).wait(1).to({regX:92.2,regY:471.2,x:572.85,y:786.05},0).wait(1).to({x:540.2,y:775.95},0).wait(1).to({x:507.15,y:765.8},0).wait(1).to({regX:92.3,x:473.85,y:755.55},0).wait(1).to({regX:92.2,x:440,y:745.15},0).wait(1).to({x:405.9,y:734.65},0).wait(1).to({regX:92.3,x:371.55,y:724.05},0).wait(1).to({regX:116,regY:112.4,x:360.45,y:354.55},0).wait(1).to({regX:92.2,regY:471.2,x:412.05,y:713.4},0).wait(1).to({x:487.65,y:713.5},0).wait(1).to({x:563.3,y:713.6},0).wait(1).to({x:639.1,y:713.7},0).wait(1).to({x:714.95,y:713.8},0).wait(1).to({x:790.95,y:713.9},0).wait(1).to({regX:116,regY:112.4,x:890.9,y:355.25},0).wait(1).to({regX:92.2,regY:471.2,x:864.45,y:714.85},0).wait(1).to({x:856.6,y:717.3},0).wait(1).to({x:843.5,y:721.4},0).wait(1).to({regX:92.3,x:825.25,y:727.15},0).wait(1).to({regX:92.2,x:801.6,y:734.5},0).wait(1).to({x:772.8,y:743.55},0).wait(1).to({x:738.75,y:754.2},0).wait(1).to({x:699.45,y:766.45},0).wait(1).to({x:654.95,y:780.4},0).wait(1).to({regX:116,regY:112.4,x:629,y:437.2},0).wait(1).to({regX:92.2,regY:471.2,x:593.95,y:792.55},0).wait(1).to({x:582.75,y:789.05},0).wait(1).to({x:571.45,y:785.6},0).wait(1).to({x:560.1,y:782.1},0).wait(1).to({x:548.75,y:778.6},0).wait(1).to({x:537.3,y:775.1},0).wait(1).to({x:525.85,y:771.55},0).wait(1).to({x:514.35,y:768},0).wait(1).to({x:502.8,y:764.45},0).wait(1).to({x:491.2,y:760.9},0).wait(1).to({x:479.6,y:757.3},0).wait(1).to({x:467.9,y:753.75},0).wait(1).to({x:456.2,y:750.1},0).wait(1).to({x:444.45,y:746.5},0).wait(1).to({x:432.65,y:742.85},0).wait(1).to({x:420.8,y:739.2},0).wait(1).to({x:408.9,y:735.55},0).wait(1).to({x:396.95,y:731.9},0).wait(1).to({x:384.95,y:728.2},0).wait(1).to({x:372.95,y:724.5},0).wait(1).to({x:360.9,y:720.8},0).wait(1).to({x:348.8,y:717.05},0).wait(1).to({regX:116,regY:112.4,x:360.45,y:354.55},0).wait(1).to({regX:92.2,regY:471.2,x:343.75,y:713.35},0).wait(1).to({x:350.9},0).wait(1).to({x:358},0).wait(1).to({x:365.15},0).wait(1).to({x:372.3},0).wait(1).to({x:379.45,y:713.4},0).wait(1).to({x:386.55},0).wait(1).to({x:393.7},0).wait(1).to({x:400.85},0).wait(1).to({x:408},0).wait(1).to({x:415.15,y:713.45},0).wait(1).to({x:422.3},0).wait(1).to({x:429.4},0).wait(1).to({x:436.55},0).wait(1).to({x:443.7},0).wait(1).to({x:450.85,y:713.5},0).wait(1).to({x:458},0).wait(1).to({x:465.15},0).wait(1).to({x:472.3},0).wait(1).to({x:479.45},0).wait(1).to({x:486.6},0).wait(1).to({x:493.75,y:713.55},0).wait(1).to({x:500.9},0).wait(1).to({x:508.05},0).wait(1).to({x:515.25},0).wait(1).to({x:522.4},0).wait(1).to({x:529.55,y:713.6},0).wait(1).to({x:536.7},0).wait(1).to({x:543.85},0).wait(1).to({x:551},0).wait(1).to({x:558.2},0).wait(1).to({x:565.35,y:713.65},0).wait(1).to({x:572.5},0).wait(1).to({x:579.7},0).wait(1).to({x:586.85},0).wait(1).to({x:594},0).wait(1).to({x:601.2},0).wait(1).to({x:608.35,y:713.7},0).wait(1).to({x:615.5},0).wait(1).to({x:622.7},0).wait(1).to({x:629.85},0).wait(1).to({x:637.05},0).wait(1).to({x:644.2,y:713.75},0).wait(1).to({x:651.4},0).wait(1).to({x:658.55},0).wait(1).to({x:665.75},0).wait(1).to({x:672.9},0).wait(1).to({x:680.1,y:713.8},0).wait(1).to({x:687.25},0).wait(1).to({x:694.45},0).wait(1).to({x:701.65},0).wait(1).to({x:708.8},0).wait(1).to({x:716,y:713.85},0).wait(1).to({x:723.2},0).wait(1).to({x:730.35},0).wait(1).to({x:737.55},0).wait(1).to({x:744.75},0).wait(1).to({x:751.95},0).wait(1).to({x:759.1,y:713.9},0).wait(1).to({x:766.3},0).wait(1).to({x:773.5},0).wait(1).to({x:780.7},0).wait(1).to({x:787.9},0).wait(1).to({x:795.1,y:713.95},0).wait(1).to({x:802.25},0).wait(1).to({x:809.45},0).wait(1).to({x:816.65},0).wait(1).to({x:823.85},0).wait(1).to({x:831.05,y:714},0).wait(1).to({x:838.25},0).wait(1).to({x:845.45},0).wait(1).to({x:852.65},0).wait(1).to({x:859.85},0).wait(1).to({regX:116,regY:112.4,x:890.9,y:355.25},0).to({_off:true},1).wait(3));

	// Capa_4
	this.instance_1 = new lib.Símbolo10();
	this.instance_1.setTransform(606.25,472.15);
	...
	this.instance_2.setTransform(511,652);

	this.instance_3 = new lib.ChatGPTImage6feb202611_53_36am();
	this.instance_3.setTransform(-252,-47);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.instance_3},{t:this.instance_2}]}).wait(165));

	this._renderFirstFrame();

}).prototype = p = new lib.AnMovieClip();
p.nominalBounds = new cjs.Rectangle(-60.2,52.6,1405,1196.9);
// library properties:
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/index_atlas_1.png?1770396841428", id:"index_atlas_1"},
		{src:"sounds/checkpoint.mp3?1770396841720", id:"checkpoint"},
		{src:"sounds/click.mp3?1770396841720", id:"click"},
		{src:"sounds/click2.mp3?1770396841720", id:"click2"},
		{src:"sounds/CORNETAPERDIO.mp3?1770396841720", id:"CORNETAPERDIO"},
		{src:"sounds/CORNETAUNAVEZ.mp3?1770396841720", id:"CORNETAUNAVEZ"},
		{src:"sounds/moneda2.mp3?1770396841720", id:"moneda2"},
		{src:"sounds/sonidofindeltiempoterminoeltiempobuzzercornetamalCORTA.mp3?1770396841720", id:"sonidofindeltiempoterminoeltiempobuzzercornetamalCORTA"},
		{src:"https://code.jquery.com/jquery-3.4.1.min.js?1770396841720", id:"lib/jquery-3.4.1.min.js"},
		{src:"components/sdk/anwidget.js?1770396841720", id:"sdk/anwidget.js"},
		{src:"components/video/src/video.js?1770396841720", id:"an.Video"}
	],
	preloads: []
};
