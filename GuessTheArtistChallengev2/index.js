...
if (reversed == null) { reversed = false; }
	...
	this.etiketa = new cjs.Text("", "bold 90px 'Arial Black'", "#6600FF");
	this.etiketa.name = "etiketa";
	this.etiketa.textAlign = "center";
	this.etiketa.lineHeight = 129;
	this.etiketa.lineWidth = 119;
	this.etiketa.parent = this;
	this.etiketa.setTransform(-9.3547,-29.0568,1.777,1.6799);
...
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/index_atlas_1.png?1773357541773", id:"index_atlas_1"},
		{src:"sounds/CORNETAPERDIO.mp3?1773357541962", id:"CORNETAPERDIO"},
		{src:"sounds/CORNETAUNAVEZ.mp3?1773357541962", id:"CORNETAUNAVEZ"},
		{src:"https://code.jquery.com/jquery-3.4.1.min.js?1773357541962", id:"lib/jquery-3.4.1.min.js"},
		{src:"components/sdk/anwidget.js?1773357541962", id:"sdk/anwidget.js"},
		{src:"components/video/src/video.js?1773357541962", id:"an.Video"}
	],
	preloads: []
};
