...
lib.ssMetadata = [
		{name:"RULETA_DE_LAS_ESTRELLAS_atlas_", frames: [[0,0,1920,1080],[1808,1422,82,82],[1808,1506,164,40],[1622,1599,206,68],[1622,1225,205,195],[1401,1225,219,209],[1401,1436,219,209],[1622,1422,184,175],[1401,1647,219,209],[1401,1858,407,58],[1401,1082,523,141],[0,1082,1399,802],[0,1886,470,50]]}
];
...
(lib.bgrekreaestrellas = function() {
	this.spriteSheet = ss["RULETA_DE_LAS_ESTRELLAS_atlas_"];
	this.gotoAndStop(0);
...
(lib.Symbol12 = function(mode,startPosition,loop) {
	...
	this.etiketa = new cjs.Text("", "50px 'Impact'", "#FFFFFF");
	...
	this.instance.parent = this;
	this.instance.setTransform(-96,-88);

	this.instance_1 = new lib.Bitmap23();
	this.instance_1.parent = this;
	this.instance_1.setTransform(-103,-95);

	this.instance_2 = new lib.Bitmap24();
	this.instance_2.parent = this;
	this.instance_2.setTransform(-103,-95);

	this.instance_3 = new lib.Bitmap26();
	this.instance_3.parent = this;
	this.instance_3.setTransform(-103,-95);
	...
	this.instance_4.setTransform(-87,-79);

	this.timeline.addTween(cjs.Tween.get(this.instance_4).wait(4));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(-102.6,-88,274,195);
...
// stage content:
(lib.RULETADELASESTRELLAS = function(mode,startPosition,loop) {
	this.initialize(mode,startPosition,loop,{});
	...
	this.bt21.setTransform(-1060.4,1014.1,0.767,0.767,0,0,0,-0.2,0.1);

	this.bt22 = new lib.Symbol12();
	this.bt22.parent = this;
	this.bt22.setTransform(-924.4,1024.7,0.665,0.665,0,0,0,-0.3,0.1);

	this.bt24 = new lib.Symbol12();
	this.bt24.parent = this;
	this.bt24.setTransform(-575.2,1014.1,0.767,0.767,0,0,0,-0.2,0.1);

	this.bt25 = new lib.Symbol12();
	this.bt25.parent = this;
	this.bt25.setTransform(-372,1005.4,0.95,0.95,0,0,0,-0.2,0.1);

	this.bt23 = new lib.Symbol12();
	this.bt23.parent = this;
	this.bt23.setTransform(-747.7,1027.9,0.734,0.734,0,0,0,-0.1,0);

	this.bt20 = new lib.Symbol12();
	this.bt20.parent = this;
	this.bt20.setTransform(-340.7,797.2,0.767,0.767,0,0,0,-0.2,0.1);

	this.bt19 = new lib.Symbol12();
	this.bt19.parent = this;
	this.bt19.setTransform(-574,809.6,0.767,0.767,0,0,0,-0.2,0);

	this.bt18 = new lib.Symbol12();
	this.bt18.parent = this;
	this.bt18.setTransform(-768.5,797.1,0.767,0.767,0,0,0,-0.2,0);

	this.bt17 = new lib.Symbol12();
	this.bt17.parent = this;
	this.bt17.setTransform(-985.1,809.7,0.767,0.767,0,0,0,-0.3,0.1);

	this.bt16 = new lib.Symbol12();
	this.bt16.parent = this;
	this.bt16.setTransform(-1152.4,820.3,0.665,0.665,0,0,0,-0.3,0.1);

	this.bt15 = new lib.Symbol12();
	this.bt15.parent = this;
	this.bt15.setTransform(-395.7,666.7,0.767,0.767,0,0,0,-0.2,0.1);

	this.bt14 = new lib.Symbol12();
	this.bt14.parent = this;
	this.bt14.setTransform(-646.1,680.6,0.767,0.767,0,0,0,-0.2,0.1);

	this.bt13 = new lib.Symbol12();
	this.bt13.parent = this;
	this.bt13.setTransform(-507.8,424,0.984,0.984,0,0,0,-0.1,0);

	this.bt12 = new lib.Symbol12();
	this.bt12.parent = this;
	this.bt12.setTransform(-679.4,417.1,0.974,0.974,0,0,0,-0.1,0.1);

	this.bt11 = new lib.Symbol12();
	this.bt11.parent = this;
	this.bt11.setTransform(-886.3,420.5,0.942,0.942,0,0,0,-0.2,0.1);
	...
	this.bt10.setTransform(-1113.1,445.1,0.986,0.986,0,0,0,-0.2,0.1);

	this.bt9 = new lib.Symbol12();
	this.bt9.parent = this;
	this.bt9.setTransform(-1346.2,475.7,0.888,0.888,0,0,0,0,0.3);

	this.bt8 = new lib.Symbol12();
	this.bt8.parent = this;
	this.bt8.setTransform(-670.6,247.3,1.06,1.06,0,0,0,-0.1,0.1);

	this.bt7 = new lib.Symbol12();
	this.bt7.parent = this;
	this.bt7.setTransform(-828.9,287.5,0.767,0.767,0,0,0,2.5,25.7);

	this.bt6 = new lib.Symbol12();
	this.bt6.parent = this;
	this.bt6.setTransform(-1072,274.4,0.772,0.772);

	this.bt5 = new lib.Symbol12();
	this.bt5.parent = this;
	this.bt5.setTransform(1143.6,392.9,1.278,1.277,0,0,0,-0.1,0.2);

	this.bt4 = new lib.Symbol12();
	this.bt4.parent = this;
	this.bt4.setTransform(931.3,220.8,1.277,1.277,0,0,0,0,0.3);

	this.bt3 = new lib.Symbol12();
	this.bt3.parent = this;
	this.bt3.setTransform(664.3,319,1.277,1.277,0,0,0,-0.1,0.1);

	this.bt2 = new lib.Symbol12();
	this.bt2.parent = this;
	this.bt2.setTransform(397.2,220.4,1.277,1.277);

	this.bt1 = new lib.Symbol12();
	this.bt1.parent = this;
	this.bt1.setTransform(155.5,356,1.278,1.277,0,0,0,-0.1,0.1);
	...
	// Layer 3
	this.instance_1 = new lib.bgrekreaestrellas();
	this.instance_1.parent = this;
...
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/RULETA_DE_LAS_ESTRELLAS_atlas_.png?1653681708713", id:"RULETA_DE_LAS_ESTRELLAS_atlas_"},
		{src:"sounds/CORNETAPERDIO.mp3?1653681708785", id:"CORNETAPERDIO"},
		{src:"sounds/CORNETAUNAVEZ.mp3?1653681708785", id:"CORNETAUNAVEZ"},
		{src:"https://code.jquery.com/jquery-2.2.4.min.js?1653681708785", id:"lib/jquery-2.2.4.min.js"},
		{src:"components/sdk/anwidget.js?1653681708785", id:"sdk/anwidget.js"},
		{src:"components/video/src/video.js?1653681708785", id:"an.Video"}
	],
	preloads: []
};
