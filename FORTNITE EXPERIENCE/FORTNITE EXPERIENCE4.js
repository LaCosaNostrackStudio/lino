...
lib.ssMetadata = [
		{name:"FORTNITE EXPERIENCE4_atlas_", frames: [[1554,1517,82,82],[1554,1601,164,40],[1810,1379,206,68],[1810,1225,152,152],[1401,1225,178,178],[1401,1517,151,151],[1581,1225,151,151],[1401,1405,407,58],[1401,1082,523,141],[0,1082,1399,802],[1401,1465,470,50],[0,0,1920,1080]]}
];
...
(lib.Bitmap10 = function() {
	this.spriteSheet = ss["FORTNITE EXPERIENCE4_atlas_"];
	this.gotoAndStop(0);
...
// stage content:
(lib.FORTNITEEXPERIENCE4 = function(mode,startPosition,loop) {
	this.initialize(mode,startPosition,loop,{});
...
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/FORTNITE EXPERIENCE4_atlas_.png?1651777109880", id:"FORTNITE EXPERIENCE4_atlas_"},
		{src:"sounds/CORNETAPERDIO.mp3?1651777109947", id:"CORNETAPERDIO"},
		{src:"sounds/CORNETAUNAVEZ.mp3?1651777109947", id:"CORNETAUNAVEZ"},
		{src:"https://code.jquery.com/jquery-2.2.4.min.js?1651777109947", id:"lib/jquery-2.2.4.min.js"},
		{src:"components/sdk/anwidget.js?1651777109947", id:"sdk/anwidget.js"},
		{src:"components/video/src/video.js?1651777109947", id:"an.Video"}
	],
	preloads: []
};
