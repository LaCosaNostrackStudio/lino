...
lib.ssMetadata = [
		{name:"index_atlas_1", frames: [[2048,947,82,82],[2838,804,164,40],[2366,856,206,68],[1639,947,407,58],[1639,804,523,141],[1639,0,1399,802],[2366,804,470,50],[3040,0,1024,1024],[2164,804,200,148],[0,0,1637,1091]]}
];
...
(lib.ChatGPTImage13ene202607_18_47pmpngcopia = function() {
	this.initialize(ss["index_atlas_1"]);
	this.gotoAndStop(7);
}).prototype = p = new cjs.Sprite();
...
if (reversed == null) { reversed = false; }
	...
	this.etiketa.setTransform(-18.9546,-10.4068,1.777,1.6799);
	...
	// Capa_2
	this.instance = new lib.ChatGPTImage13ene202607_18_47pmpngcopia();
	this.instance.setTransform(-229,-163,0.4241,0.4241);
...
p.nominalBounds = new cjs.Rectangle(-229,-163,434.3,434.3);
...
if (reversed == null) { reversed = false; }
	...
	this.instance_2.setTransform(-17,-48,0.7965,0.7965);
...
p.nominalBounds = new cjs.Rectangle(-515.4,-231.8,1860.1999999999998,1143.9);
// library properties:
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/index_atlas_1.png?1779406446520", id:"index_atlas_1"},
		{src:"sounds/CORNETAPERDIO.mp3?1779406446640", id:"CORNETAPERDIO"},
		{src:"sounds/CORNETAUNAVEZ.mp3?1779406446640", id:"CORNETAUNAVEZ"},
		{src:"https://code.jquery.com/jquery-3.4.1.min.js?1779406446640", id:"lib/jquery-3.4.1.min.js"},
		{src:"components/sdk/anwidget.js?1779406446640", id:"sdk/anwidget.js"},
		{src:"components/video/src/video.js?1779406446640", id:"an.Video"}
	],
	preloads: []
};
