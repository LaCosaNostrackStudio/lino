...
lib.ssMetadata = [
		{name:"index_atlas_1", frames: [[3948,0,82,82],[2389,804,164,40],[3727,780,206,68],[3318,773,407,58],[3318,630,523,141],[1917,0,1399,802],[1917,804,470,50],[3843,630,200,148],[0,0,1915,1277],[3318,0,628,628]]}
];
...
if (reversed == null) { reversed = false; }
	...
	this.shape.graphics.f("#FFFFFF").s().p("AoXIXQjdjeAAk5QAAk5DdjeQDejdE5AAQE5AADeDdQDeDeAAE5QAAE5jeDeQjeDek5AAQk5AAjejeg");
	this.shape.setTransform(75.725,75.725);

	this.timeline.addTween(cjs.Tween.get(this.shape).wait(1));

	this._renderFirstFrame();

}).prototype = getMCSymbolPrototype(lib.Símbolo3, new cjs.Rectangle(0,0,151.5,151.5), null);
...
if (reversed == null) { reversed = false; }
	...
	this.etiketa = new cjs.Text("", "bold 70px 'Arial Black'", "#0033CC");
	this.etiketa.name = "etiketa";
	this.etiketa.textAlign = "center";
	this.etiketa.lineHeight = 101;
	this.etiketa.lineWidth = 119;
	this.etiketa.parent = this;
	this.etiketa.setTransform(-3.9047,-4.6068,1.777,1.6799);
	this.etiketa.shadow = new cjs.Shadow("rgba(255,255,255,1)",4,4,0);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.etiketa},{t:this.mivar}]}).wait(4));

	// Capa_2
	this.instance = new lib.Símbolo3();
	this.instance.setTransform(4.3,51.4,1,1,0,0,0,75.7,75.7);
	...
	this.instance_1.setTransform(-162,-111,0.5296,0.5296);
...
p.nominalBounds = new cjs.Rectangle(-162,-111,333.4,332.6);
...
if (reversed == null) { reversed = false; }
	...
	this.bt12.name = "bt12";
	this.bt12.setTransform(1126.7,507.4,0.8676,0.8676,0,0,0,-0.1,0.1);

	this.bt11 = new lib.Symbol12_1();
	this.bt11.name = "bt11";
	this.bt11.setTransform(893.95,507.4,0.8676,0.8676,0,0,0,-0.1,0.1);

	this.bt10 = new lib.Symbol12_1();
	this.bt10.name = "bt10";
	this.bt10.setTransform(635.05,487.25,0.8676,0.8676,0,0,0,-0.1,0.1);

	this.bt9 = new lib.Symbol12_1();
	this.bt9.name = "bt9";
	this.bt9.setTransform(388,487.25,0.8676,0.8676,0,0,0,-0.1,0.1);

	this.bt8 = new lib.Symbol12_1();
	this.bt8.name = "bt8";
	this.bt8.setTransform(137.85,487.25,0.8676,0.8676,0,0,0,-0.1,0.1);

	this.bt7 = new lib.Symbol12_1();
	this.bt7.name = "bt7";
	this.bt7.setTransform(1029.1,282.4,0.8676,0.8676,0,0,0,-0.1,0.1);

	this.bt6 = new lib.Symbol12_1();
	this.bt6.name = "bt6";
	this.bt6.setTransform(769.85,289.7,0.8676,0.8676,0,0,0,-0.1,0.1);

	this.bt5 = new lib.Symbol12_1();
	this.bt5.name = "bt5";
	this.bt5.setTransform(509.4,289.7,0.8676,0.8676,0,0,0,-0.1,0.1);

	this.bt4 = new lib.Symbol12_1();
	this.bt4.name = "bt4";
	this.bt4.setTransform(259.15,289.7,0.8676,0.8676,0,0,0,-0.1,0.1);

	this.bt3 = new lib.Symbol12_1();
	this.bt3.name = "bt3";
	this.bt3.setTransform(908.65,83,0.8676,0.8676,0,0,0,-0.1,0.1);

	this.bt2 = new lib.Symbol12_1();
	this.bt2.name = "bt2";
	this.bt2.setTransform(654.9,83,0.8676,0.8676,0,0,0,-0.1,0.1);
	...
	this.bt1.name = "bt1";
	this.bt1.setTransform(388,83,0.8676,0.8676,0,0,0,-0.1,0.1);
	...
	this.instance_2.setTransform(-17,-142,0.6842,0.6842);
...
p.nominalBounds = new cjs.Rectangle(-457.3,-231.8,1802.1,1143.9);
// library properties:
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/index_atlas_1.png?1773357964565", id:"index_atlas_1"},
		{src:"sounds/CORNETAPERDIO.mp3?1773357964677", id:"CORNETAPERDIO"},
		{src:"sounds/CORNETAUNAVEZ.mp3?1773357964677", id:"CORNETAUNAVEZ"},
		{src:"https://code.jquery.com/jquery-3.4.1.min.js?1773357964677", id:"lib/jquery-3.4.1.min.js"},
		{src:"components/sdk/anwidget.js?1773357964678", id:"sdk/anwidget.js"},
		{src:"components/video/src/video.js?1773357964678", id:"an.Video"}
	],
	preloads: []
};
