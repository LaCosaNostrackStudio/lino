...
lib.ssMetadata = [
		{name:"index_atlas_", frames: [[0,0,1119,681],[0,683,1035,383],[1918,0,117,365],[1535,234,381,214],[1037,683,794,307],[1121,234,412,240],[1381,580,379,12],[1121,0,756,232],[1251,476,128,128],[1535,450,128,128],[1121,476,128,128]]}
];
...
(lib.Tween2 = function(mode,startPosition,loop) {
	...
	this.instance.parent = this;
	this.instance.setTransform(-525,-192);

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(1));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(-525,-192,1035,383);
...
(lib.Tween10 = function(mode,startPosition,loop) {
	...
	this.instance.parent = this;
	this.instance.setTransform(610.7,-316.1,1,1,0,0,0,150.6,29);

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(1));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(460.1,-345.1,301.2,58);
...
(lib.Symbol31 = function(mode,startPosition,loop) {
	...
	this.instance_2.setTransform(310.3,-76.1,1,1,0,0,0,64,64);
	...
	this.instance_3.setTransform(-401.6,-81.6,1.716,1.716,0,0,0,63.7,64);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.instance_3},{t:this.instance_2},{t:this.instance_1}]}).wait(60));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(-551.4,-248,1517,387.1);
...
(lib.index = function(mode,startPosition,loop) {
	...
	this.instance.parent = this;
	this.instance.setTransform(303,1780);
	...
	this.instance_1.parent = this;
	this.instance_1.setTransform(190.2,280.2,1,1,0,0,0,299.8,102);

	this.instance_2 = new lib.Symbol111();
	this.instance_2.parent = this;
	this.instance_2.setTransform(372.8,244.2,1,1,0,0,0,344.4,210.1);
	...
	this.instance_3.parent = this;
	this.instance_3.setTransform(502.5,-349.3,1,1,0,0,0,559.6,340.7);

	this.timeline.addTween(cjs.Tween.get(this.instance_3).to({y:317.9},59,cjs.Ease.get(1)).wait(40));

	// Layer 3
	this.instance_4 = new lib.Tween2("synched",0);
	this.instance_4.parent = this;
	this.instance_4.setTransform(493.5,2052.6);
	this.instance_4._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_4).wait(39).to({_off:false},0).to({y:1683.5},59,cjs.Ease.get(1)).wait(1));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(417.9,160,1119,2482.1);
// library properties:
lib.properties = {
	width: 950,
	height: 1700,
	...
	opacity: 1.00,
	manifest: [
		{src:"images/index_atlas_.png?1658844781041", id:"index_atlas_"}
	],
	preloads: []
};
