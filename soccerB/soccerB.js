...
lib.ssMetadata = [
		{name:"soccerB_atlas_1", frames: [[0,804,1280,720],[1589,112,82,82],[1810,0,164,40],[1401,221,206,68],[1401,0,407,58],[1282,804,523,141],[0,0,1399,802],[1401,60,470,50],[1401,112,186,107]]}
];
...
(lib.BackgroundSoccer2RecreaUsa = function() {
...
p.nominalBounds = new cjs.Rectangle(-113,-28.2,284.4,177);
...
if (reversed == null) { reversed = false; }
	...
	this.bt10.name = "bt10";
	this.bt10.setTransform(1011.85,482.6,0.8676,0.8676,0,0,0,-0.1,0.1);

	this.bt9 = new lib.Symbol12();
	this.bt9.name = "bt9";
	this.bt9.setTransform(751.2,482.6,0.8676,0.8676,0,0,0,-0.1,0.1);

	this.bt8 = new lib.Symbol12();
	this.bt8.name = "bt8";
	this.bt8.setTransform(488.95,482.6,0.8676,0.8676,0,0,0,-0.1,0.1);

	this.bt7 = new lib.Symbol12();
	this.bt7.name = "bt7";
	this.bt7.setTransform(207.3,482.6,0.8676,0.8676,0,0,0,-0.1,0.1);

	this.bt6 = new lib.Symbol12();
	this.bt6.name = "bt6";
	this.bt6.setTransform(927.05,281.95,0.8676,0.8676,0,0,0,-0.1,0.1);

	this.bt5 = new lib.Symbol12();
	this.bt5.name = "bt5";
	this.bt5.setTransform(593.65,281.95,0.8676,0.8676,0,0,0,-0.1,0.1);

	this.bt4 = new lib.Symbol12();
	this.bt4.name = "bt4";
	this.bt4.setTransform(264.75,281.95,0.8676,0.8676,0,0,0,-0.1,0.1);

	this.bt3 = new lib.Symbol12();
	this.bt3.name = "bt3";
	this.bt3.setTransform(874.9,83,0.8676,0.8676,0,0,0,-0.1,0.1);

	this.bt2 = new lib.Symbol12();
	this.bt2.name = "bt2";
	this.bt2.setTransform(601.85,83,0.8676,0.8676,0,0,0,-0.1,0.1);
	...
	this.bt1.name = "bt1";
	this.bt1.setTransform(325.65,83,0.8676,0.8676,0,0,0,-0.1,0.1);
	...
	// Layer 3
	this.instance_1 = new lib.BackgroundSoccer2RecreaUsa();
...
p.nominalBounds = new cjs.Rectangle(-415.9,-231.8,1760.6999999999998,1143.9);
// library properties:
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/soccerB_atlas_1.png?1666985416709", id:"soccerB_atlas_1"},
		{src:"sounds/CORNETAPERDIO.mp3?1666985416811", id:"CORNETAPERDIO"},
		{src:"sounds/CORNETAUNAVEZ.mp3?1666985416811", id:"CORNETAUNAVEZ"},
		{src:"https://code.jquery.com/jquery-3.4.1.min.js?1666985416811", id:"lib/jquery-3.4.1.min.js"},
		{src:"components/sdk/anwidget.js?1666985416811", id:"sdk/anwidget.js"},
		{src:"components/video/src/video.js?1666985416811", id:"an.Video"}
	],
	preloads: []
};
