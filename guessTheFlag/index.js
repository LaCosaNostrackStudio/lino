...
lib.ssMetadata = [
		{name:"index_atlas_1", frames: [[0,804,1000,667],[480,1836,82,82],[409,2005,164,40],[480,1766,206,68],[0,1953,407,58],[480,1473,523,141],[0,0,1399,802],[409,1953,470,50],[480,1616,200,148],[0,1473,478,478]]}
];
...
if (reversed == null) { reversed = false; }
	...
	this.shape.graphics.f("#FFFFFF").s().p("AsaMbQlIlJAAnSQAAnRFIlJQFKlJHQAAQHSAAFJFJQFIFJAAHRQAAHSlIFJQlJFJnSAAQnQAAlKlJg");
	this.shape.setTransform(154.45,146.375);

	this.timeline.addTween(cjs.Tween.get(this.shape).wait(1));

	this._renderFirstFrame();

}).prototype = getMCSymbolPrototype(lib.Símbolo5, new cjs.Rectangle(0,0,318.7,318.7), null);
...
if (reversed == null) { reversed = false; }
	...
	// Capa_1
	this.instance = new lib._24181();
	this.instance.setTransform(0,0,1.3754,1.3636);

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(1));

	this._renderFirstFrame();

}).prototype = getMCSymbolPrototype(lib.Símbolo4, new cjs.Rectangle(0,0,1375.4,909.5), null);
...
if (reversed == null) { reversed = false; }
	...
	this.etiketa = new cjs.Text("", "bold 72px 'Arial Black'", "#3300FF");
	this.etiketa.name = "etiketa";
	this.etiketa.textAlign = "center";
	this.etiketa.lineHeight = 104;
	this.etiketa.lineWidth = 119;
	this.etiketa.parent = this;
	this.etiketa.setTransform(-17.6047,-29.0568,1.777,1.6799);
	this.etiketa.shadow = new cjs.Shadow("rgba(0,0,0,1)",4,4,0);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.etiketa},{t:this.mivar}]}).wait(4));

	// Layer 4
	this.instance = new lib.Símbolo5();
	this.instance.setTransform(-4.7,40.3,1,1,0,0,0,159.3,159.3);
...
p.nominalBounds = new cjs.Rectangle(-164,-119,335.4,318.7);
...
if (reversed == null) { reversed = false; }
	...
	this.bt12.name = "bt12";
	this.bt12.setTransform(1120.35,488.65,0.8676,0.8676,0,0,0,-0.1,0.1);

	this.bt11 = new lib.Symbol12_1();
	this.bt11.name = "bt11";
	this.bt11.setTransform(876.4,487.9,0.8676,0.8676,0,0,0,-0.1,0.1);

	this.bt10 = new lib.Symbol12_1();
	this.bt10.name = "bt10";
	this.bt10.setTransform(632.6,487.9,0.8676,0.8676,0,0,0,-0.1,0.1);

	this.bt9 = new lib.Symbol12_1();
	this.bt9.name = "bt9";
	this.bt9.setTransform(400.05,492.8,0.8676,0.8676,0,0,0,-0.1,0.1);

	this.bt8 = new lib.Symbol12_1();
	this.bt8.name = "bt8";
	this.bt8.setTransform(148.9,493.55,0.8676,0.8676,0,0,0,-0.1,0.1);

	this.bt7 = new lib.Symbol12_1();
	this.bt7.name = "bt7";
	this.bt7.setTransform(978.05,281.95,0.8676,0.8676,0,0,0,-0.1,0.1);

	this.bt6 = new lib.Symbol12_1();
	this.bt6.name = "bt6";
	this.bt6.setTransform(741.5,281.95,0.8676,0.8676,0,0,0,-0.1,0.1);

	this.bt5 = new lib.Symbol12_1();
	this.bt5.name = "bt5";
	this.bt5.setTransform(494.55,281.95,0.8676,0.8676,0,0,0,-0.1,0.1);

	this.bt4 = new lib.Symbol12_1();
	this.bt4.name = "bt4";
	this.bt4.setTransform(263.45,281.95,0.8676,0.8676,0,0,0,-0.1,0.1);

	this.bt3 = new lib.Symbol12_1();
	this.bt3.name = "bt3";
	this.bt3.setTransform(876.4,83,0.8676,0.8676,0,0,0,-0.1,0.1);

	this.bt2 = new lib.Symbol12_1();
	this.bt2.name = "bt2";
	this.bt2.setTransform(617.75,83,0.8676,0.8676,0,0,0,-0.1,0.1);
	...
	this.bt1.name = "bt1";
	this.bt1.setTransform(388.6,83,0.8676,0.8676,0,0,0,-0.1,0.1);
	...
	// Capa_1
	this.instance_1 = new lib.logopngcopia();
	this.instance_1.setTransform(566,621,0.647,0.647);

	this.timeline.addTween(cjs.Tween.get(this.instance_1).wait(2));

	// Layer 3
	this.instance_2 = new lib.Símbolo4();
	this.instance_2.setTransform(627.7,365.8,1,1,0,0,0,687.7,454.8);
	this.instance_2.filters = [new cjs.BlurFilter(8, 8, 3)];
	this.instance_2.cache(-2,-2,1379,914);
...
p.nominalBounds = new cjs.Rectangle(-459,-231.8,1803.8,1143.9);
// library properties:
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/index_atlas_1.png?1776303882999", id:"index_atlas_1"},
		{src:"sounds/CORNETAPERDIO.mp3?1776303883125", id:"CORNETAPERDIO"},
		{src:"sounds/CORNETAUNAVEZ.mp3?1776303883125", id:"CORNETAUNAVEZ"},
		{src:"https://code.jquery.com/jquery-3.4.1.min.js?1776303883125", id:"lib/jquery-3.4.1.min.js"},
		{src:"components/sdk/anwidget.js?1776303883125", id:"sdk/anwidget.js"},
		{src:"components/video/src/video.js?1776303883125", id:"an.Video"}
	],
	preloads: []
};
