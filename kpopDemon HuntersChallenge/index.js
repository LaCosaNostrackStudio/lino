...
lib.ssMetadata = [
		{name:"index_atlas_1", frames: [[1603,1413,82,82],[1810,1483,164,40],[1810,1413,206,68],[1401,1563,407,58],[1401,1270,523,141],[0,827,1399,802],[1401,1623,470,50],[1401,1413,200,148],[0,0,1431,825],[0,1631,682,320],[1401,827,441,441]]}
];
...
if (reversed == null) { reversed = false; }
	...
	this.shape.graphics.f("#FFFFFF").s().p("");
	this.shape.setTransform(93.725,13.1);

	this.timeline.addTween(cjs.Tween.get(this.shape).wait(1));

	this._renderFirstFrame();

}).prototype = getMCSymbolPrototype(lib.Símbolo2, new cjs.Rectangle(0,0,187.5,26.2), null);
...
if (reversed == null) { reversed = false; }
	...
	props.mode = mode;
	props.startPosition = startPosition;
	props.labels = {dos:1,tres:2,cuatro:3};
	props.loop = loop;
	props.reversed = reversed;
	cjs.MovieClip.apply(this,[props]);
	...
	this.mivar.setTransform(127.35,26.9);
...
p.nominalBounds = new cjs.Rectangle(-174,-121,360.1,360.1);
...
if (reversed == null) { reversed = false; }
	...
	// Layer 1
	this.shape = new cjs.Shape();
	this.shape.graphics.f().s("#FFFFFF").ss(17.6,1,1).p("AkXhgIAAkCAkXhgID0BXAkXhgQATggAcgcQBYhYB8AAQB8AABYBYQBYBYAAB7QAAB9hYBXQhYBYh8AAQhxAAhThJ");
...
}).prototype = getMCSymbolPrototype(lib.Symbol8, new cjs.Rectangle(-36.7,-44.2,73.4,88.5), null);
...
if (reversed == null) { reversed = false; }
	...
	this.shape.setTransform(523.75,390.05);
...
if (reversed == null) { reversed = false; }
	...
	this.instance.setTransform(181.65,155.6,1,1,0,0,0,93.7,13.1);

	this.instance_1 = new lib.Mapadebits2();
	this.instance_1.setTransform(0,0,0.5837,0.5837);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.instance_1},{t:this.instance}]}).wait(1));

	this._renderFirstFrame();

}).prototype = getMCSymbolPrototype(lib.Símbolo1, new cjs.Rectangle(0,0,398.1,186.8), null);
...
if (reversed == null) { reversed = false; }
	...
	this.timeline.addTween(cjs.Tween.get(this.instance).to({alpha:0.1289},28).to({alpha:1},31).wait(1));
...
if (reversed == null) { reversed = false; }
	...
	props.mode = mode;
	props.startPosition = startPosition;
	props.labels = {resetear:9,ini:0,ini2:1};
	props.loop = loop;
	props.reversed = reversed;
	cjs.MovieClip.apply(this,[props]);
	...
	this.instance.setTransform(693.75,-561.6,0.7505,0.7505,0,0,0,57.7,41.9);
	...
	this.mimusica.setTransform(-252.4,-441.4,0.6384,0.4784,0,0,0,200,149.9);
	...
	this.miruta2.setTransform(1066.4,650.25);
	...
	this.miruta.setTransform(961.75,650.25);
	...
	this.mivar.parent = this;
	this.mivar.setTransform(851.25,650.25);
	...
	// Layer 8
	this.movieClip_3 = new lib.an_Video({'id': 'movieClip_3', 'src':'', 'autoplay':true, 'controls':false, 'loop':false, 'preload':false, 'class':'video'});

	this.movieClip_3.name = "movieClip_3";
	this.movieClip_3.setTransform(14.3,-797.3,2.4463,1.886,0,0,0,0.1,-0.1);

	this.timeline.addTween(cjs.Tween.get(this.movieClip_3).wait(5).to({scaleX:2.4462,scaleY:1.8859,x:14.25,y:-177.3},1).wait(4).to({scaleX:2.4463,scaleY:1.886,x:14.3,y:-812.8},1).wait(1));

	// Layer 7
	this.instance_1 = new lib.Symbol24();
	this.instance_1.setTransform(500.55,105);
	...
	this.instance_2.setTransform(491.5,-150.85,1.183,0.7493,0,0,0,523.6,0);
	this.instance_2.alpha = 0.0117;
	this.instance_2._off = true;
	new cjs.ButtonHelper(this.instance_2, 0, 1, 1);

	this.timeline.addTween(cjs.Tween.get(this.instance_2).wait(6).to({_off:false},0).wait(6));

	this._renderFirstFrame();

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(-380.4,-813.5,1491.6999999999998,1519.4);
...
}).prototype = getMCSymbolPrototype(lib.Symbol1_1, new cjs.Rectangle(6.5,-0.3,228.9,40.9), null);
...
if (reversed == null) { reversed = false; }
	...
	this.instance_1.setTransform(167.75,58.9,0.8425,0.8425,0,0,0,199.1,93.4);
	...
	this.bt25.name = "bt25";
	this.bt25.setTransform(-438.2,352.75,0.8676,0.8676,0,0,0,-0.1,0.1);

	this.bt24 = new lib.Symbol12();
	this.bt24.name = "bt24";
	this.bt24.setTransform(-566.9,352.75,0.8676,0.8676,0,0,0,-0.1,0.1);

	this.bt23 = new lib.Symbol12();
	this.bt23.name = "bt23";
	this.bt23.setTransform(-698.45,352.75,0.8676,0.8676,0,0,0,-0.1,0.1);

	this.bt22 = new lib.Symbol12();
	this.bt22.name = "bt22";
	this.bt22.setTransform(-826.85,352.75,0.8676,0.8676,0,0,0,-0.1,0.1);

	this.bt21 = new lib.Symbol12();
	this.bt21.name = "bt21";
	this.bt21.setTransform(-956.85,352.75,0.8676,0.8676,0,0,0,-0.1,0.1);

	this.bt20 = new lib.Symbol12();
	this.bt20.name = "bt20";
	this.bt20.setTransform(-428.65,165.9,0.8676,0.8676,0,0,0,-0.1,0.1);

	this.bt19 = new lib.Symbol12();
	this.bt19.name = "bt19";
	this.bt19.setTransform(-557.35,165.9,0.8676,0.8676,0,0,0,-0.1,0.1);

	this.bt18 = new lib.Symbol12();
	this.bt18.name = "bt18";
	this.bt18.setTransform(-688.9,165.9,0.8676,0.8676,0,0,0,-0.1,0.1);

	this.bt17 = new lib.Symbol12();
	this.bt17.name = "bt17";
	this.bt17.setTransform(-817.3,165.9,0.8676,0.8676,0,0,0,-0.1,0.1);

	this.bt16 = new lib.Symbol12();
	this.bt16.name = "bt16";
	this.bt16.setTransform(-947.3,165.9,0.8676,0.8676,0,0,0,-0.1,0.1);

	this.bt15 = new lib.Symbol12();
	this.bt15.name = "bt15";
	this.bt15.setTransform(-947.3,-6.95,0.8676,0.8676,0,0,0,-0.1,0.1);

	this.bt14 = new lib.Symbol12();
	this.bt14.name = "bt14";
	this.bt14.setTransform(-347.95,-191.65,0.8676,0.8676,0,0,0,-0.1,0.1);

	this.bt13 = new lib.Symbol12();
	this.bt13.name = "bt13";
	this.bt13.setTransform(-543.9,-191.65,0.8676,0.8676,0,0,0,-0.1,0.1);

	this.bt12 = new lib.Symbol12();
	this.bt12.name = "bt12";
	this.bt12.setTransform(-746.45,-191.65,0.8676,0.8676,0,0,0,-0.1,0.1);

	this.bt11 = new lib.Symbol12();
	this.bt11.name = "bt11";
	this.bt11.setTransform(-956.85,-191.65,0.8676,0.8676,0,0,0,-0.1,0.1);

	this.bt10 = new lib.Symbol12();
	this.bt10.name = "bt10";
	this.bt10.setTransform(988.55,487.9,0.8676,0.8676,0,0,0,-0.1,0.1);

	this.bt9 = new lib.Symbol12();
	this.bt9.name = "bt9";
	this.bt9.setTransform(791.6,487.25,0.8676,0.8676,0,0,0,-0.1,0.1);

	this.bt8 = new lib.Symbol12();
	this.bt8.name = "bt8";
	this.bt8.setTransform(589.85,487.25,0.8676,0.8676,0,0,0,-0.1,0.1);

	this.bt7 = new lib.Symbol12();
	this.bt7.name = "bt7";
	this.bt7.setTransform(383.45,487.25,0.8676,0.8676,0,0,0,-0.1,0.1);

	this.bt6 = new lib.Symbol12();
	this.bt6.name = "bt6";
	this.bt6.setTransform(177.4,487.25,0.8676,0.8676,0,0,0,-0.1,0.1);

	this.bt5 = new lib.Symbol12();
	this.bt5.name = "bt5";
	this.bt5.setTransform(881.55,281.95,0.8676,0.8676,0,0,0,-0.1,0.1);

	this.bt4 = new lib.Symbol12();
	this.bt4.name = "bt4";
	this.bt4.setTransform(590.65,281.95,0.8676,0.8676,0,0,0,-0.1,0.1);

	this.bt3 = new lib.Symbol12();
	this.bt3.name = "bt3";
	this.bt3.setTransform(344,281.95,0.8676,0.8676,0,0,0,-0.1,0.1);

	this.bt2 = new lib.Symbol12();
	this.bt2.name = "bt2";
	this.bt2.setTransform(737.95,83,0.8676,0.8676,0,0,0,-0.1,0.1);
	...
	this.bt1.name = "bt1";
	this.bt1.setTransform(447.6,83,0.8676,0.8676,0,0,0,-0.1,0.1);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.fsbtn}]}).to({state:[{t:this.bt1},{t:this.reini},{t:this.btfull},{t:this.bt2},{t:this.bt3},{t:this.bt4},{t:this.bt5},{t:this.bt6},{t:this.bt7},{t:this.bt8},{t:this.bt9},{t:this.bt10},{t:this.bt11},{t:this.bt12},{t:this.bt13},{t:this.bt14},{t:this.bt15},{t:this.bt16},{t:this.bt17},{t:this.bt18},{t:this.bt19},{t:this.bt20},{t:this.bt21},{t:this.bt22},{t:this.bt23},{t:this.bt24},{t:this.bt25},{t:this.myMC},{t:this.instance_1}]},1).wait(1));

	// Layer 3
	this.instance_2 = new lib.logopngcopia();
	this.instance_2.setTransform(566,621,0.647,0.647);

	this.instance_3 = new lib.Mapadebits1();
	this.instance_3.setTransform(-58,-12);
...
p.nominalBounds = new cjs.Rectangle(-467.7,-231.8,1840.7,1143.9);
// library properties:
lib.properties = {
	id: '1B95F371D74A024DB5BCE5AD262C2CC9',
	width: 1280,
	height: 720,
	fps: 60,
	color: "#FFFFFF",
	opacity: 1.00,
	manifest: [
		{src:"images/index_atlas_1.png?1768343319736", id:"index_atlas_1"},
		{src:"sounds/CORNETAPERDIO.mp3?1768343319850", id:"CORNETAPERDIO"},
		{src:"sounds/CORNETAUNAVEZ.mp3?1768343319850", id:"CORNETAUNAVEZ"},
		{src:"https://code.jquery.com/jquery-3.4.1.min.js?1768343319850", id:"lib/jquery-3.4.1.min.js"},
		{src:"components/sdk/anwidget.js?1768343319850", id:"sdk/anwidget.js"},
		{src:"components/video/src/video.js?1768343319850", id:"an.Video"}
	],
	preloads: []
};
...
an.compositions['1B95F371D74A024DB5BCE5AD262C2CC9'] = {
