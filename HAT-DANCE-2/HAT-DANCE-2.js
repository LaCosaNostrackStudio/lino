...
lib.ssMetadata = [
		{name:"HAT_DANCE_2_atlas_", frames: [[0,0,1920,1080],[1922,0,82,82],[1810,1557,164,40],[1401,1669,206,68],[1654,1391,251,164],[1401,1225,251,164],[1654,1225,251,164],[1401,1391,251,164],[1401,1557,407,58],[1401,1082,523,141],[0,1082,1399,802],[1401,1617,470,50]]}
];
...
(lib.bg = function() {
	this.spriteSheet = ss["HAT_DANCE_2_atlas_"];
	this.gotoAndStop(0);
...
// stage content:
(lib.HATDANCE2 = function(mode,startPosition,loop) {
	this.initialize(mode,startPosition,loop,{});
	...
	this.bt7.setTransform(421.2,829.3,0.767,0.767,0,0,0,2.5,25.7);

	this.bt6 = new lib.Symbol12_1();
	this.bt6.parent = this;
	this.bt6.setTransform(483,499.5,0.772,0.772);

	this.bt5 = new lib.Symbol12_1();
	this.bt5.parent = this;
	this.bt5.setTransform(783.3,494.3,0.821,0.821,0,0,0,-0.1,0.2);
...
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/HAT_DANCE_2_atlas_.png?1653665852625", id:"HAT_DANCE_2_atlas_"},
		{src:"sounds/CORNETAPERDIO.mp3?1653665852699", id:"CORNETAPERDIO"},
		{src:"sounds/CORNETAUNAVEZ.mp3?1653665852699", id:"CORNETAUNAVEZ"},
		{src:"https://code.jquery.com/jquery-2.2.4.min.js?1653665852699", id:"lib/jquery-2.2.4.min.js"},
		{src:"components/sdk/anwidget.js?1653665852699", id:"sdk/anwidget.js"},
		{src:"components/video/src/video.js?1653665852699", id:"an.Video"}
	],
	preloads: []
};
