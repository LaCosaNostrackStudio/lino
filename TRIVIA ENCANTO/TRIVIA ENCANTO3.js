...
lib.ssMetadata = [
		{name:"TRIVIA ENCANTO3_atlas_", frames: [[1568,1407,82,82],[1810,1225,164,40],[1568,1337,206,68],[1401,1763,165,140],[1401,1621,165,140],[1401,1479,165,140],[1401,1337,165,140],[1401,1225,407,58],[1401,1082,523,141],[0,1082,1399,802],[1401,1285,470,50],[0,0,1920,1080]]}
];
...
(lib.Bitmap10 = function() {
	this.spriteSheet = ss["TRIVIA ENCANTO3_atlas_"];
	this.gotoAndStop(0);
...
// stage content:
(lib.TRIVIAENCANTO3 = function(mode,startPosition,loop) {
	this.initialize(mode,startPosition,loop,{});
	...
	this.bt15.setTransform(1019.1,520.7,0.868,0.868,0,0,0,-0.1,0.1);

	this.bt14 = new lib.Symbol12();
	this.bt14.parent = this;
	this.bt14.setTransform(816.5,520.7,0.868,0.868,0,0,0,-0.1,0.1);

	this.bt13 = new lib.Symbol12();
	this.bt13.parent = this;
	this.bt13.setTransform(620.6,520.7,0.868,0.868,0,0,0,-0.1,0.1);

	this.bt12 = new lib.Symbol12();
	this.bt12.parent = this;
	this.bt12.setTransform(418,520.7,0.868,0.868,0,0,0,-0.1,0.1);

	this.bt11 = new lib.Symbol12();
	this.bt11.parent = this;
	this.bt11.setTransform(207.6,520.7,0.868,0.868,0,0,0,-0.1,0.1);

	this.bt10 = new lib.Symbol12();
	this.bt10.parent = this;
	this.bt10.setTransform(1049.3,330.2,0.868,0.868,0,0,0,-0.1,0.1);

	this.bt9 = new lib.Symbol12();
	this.bt9.parent = this;
	this.bt9.setTransform(825,330.2,0.868,0.868,0,0,0,-0.1,0.1);

	this.bt8 = new lib.Symbol12();
	this.bt8.parent = this;
	this.bt8.setTransform(619.4,330.2,0.868,0.868,0,0,0,-0.1,0.1);

	this.bt7 = new lib.Symbol12();
	this.bt7.parent = this;
	this.bt7.setTransform(391.5,330.2,0.868,0.868,0,0,0,-0.1,0.1);

	this.bt6 = new lib.Symbol12();
	this.bt6.parent = this;
	this.bt6.setTransform(173.8,330.2,0.868,0.868,0,0,0,-0.1,0.1);

	this.bt5 = new lib.Symbol12();
	this.bt5.parent = this;
	this.bt5.setTransform(1130.6,132.1,0.868,0.868,0,0,0,-0.1,0.1);

	this.bt4 = new lib.Symbol12();
	this.bt4.parent = this;
	this.bt4.setTransform(883.2,132.1,0.868,0.868,0,0,0,-0.1,0.1);

	this.bt3 = new lib.Symbol12();
	this.bt3.parent = this;
	this.bt3.setTransform(619,132.1,0.868,0.868,0,0,0,-0.1,0.1);

	this.bt2 = new lib.Symbol12();
	this.bt2.parent = this;
	this.bt2.setTransform(352.1,132.1,0.868,0.868,0,0,0,-0.1,0.1);
	...
	this.bt1.setTransform(112.4,132.1,0.868,0.868,0,0,0,-0.1,0.1);
...
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/TRIVIA ENCANTO3_atlas_.png?1652710263425", id:"TRIVIA ENCANTO3_atlas_"},
		{src:"sounds/CORNETAPERDIO.mp3?1652710263506", id:"CORNETAPERDIO"},
		{src:"sounds/CORNETAUNAVEZ.mp3?1652710263506", id:"CORNETAUNAVEZ"},
		{src:"https://code.jquery.com/jquery-2.2.4.min.js?1652710263506", id:"lib/jquery-2.2.4.min.js"},
		{src:"components/sdk/anwidget.js?1652710263506", id:"sdk/anwidget.js"},
		{src:"components/video/src/video.js?1652710263506", id:"an.Video"}
	],
	preloads: []
};
