...
lib.ssMetadata = [
		{name:"soccerB_atlas_1", frames: [[1791,130,82,82],[1875,130,164,40],[1791,60,206,68],[1603,0,407,58],[1401,1417,523,141],[0,903,1399,802],[1401,1560,470,50],[0,0,1601,901],[1401,903,512,512],[1603,60,186,107]]}
];
...
(lib.Bitmap10 = function() {
	this.initialize(ss["soccerB_atlas_1"]);
	this.gotoAndStop(0);
...
if (reversed == null) { reversed = false; }
	...
	this.etiketa.setTransform(12.9453,-8.8568,1.777,1.6799);
	this.etiketa.shadow = new cjs.Shadow("rgba(0,153,255,1)",0,0,12);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.etiketa},{t:this.mivar}]}).wait(4));

	// Layer 4
	this.instance = new lib.logo();
	this.instance.setTransform(-113,-22,1.3819,1.3819);
...
p.nominalBounds = new cjs.Rectangle(-118.9,-35.2,290.3,191);
...
// stage content:
(lib.soccerB = function(mode,startPosition,loop,reversed) {
if (loop == null) { loop = true; }
if (reversed == null) { reversed = false; }
	var props = new Object();
	props.mode = mode;
	...
	this.bt10.name = "bt10";
	this.bt10.setTransform(1024.25,482.6,0.8676,0.8676,0,0,0,-0.1,0.1);

	this.bt9 = new lib.Symbol12();
	this.bt9.name = "bt9";
	this.bt9.setTransform(763.6,482.6,0.8676,0.8676,0,0,0,-0.1,0.1);

	this.bt8 = new lib.Symbol12();
	this.bt8.name = "bt8";
	this.bt8.setTransform(501.35,482.6,0.8676,0.8676,0,0,0,-0.1,0.1);

	this.bt7 = new lib.Symbol12();
	this.bt7.name = "bt7";
	this.bt7.setTransform(219.7,482.6,0.8676,0.8676,0,0,0,-0.1,0.1);

	this.bt6 = new lib.Symbol12();
	this.bt6.name = "bt6";
	this.bt6.setTransform(939.45,281.95,0.8676,0.8676,0,0,0,-0.1,0.1);

	this.bt5 = new lib.Symbol12();
	this.bt5.name = "bt5";
	this.bt5.setTransform(606.05,281.95,0.8676,0.8676,0,0,0,-0.1,0.1);

	this.bt4 = new lib.Symbol12();
	this.bt4.name = "bt4";
	this.bt4.setTransform(277.15,281.95,0.8676,0.8676,0,0,0,-0.1,0.1);

	this.bt3 = new lib.Symbol12();
	this.bt3.name = "bt3";
	this.bt3.setTransform(887.3,83,0.8676,0.8676,0,0,0,-0.1,0.1);

	this.bt2 = new lib.Symbol12();
	this.bt2.name = "bt2";
	this.bt2.setTransform(614.25,83,0.8676,0.8676,0,0,0,-0.1,0.1);
	...
	this.bt1.name = "bt1";
	this.bt1.setTransform(338.05,83,0.8676,0.8676,0,0,0,-0.1,0.1);
	...
	this.instance_1.setTransform(641.2,664.3,1,1,0,0,0,107.2,14.3);

	this.instance_2 = new lib.craiyon_100930_image();
	this.instance_2.setTransform(15,15,0.3352,0.3352);

	this.instance_3 = new lib.Captura();
	this.instance_3.setTransform(-16,-17,0.8437,0.8437);
...
p.nominalBounds = new cjs.Rectangle(-422.9,-231.8,1767.6999999999998,1143.9);
// library properties:
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/soccerB_atlas_1.png?1757339862656", id:"soccerB_atlas_1"},
		{src:"sounds/CORNETAPERDIO.mp3?1757339862773", id:"CORNETAPERDIO"},
		{src:"sounds/CORNETAUNAVEZ.mp3?1757339862773", id:"CORNETAUNAVEZ"},
		{src:"https://code.jquery.com/jquery-3.4.1.min.js?1757339862773", id:"lib/jquery-3.4.1.min.js"},
		{src:"components/sdk/anwidget.js?1757339862773", id:"sdk/anwidget.js"},
		{src:"components/video/src/video.js?1757339862773", id:"an.Video"}
	],
	preloads: []
};
