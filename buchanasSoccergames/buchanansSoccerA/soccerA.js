...
lib.ssMetadata = [
		{name:"soccerA_atlas_1", frames: [[0,804,1280,720],[1915,0,82,82],[1814,717,164,40],[1606,717,206,68],[1401,657,203,179],[1606,657,407,58],[1401,514,523,141],[0,0,1399,802],[1282,838,470,50],[0,1526,1741,233],[1401,0,512,512]]}
];
...
(lib.BackgroundSoccer1RecreaUsa = function() {
	this.initialize(ss["soccerA_atlas_1"]);
	this.gotoAndStop(0);
...
if (reversed == null) { reversed = false; }
	...
	this.shape.graphics.rf(["rgba(0,0,0,0.969)","rgba(0,0,0,0.047)"],[0.306,1],0,0,0,0,0,72.6).s().p("An4H4QjQjQgBkoQABknDQjRQDSjQEmAAQEoAADQDQQDSDRAAEnQAAEojSDQQjQDRkoAAQkmAAjSjRg");
	this.shape.setTransform(71.35,71.325);

	this.timeline.addTween(cjs.Tween.get(this.shape).wait(1));

	this._renderFirstFrame();

}).prototype = getMCSymbolPrototype(lib.Symbol53, new cjs.Rectangle(0,0,142.7,142.7), null);
...
if (reversed == null) { reversed = false; }
	...
	this.etiketa.setTransform(12.9453,-12.9568,1.777,1.6799);
	this.etiketa.shadow = new cjs.Shadow("rgba(0,0,0,1)",0,0,9);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.etiketa},{t:this.mivar}]}).wait(4));

	// Layer 4
	this.instance = new lib.Symbol53();
	this.instance.setTransform(17.15,38.1,1,1,0,0,0,71.4,71.3);

	this.instance_1 = new lib.Bitmap26();
	this.instance_1.setTransform(-89,-53);
...
p.nominalBounds = new cjs.Rectangle(-105.9,-53,277.3,191.7);
...
// stage content:
(lib.soccerA = function(mode,startPosition,loop,reversed) {
if (loop == null) { loop = true; }
if (reversed == null) { reversed = false; }
	var props = new Object();
	props.mode = mode;
	...
	this.bt5.name = "bt5";
	this.bt5.setTransform(830.85,281.95,0.8676,0.8676,0,0,0,-0.1,0.1);

	this.bt4 = new lib.Symbol12_1();
	this.bt4.name = "bt4";
	this.bt4.setTransform(584.8,281.95,0.8676,0.8676,0,0,0,-0.1,0.1);
	...
	this.bt2.name = "bt2";
	this.bt2.setTransform(716.5,83,0.8676,0.8676,0,0,0,-0.1,0.1);
	...
	this.bt1.name = "bt1";
	this.bt1.setTransform(486.6,83,0.8676,0.8676,0,0,0,-0.1,0.1);
	...
	this.instance_1.setTransform(15,15,0.3351,0.3351);

	this.instance_2 = new lib.buchananslogo();
	this.instance_2.setTransform(534,650,0.1232,0.1232);

	this.instance_3 = new lib.BackgroundSoccer1RecreaUsa();
	this.instance_3.setTransform(-117,-5,1.1833,1.1833);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.instance_3},{t:this.instance_2},{t:this.instance_1}]}).wait(2));

	this._renderFirstFrame();

}).prototype = p = new lib.AnMovieClip();
p.nominalBounds = new cjs.Rectangle(-409.9,-231.8,1807.5,1143.9);
// library properties:
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/soccerA_atlas_1.png?1757338073830", id:"soccerA_atlas_1"},
		{src:"sounds/CORNETAPERDIO.mp3?1757338073942", id:"CORNETAPERDIO"},
		{src:"sounds/CORNETAUNAVEZ.mp3?1757338073942", id:"CORNETAUNAVEZ"},
		{src:"https://code.jquery.com/jquery-3.4.1.min.js?1757338073942", id:"lib/jquery-3.4.1.min.js"},
		{src:"components/sdk/anwidget.js?1757338073942", id:"sdk/anwidget.js"},
		{src:"components/video/src/video.js?1757338073942", id:"an.Video"}
	],
	preloads: []
};
