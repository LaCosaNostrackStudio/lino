...
lib.ssMetadata = [
		{name:"donde cayo_atlas_1", frames: [[0,3915,82,82],[1082,2233,164,40],[1082,2163,206,68],[1290,2163,200,68],[0,3111,1399,802],[1082,2111,470,50],[1202,0,512,512],[0,0,1200,1200],[1082,1202,600,600],[0,1202,1080,1080],[0,2284,1360,825],[1082,1804,312,305]]}
];
...
(lib.Bitmap10 = function() {
	this.initialize(ss["donde cayo_atlas_1"]);
	this.gotoAndStop(0);
...
(lib.craiyon_121926_image = function() {
	this.initialize(ss["donde cayo_atlas_1"]);
	this.gotoAndStop(7);
}).prototype = p = new cjs.Sprite();
...
(lib.craiyon_122153_image = function() {
	this.initialize(ss["donde cayo_atlas_1"]);
	this.gotoAndStop(8);
}).prototype = p = new cjs.Sprite();
...
(lib.craiyon_122613_image = function() {
	this.initialize(ss["donde cayo_atlas_1"]);
	this.gotoAndStop(9);
}).prototype = p = new cjs.Sprite();
...
if (reversed == null) { reversed = false; }
	...
	// Capa_2
	this.instance = new lib.craiyon_121926_image();
	this.instance.setTransform(-137,-163,0.4001,0.4001);

	this.instance_1 = new lib.craiyon_122153_image();
	this.instance_1.setTransform(-90,-105,0.6458,0.6458);

	this.instance_2 = new lib.craiyon_122613_image();
	this.instance_2.setTransform(-97,-122,0.3844,0.3844);
...
p.nominalBounds = new cjs.Rectangle(-137,-163,480.1,480.1);
...
if (reversed == null) { reversed = false; }
	...
	this.instance.setTransform(-19,-7,0.4471,0.4471);

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(1));

	this._renderFirstFrame();

}).prototype = getMCSymbolPrototype(lib.Símbolo3, new cjs.Rectangle(-19,-7,139.5,136.4), null);
...
if (reversed == null) { reversed = false; }
	...
	this.shape_29.setTransform(661.7198,233.3738,1.1248,0.9485,180);

	this.shape_30 = new cjs.Shape();
	this.shape_30.graphics.f().s("#F7C63C").ss(2,1).p("AAbgIIg1AR");
	this.shape_30.setTransform(641.4447,224.814,1.1248,0.9485,180);

	this.shape_31 = new cjs.Shape();
	this.shape_31.graphics.f().s("#F7C63C").ss(2,1).p("AAKAfIgTg9");
	this.shape_31.setTransform(651.4557,207.4335,1.1248,0.9485,180);

	this.shape_32 = new cjs.Shape();
	this.shape_32.graphics.f().s("#F7C63C").ss(2,1).p("AgbAJIA3gR");
	this.shape_32.setTransform(671.8433,216.2779,1.1248,0.9485,180);

	this.shape_33 = new cjs.Shape();
	this.shape_33.graphics.f().s("#F7C63C").ss(2,1).p("AhLglICXBL");
	this.shape_33.setTransform(676.5957,228.9634,1.1248,0.9485,180);

	this.shape_34 = new cjs.Shape();
	this.shape_34.graphics.f().s("#F7C63C").ss(2,1).p("AAmhLIhLCX");
	this.shape_34.setTransform(646.6752,237.3573,1.1248,0.9485,180);

	this.shape_35 = new cjs.Shape();
	this.shape_35.graphics.f().s("#F7C63C").ss(2,1).p("ABMAmIiXhL");
	this.shape_35.setTransform(636.7204,212.1521,1.1248,0.9485,180);

	this.shape_36 = new cjs.Shape();
	this.shape_36.graphics.f().s("#F7C63C").ss(2,1).p("AglBMIBLiX");
	this.shape_36.setTransform(666.6128,203.7345,1.1248,0.9485,180);

	this.shape_37 = new cjs.Shape();
	this.shape_37.graphics.f().s("#F7C63C").ss(2,1).p("AgSgVIAlAr");
	this.shape_37.setTransform(43.7651,77.6136,1.1248,0.9485,180);

	this.shape_38 = new cjs.Shape();
	this.shape_38.graphics.f().s("#F7C63C").ss(2,1).p("AAWgSIgrAl");
	this.shape_38.setTransform(21.156,76.2383,1.1248,0.9485,180);

	this.shape_39 = new cjs.Shape();
	this.shape_39.graphics.f().s("#F7C63C").ss(2,1).p("AAVAYIgpgv");
	this.shape_39.setTransform(22.5621,56.9373,1.1248,0.9485,180);

	this.shape_40 = new cjs.Shape();
	this.shape_40.graphics.f().s("#F7C63C").ss(2,1).p("AgVATIArgl");
	this.shape_40.setTransform(45.3961,58.5734,1.1248,0.9485,180);

	this.shape_41 = new cjs.Shape();
	this.shape_41.graphics.f().s("#F7C63C").ss(2,1).p("AhUgFICoAL");
	this.shape_41.setTransform(55.5478,68.7455,1.1248,0.9485,180);

	this.shape_42 = new cjs.Shape();
	this.shape_42.graphics.f().s("#F7C63C").ss(2,1).p("AAGhTIgLCn");
	this.shape_42.setTransform(31.6732,86.1497,1.1248,0.9485,180);

	this.shape_43 = new cjs.Shape();
	this.shape_43.graphics.f().s("#F7C63C").ss(2,1).p("ABUAGIiogL");
	this.shape_43.setTransform(11.0606,66.0424,1.1248,0.9485,180);

	this.shape_44 = new cjs.Shape();
	this.shape_44.graphics.f().s("#F7C63C").ss(2,1).p("AgFBUIALin");
	this.shape_44.setTransform(34.879,48.6383,1.1248,0.9485,180);

	this.shape_45 = new cjs.Shape();
	this.shape_45.graphics.f().s("#F7C63C").ss(2,1).p("AgIgPIARAf");
	this.shape_45.setTransform(279.8112,93.192,1.1248,0.9485,180);

	this.shape_46 = new cjs.Shape();
	this.shape_46.graphics.f().s("#F7C63C").ss(2,1).p("AAQgIIgfAR");
	this.shape_46.setTransform(265.9757,89.8013,1.1248,0.9485,180);

	this.shape_47 = new cjs.Shape();
	this.shape_47.graphics.f().s("#F7C63C").ss(2,1).p("AAKASIgTgj");
	this.shape_47.setTransform(269.8845,77.9456,1.1248,0.9485,180);

	this.shape_48 = new cjs.Shape();
	this.shape_48.graphics.f().s("#F7C63C").ss(2,1).p("AgPAJIAfgR");
	this.shape_48.setTransform(283.8324,81.526,1.1248,0.9485,180);

	this.shape_49 = new cjs.Shape();
	this.shape_49.graphics.f().s("#F7C63C").ss(2,1).p("AgzgOIBnAd");
	this.shape_49.setTransform(288.5286,89.0188,1.1248,0.9485,180);

	this.shape_50 = new cjs.Shape();
	this.shape_50.graphics.f().s("#F7C63C").ss(2,1).p("AAPgzIgdBn");
	this.shape_50.setTransform(270.9531,97.1281,1.1248,0.9485,180);

	this.shape_51 = new cjs.Shape();
	this.shape_51.graphics.f().s("#F7C63C").ss(2,1).p("AA0APIhngd");
	this.shape_51.setTransform(261.3077,82.3085,1.1248,0.9485,180);

	this.shape_52 = new cjs.Shape();
	this.shape_52.graphics.f().s("#F7C63C").ss(2,1).p("AgOA0IAdhn");
	this.shape_52.setTransform(278.8832,74.1755,1.1248,0.9485,180);

	this.shape_53 = new cjs.Shape();
	this.shape_53.graphics.f().s("#F7C63C").ss(2,1).p("AgOgJIAeAT");
	this.shape_53.setTransform(484.8962,348.4452,1.1248,0.9485,180);

	this.shape_54 = new cjs.Shape();
	this.shape_54.graphics.f().s("#F7C63C").ss(2,1).p("AAKgOIgTAd");
	this.shape_54.setTransform(470.8077,350.9349,1.1248,0.9485,180);

	this.shape_55 = new cjs.Shape();
	this.shape_55.graphics.f().s("#F7C63C").ss(2,1).p("AARALIghgV");
	this.shape_55.setTransform(467.6581,338.9369,1.1248,0.9485,180);

	this.shape_56 = new cjs.Shape();
	this.shape_56.graphics.f().s("#F7C63C").ss(2,1).p("AgJAPIATgd");
	this.shape_56.setTransform(481.9716,336.5658,1.1248,0.9485,180);

	this.shape_57 = new cjs.Shape();
	this.shape_57.graphics.f().s("#F7C63C").ss(2,1).p("Ag0ALIBpgV");
	this.shape_57.setTransform(490.2673,341.2843,1.1248,0.9485,180);

	this.shape_58 = new cjs.Shape();
	this.shape_58.graphics.f().s("#F7C63C").ss(2,1).p("AgKg0IAVBp");
	this.shape_58.setTransform(479.272,355.44,1.1248,0.9485,180);

	this.shape_59 = new cjs.Shape();
	this.shape_59.graphics.f().s("#F7C63C").ss(2,1).p("AA1gKIhpAV");
	this.shape_59.setTransform(462.4839,346.1689,1.1248,0.9485,180);

	this.shape_60 = new cjs.Shape();
	this.shape_60.graphics.f().s("#F7C63C").ss(2,1).p("AALA1IgVhp");
	this.shape_60.setTransform(473.4791,332.0369,1.1248,0.9485,180);

	this.shape_61 = new cjs.Shape();
	this.shape_61.graphics.f().s("#F7C63C").ss(2,1).p("AgcASIA5gj");
	this.shape_61.setTransform(229.7561,353.1874,1.1248,0.9485,180);

	this.shape_62 = new cjs.Shape();
	this.shape_62.graphics.f().s("#F7C63C").ss(2,1).p("AgRgcIAjA5");
	this.shape_62.setTransform(223.4008,375.0968,1.1248,0.9485,180);

	this.shape_63 = new cjs.Shape();
	this.shape_63.graphics.f().s("#F7C63C").ss(2,1).p("AAhgTIhBAn");
	this.shape_63.setTransform(197.0235,369.9514,1.1248,0.9485,180);

	this.shape_64 = new cjs.Shape();
	this.shape_64.graphics.f().s("#F7C63C").ss(2,1).p("AASAdIgjg5");
	this.shape_64.setTransform(203.7725,347.8287,1.1248,0.9485,180);

	this.shape_65 = new cjs.Shape();
	this.shape_65.graphics.f().s("#F7C63C").ss(2,1).p("AgXBhIAvjB");
	this.shape_65.setTransform(219.8576,339.8854,1.1248,0.9485,180);

	this.shape_66 = new cjs.Shape();
	this.shape_66.graphics.f().s("#F7C63C").ss(2,1).p("AhggXIDBAv");
	this.shape_66.setTransform(239.1766,366.7267,1.1248,0.9485,180);

	this.shape_67 = new cjs.Shape();
	this.shape_67.graphics.f().s("#F7C63C").ss(2,1).p("AAYhgIgvDB");
	this.shape_67.setTransform(207.372,383.0401,1.1248,0.9485,180);

	this.shape_68 = new cjs.Shape();
	this.shape_68.graphics.f().s("#F7C63C").ss(2,1).p("ABhAYIjBgv");
	this.shape_68.setTransform(188.0249,356.1988,1.1248,0.9485,180);
...
p.nominalBounds = new cjs.Rectangle(-79.5,-67.5,139.5,467.8);
...
if (reversed == null) { reversed = false; }
	...
	this.shape = new cjs.Shape();
	this.shape.graphics.f("#99FF00").s().p("A26E7IAAp2MAt1AAAIAAJ2g");
...
p.nominalBounds = new cjs.Rectangle(-137,-371,480.1,688.1);
...
p.nominalBounds = new cjs.Rectangle(-518.1,-163,861.2,1162.6);
...
if (reversed == null) { reversed = false; }
	...
	this.timeline.addTween(cjs.Tween.get(this.cajaa).wait(1).to({_off:false},0).to({y:355.25},28,cjs.Ease.get(1)).wait(1).to({regX:103.1,regY:418.3,x:352.2,y:661.15},0).wait(1).to({x:368.1},0).wait(1).to({x:394.65},0).wait(1).to({x:431.85},0).wait(1).to({x:479.65},0).wait(1).to({x:538.05},0).wait(1).to({x:607.1},0).wait(1).to({x:686.8},0).wait(1).to({x:777.05},0).wait(1).to({regX:116,regY:112.4,x:890.9,y:355.25},0).wait(1).to({regX:103.1,regY:418.3,x:846.45,y:671},0).wait(1).to({x:814.6,y:680.95},0).wait(1).to({x:782.35,y:691.05},0).wait(1).to({x:749.8,y:701.25},0).wait(1).to({x:716.9,y:711.55},0).wait(1).to({x:683.65,y:721.95},0).wait(1).to({x:650.05,y:732.45},0).wait(1).to({regX:116,regY:112.4,x:629,y:437.2},0).wait(1).to({regX:103.1,regY:418.3,x:577.8,y:731.4},0).wait(1).to({x:539.45,y:719.75},0).wait(1).to({x:501.05,y:708.05},0).wait(1).to({x:462.6,y:696.35},0).wait(1).to({x:424.05,y:684.6},0).wait(1).to({x:385.5,y:672.9},0).wait(1).to({regX:116,regY:112.4,x:359.8,y:355.25},0).wait(1).to({regX:103.1,regY:418.3,x:352.2,y:661.15},0).wait(1).to({x:368.1},0).wait(1).to({x:394.65},0).wait(1).to({x:431.85},0).wait(1).to({x:479.65},0).wait(1).to({x:538.05},0).wait(1).to({x:607.1},0).wait(1).to({x:686.8},0).wait(1).to({x:777.05},0).wait(1).to({regX:116,regY:112.4,x:890.9,y:355.25},0).wait(1).to({regX:103.1,regY:418.3,x:867.05,y:664.55},0).wait(1).to({x:856.1,y:667.95},0).wait(1).to({x:845.1,y:671.4},0).wait(1).to({x:834.05,y:674.9},0).wait(1).to({x:822.95,y:678.35},0).wait(1).to({x:811.8,y:681.85},0).wait(1).to({x:800.65,y:685.35},0).wait(1).to({x:789.4,y:688.85},0).wait(1).to({x:778.15,y:692.35},0).wait(1).to({x:766.85,y:695.9},0).wait(1).to({x:755.5,y:699.45},0).wait(1).to({x:744.1,y:703},0).wait(1).to({x:732.7,y:706.6},0).wait(1).to({x:721.2,y:710.2},0).wait(1).to({x:709.7,y:713.8},0).wait(1).to({x:698.15,y:717.4},0).wait(1).to({x:686.55,y:721},0).wait(1).to({x:674.9,y:724.65},0).wait(1).to({x:663.2,y:728.3},0).wait(1).to({x:651.5,y:732},0).wait(1).to({x:639.75,y:735.65},0).wait(1).to({x:627.95,y:739.35},0).wait(1).to({regX:116,regY:112.4,x:629,y:437.2},0).wait(1).to({regX:103.1,regY:418.3,x:612.45,y:741.95},0).wait(1).to({x:608.85,y:740.85},0).wait(1).to({x:605.2,y:739.75},0).wait(1).to({x:601.6,y:738.65},0).wait(1).to({x:597.95,y:737.55},0).wait(1).to({x:594.35,y:736.45},0).wait(1).to({x:590.75,y:735.35},0).wait(1).to({x:587.1,y:734.25},0).wait(1).to({x:583.5,y:733.15},0).wait(1).to({x:579.85,y:732.05},0).wait(1).to({x:576.25,y:730.95},0).wait(1).to({x:572.6,y:729.85},0).wait(1).to({x:569,y:728.75},0).wait(1).to({x:565.35,y:727.65},0).wait(1).to({x:561.75,y:726.55},0).wait(1).to({x:558.1,y:725.45},0).wait(1).to({x:554.45,y:724.3},0).wait(1).to({x:550.85,y:723.2},0).wait(1).to({x:547.2,y:722.1},0).wait(1).to({x:543.6,y:721},0).wait(1).to({x:539.95,y:719.9},0).wait(1).to({x:536.35,y:718.8},0).wait(1).to({x:532.7,y:717.7},0).wait(1).to({x:529.05,y:716.6},0).wait(1).to({x:525.45,y:715.5},0).wait(1).to({x:521.8,y:714.4},0).wait(1).to({x:518.15,y:713.25},0).wait(1).to({x:514.55,y:712.15},0).wait(1).to({x:510.9,y:711.05},0).wait(1).to({x:507.25,y:709.95},0).wait(1).to({x:503.65,y:708.85},0).wait(1).to({x:500,y:707.75},0).wait(1).to({x:496.35,y:706.65},0).wait(1).to({x:492.75,y:705.55},0).wait(1).to({x:489.1,y:704.4},0).wait(1).to({x:485.45,y:703.3},0).wait(1).to({x:481.8,y:702.2},0).wait(1).to({x:478.2,y:701.1},0).wait(1).to({x:474.55,y:700},0).wait(1).to({x:470.9,y:698.9},0).wait(1).to({x:467.25,y:697.75},0).wait(1).to({x:463.6,y:696.65},0).wait(1).to({x:460,y:695.55},0).wait(1).to({x:456.35,y:694.45},0).wait(1).to({x:452.7,y:693.35},0).wait(1).to({x:449.05,y:692.25},0).wait(1).to({x:445.4,y:691.1},0).wait(1).to({x:441.75,y:690},0).wait(1).to({x:438.15,y:688.9},0).wait(1).to({x:434.5,y:687.8},0).wait(1).to({x:430.85,y:686.7},0).wait(1).to({x:427.2,y:685.6},0).wait(1).to({x:423.55,y:684.45},0).wait(1).to({x:419.9,y:683.35},0).wait(1).to({x:416.25,y:682.25},0).wait(1).to({x:412.6,y:681.15},0).wait(1).to({x:408.95,y:680},0).wait(1).to({x:405.3,y:678.9},0).wait(1).to({x:401.65,y:677.8},0).wait(1).to({x:398,y:676.7},0).wait(1).to({x:394.35,y:675.6},0).wait(1).to({x:390.7,y:674.45},0).wait(1).to({x:387.05,y:673.35},0).wait(1).to({x:383.4,y:672.25},0).wait(1).to({x:379.75,y:671.15},0).wait(1).to({x:376.1,y:670},0).wait(1).to({x:372.45,y:668.9},0).wait(1).to({x:368.8,y:667.8},0).wait(1).to({x:365.15,y:666.7},0).wait(1).to({x:361.5,y:665.6},0).wait(1).to({x:357.85,y:664.45},0).wait(1).to({x:354.2,y:663.35},0).wait(1).to({x:350.55,y:662.25},0).wait(1).to({regX:116,regY:112.4,x:359.8,y:355.25},0).to({_off:true},1).wait(3));
	...
	this.timeline.addTween(cjs.Tween.get(this.cajab).wait(1).to({_off:false},0).to({y:437.2},28,cjs.Ease.get(1)).wait(1).to({regX:103.1,regY:418.3,x:613.4,y:742.25},0).wait(1).to({x:605.35,y:739.8},0).wait(1).to({x:591.9,y:735.7},0).wait(1).to({x:573.1,y:729.95},0).wait(1).to({x:548.95,y:722.6},0).wait(1).to({x:519.4,y:713.55},0).wait(1).to({x:484.5,y:702.9},0).wait(1).to({x:444.2,y:690.65},0).wait(1).to({x:398.55,y:676.7},0).wait(1).to({regX:116,regY:112.4,x:360.45,y:355.25},0).wait(1).to({regX:103.1,regY:418.3,x:411.5,y:661.05},0).wait(1).to({x:476.2,y:660.95},0).wait(1).to({x:541.6,y:660.85},0).wait(1).to({x:607.7,y:660.8},0).wait(1).to({x:674.55,y:660.7},0).wait(1).to({x:742.05,y:660.6},0).wait(1).to({x:810.3,y:660.5},0).wait(1).to({regX:116,regY:112.4,x:892.15,y:354.55},0).wait(1).to({regX:103.1,regY:418.3,x:841.8,y:672.2},0).wait(1).to({x:804.3,y:683.95},0).wait(1).to({x:766.75,y:695.75},0).wait(1).to({x:729.2,y:707.55},0).wait(1).to({x:691.55,y:719.4},0).wait(1).to({x:653.85,y:731.2},0).wait(1).to({regX:116,regY:112.4,x:629,y:437.2},0).wait(1).to({regX:103.1,regY:418.3,x:613.4,y:742.25},0).wait(1).to({x:605.35,y:739.8},0).wait(1).to({x:591.9,y:735.7},0).wait(1).to({x:573.1,y:729.95},0).wait(1).to({x:548.95,y:722.6},0).wait(1).to({x:519.4,y:713.55},0).wait(1).to({x:484.5,y:702.9},0).wait(1).to({x:444.2,y:690.65},0).wait(1).to({x:398.55,y:676.7},0).wait(1).to({regX:116,regY:112.4,x:360.45,y:355.25},0).wait(1).to({regX:103.1,regY:418.3,x:369.7,y:661.1},0).wait(1).to({x:391.95,y:661.05},0).wait(1).to({x:414.3},0).wait(1).to({x:436.75,y:661},0).wait(1).to({x:459.25},0).wait(1).to({x:481.85,y:660.95},0).wait(1).to({x:504.55,y:660.9},0).wait(1).to({x:527.35},0).wait(1).to({x:550.2,y:660.85},0).wait(1).to({x:573.15},0).wait(1).to({x:596.15,y:660.8},0).wait(1).to({x:619.3,y:660.75},0).wait(1).to({x:642.5},0).wait(1).to({x:665.8,y:660.7},0).wait(1).to({x:689.15},0).wait(1).to({x:712.6,y:660.65},0).wait(1).to({x:736.15,y:660.6},0).wait(1).to({x:759.8},0).wait(1).to({x:783.5,y:660.55},0).wait(1).to({x:807.3,y:660.5},0).wait(1).to({x:831.2},0).wait(1).to({x:855.15,y:660.45},0).wait(1).to({regX:116,regY:112.4,x:892.15,y:354.55},0).wait(1).to({regX:103.1,regY:418.3,x:875.7,y:661.55},0).wait(1).to({x:872.15,y:662.65},0).wait(1).to({x:868.6,y:663.75},0).wait(1).to({x:865.05,y:664.85},0).wait(1).to({x:861.55,y:666},0).wait(1).to({x:858,y:667.1},0).wait(1).to({x:854.45,y:668.2},0).wait(1).to({x:850.9,y:669.3},0).wait(1).to({x:847.35,y:670.45},0).wait(1).to({x:843.8,y:671.55},0).wait(1).to({x:840.3,y:672.65},0).wait(1).to({x:836.75,y:673.75},0).wait(1).to({x:833.2,y:674.9},0).wait(1).to({x:829.65,y:676},0).wait(1).to({x:826.1,y:677.1},0).wait(1).to({x:822.55,y:678.2},0).wait(1).to({x:819,y:679.35},0).wait(1).to({x:815.45,y:680.45},0).wait(1).to({x:811.9,y:681.55},0).wait(1).to({x:808.35,y:682.7},0).wait(1).to({x:804.8,y:683.8},0).wait(1).to({x:801.25,y:684.9},0).wait(1).to({x:797.7,y:686},0).wait(1).to({x:794.15,y:687.15},0).wait(1).to({x:790.6,y:688.25},0).wait(1).to({x:787.05,y:689.35},0).wait(1).to({x:783.5,y:690.5},0).wait(1).to({x:779.95,y:691.6},0).wait(1).to({x:776.4,y:692.7},0).wait(1).to({x:772.85,y:693.85},0).wait(1).to({x:769.3,y:694.95},0).wait(1).to({x:765.75,y:696.05},0).wait(1).to({x:762.2,y:697.2},0).wait(1).to({x:758.65,y:698.3},0).wait(1).to({x:755.1,y:699.4},0).wait(1).to({x:751.55,y:700.55},0).wait(1).to({x:748,y:701.65},0).wait(1).to({x:744.45,y:702.75},0).wait(1).to({x:740.85,y:703.9},0).wait(1).to({x:737.3,y:705},0).wait(1).to({x:733.75,y:706.1},0).wait(1).to({x:730.2,y:707.25},0).wait(1).to({x:726.65,y:708.35},0).wait(1).to({x:723.1,y:709.45},0).wait(1).to({x:719.5,y:710.6},0).wait(1).to({x:715.95,y:711.7},0).wait(1).to({x:712.4,y:712.8},0).wait(1).to({x:708.85,y:713.95},0).wait(1).to({x:705.3,y:715.05},0).wait(1).to({x:701.7,y:716.2},0).wait(1).to({x:698.15,y:717.3},0).wait(1).to({x:694.6,y:718.4},0).wait(1).to({x:691,y:719.55},0).wait(1).to({x:687.45,y:720.65},0).wait(1).to({x:683.9,y:721.75},0).wait(1).to({x:680.35,y:722.9},0).wait(1).to({x:676.75,y:724},0).wait(1).to({x:673.2,y:725.15},0).wait(1).to({x:669.65,y:726.25},0).wait(1).to({x:666.05,y:727.35},0).wait(1).to({x:662.5,y:728.5},0).wait(1).to({x:658.95,y:729.6},0).wait(1).to({x:655.35,y:730.75},0).wait(1).to({x:651.8,y:731.85},0).wait(1).to({x:648.2,y:733},0).wait(1).to({x:644.65,y:734.1},0).wait(1).to({x:641.1,y:735.2},0).wait(1).to({x:637.5,y:736.35},0).wait(1).to({x:633.95,y:737.45},0).wait(1).to({x:630.35,y:738.6},0).wait(1).to({x:626.8,y:739.7},0).wait(1).to({x:623.2,y:740.85},0).wait(1).to({x:619.65,y:741.95},0).wait(1).to({regX:116,regY:112.4,x:629,y:437.2},0).to({_off:true},1).wait(3));
	...
	this.timeline.addTween(cjs.Tween.get(this.cajac).wait(1).to({_off:false},0).to({y:355.25},28,cjs.Ease.get(1)).wait(1).to({regX:103.1,regY:418.3,x:875.35,y:661.95},0).wait(1).to({x:867.5,y:664.4},0).wait(1).to({x:854.4,y:668.5},0).wait(1).to({x:836.05,y:674.25},0).wait(1).to({x:812.5,y:681.6},0).wait(1).to({x:783.7,y:690.65},0).wait(1).to({x:749.65,y:701.3},0).wait(1).to({x:710.35,y:713.55},0).wait(1).to({x:665.85,y:727.5},0).wait(1).to({regX:116,regY:112.4,x:629,y:437.2},0).wait(1).to({regX:103.1,regY:418.3,x:583.75,y:733.15},0).wait(1).to({x:551.1,y:723.05},0).wait(1).to({x:518.05,y:712.9},0).wait(1).to({x:484.65,y:702.65},0).wait(1).to({x:450.9,y:692.25},0).wait(1).to({x:416.8,y:681.75},0).wait(1).to({x:382.35,y:671.15},0).wait(1).to({regX:116,regY:112.4,x:360.45,y:354.55},0).wait(1).to({regX:103.1,regY:418.3,x:422.95,y:660.5},0).wait(1).to({x:498.55,y:660.6},0).wait(1).to({x:574.2,y:660.7},0).wait(1).to({x:650,y:660.8},0).wait(1).to({x:725.85,y:660.9},0).wait(1).to({x:801.85,y:661},0).wait(1).to({regX:116,regY:112.4,x:890.9,y:355.25},0).wait(1).to({regX:103.1,regY:418.3,x:875.35,y:661.95},0).wait(1).to({x:867.5,y:664.4},0).wait(1).to({x:854.4,y:668.5},0).wait(1).to({x:836.05,y:674.25},0).wait(1).to({x:812.5,y:681.6},0).wait(1).to({x:783.7,y:690.65},0).wait(1).to({x:749.65,y:701.3},0).wait(1).to({x:710.35,y:713.55},0).wait(1).to({x:665.85,y:727.5},0).wait(1).to({regX:116,regY:112.4,x:629,y:437.2},0).wait(1).to({regX:103.1,regY:418.3,x:604.85,y:739.65},0).wait(1).to({x:593.65,y:736.15},0).wait(1).to({x:582.35,y:732.7},0).wait(1).to({x:571,y:729.2},0).wait(1).to({x:559.65,y:725.7},0).wait(1).to({x:548.2,y:722.2},0).wait(1).to({x:536.75,y:718.65},0).wait(1).to({x:525.25,y:715.1},0).wait(1).to({x:513.7,y:711.55},0).wait(1).to({x:502.1,y:708},0).wait(1).to({x:490.5,y:704.4},0).wait(1).to({x:478.8,y:700.85},0).wait(1).to({x:467.1,y:697.2},0).wait(1).to({x:455.35,y:693.6},0).wait(1).to({x:443.55,y:689.95},0).wait(1).to({x:431.7,y:686.3},0).wait(1).to({x:419.8,y:682.65},0).wait(1).to({x:407.85,y:679},0).wait(1).to({x:395.85,y:675.3},0).wait(1).to({x:383.85,y:671.6},0).wait(1).to({x:371.8,y:667.9},0).wait(1).to({x:359.7,y:664.15},0).wait(1).to({regX:116,regY:112.4,x:360.45,y:354.55},0).wait(1).to({regX:103.1,regY:418.3,x:354.65,y:660.45},0).wait(1).to({x:361.8},0).wait(1).to({x:368.9},0).wait(1).to({x:376.05},0).wait(1).to({x:383.2},0).wait(1).to({x:390.35,y:660.5},0).wait(1).to({x:397.45},0).wait(1).to({x:404.6},0).wait(1).to({x:411.75},0).wait(1).to({x:418.9},0).wait(1).to({x:426.05,y:660.55},0).wait(1).to({x:433.2},0).wait(1).to({x:440.3},0).wait(1).to({x:447.45},0).wait(1).to({x:454.6},0).wait(1).to({x:461.75,y:660.6},0).wait(1).to({x:468.9},0).wait(1).to({x:476.05},0).wait(1).to({x:483.2},0).wait(1).to({x:490.35},0).wait(1).to({x:497.5},0).wait(1).to({x:504.65,y:660.65},0).wait(1).to({x:511.8},0).wait(1).to({x:518.95},0).wait(1).to({x:526.15},0).wait(1).to({x:533.3},0).wait(1).to({x:540.45,y:660.7},0).wait(1).to({x:547.6},0).wait(1).to({x:554.75},0).wait(1).to({x:561.9},0).wait(1).to({x:569.1},0).wait(1).to({x:576.25,y:660.75},0).wait(1).to({x:583.4},0).wait(1).to({x:590.6},0).wait(1).to({x:597.75},0).wait(1).to({x:604.9},0).wait(1).to({x:612.1},0).wait(1).to({x:619.25,y:660.8},0).wait(1).to({x:626.4},0).wait(1).to({x:633.6},0).wait(1).to({x:640.75},0).wait(1).to({x:647.95},0).wait(1).to({x:655.1,y:660.85},0).wait(1).to({x:662.3},0).wait(1).to({x:669.45},0).wait(1).to({x:676.65},0).wait(1).to({x:683.8},0).wait(1).to({x:691,y:660.9},0).wait(1).to({x:698.15},0).wait(1).to({x:705.35},0).wait(1).to({x:712.55},0).wait(1).to({x:719.7},0).wait(1).to({x:726.9,y:660.95},0).wait(1).to({x:734.1},0).wait(1).to({x:741.25},0).wait(1).to({x:748.45},0).wait(1).to({x:755.65},0).wait(1).to({x:762.85},0).wait(1).to({x:770,y:661},0).wait(1).to({x:777.2},0).wait(1).to({x:784.4},0).wait(1).to({x:791.6},0).wait(1).to({x:798.8},0).wait(1).to({x:806,y:661.05},0).wait(1).to({x:813.15},0).wait(1).to({x:820.35},0).wait(1).to({x:827.55},0).wait(1).to({x:834.75},0).wait(1).to({x:841.95,y:661.1},0).wait(1).to({x:849.15},0).wait(1).to({x:856.35},0).wait(1).to({x:863.55},0).wait(1).to({x:870.75},0).wait(1).to({regX:116,regY:112.4,x:890.9,y:355.25},0).to({_off:true},1).wait(3));

	// Capa_4
	this.instance_1 = new lib.Símbolo10();
	this.instance_1.setTransform(627.7,472.15);

	this.playbt = new lib.Símbolo4();
	this.playbt.name = "playbt";
	this.playbt.setTransform(628.25,594.2,1,1,0,0,0,146.7,31.6);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[]}).to({state:[{t:this.playbt},{t:this.instance_1}]},1).to({state:[]},28).wait(136));

	// Layer 3
	this.instance_2 = new lib.Symbol27_1();
	this.instance_2.setTransform(128.5,111.55,1,1,0,0,0,274.4,170.1);

	this.instance_3 = new lib.Bitmap18();
	this.instance_3.setTransform(513,659);

	this.instance_4 = new lib.Mapadebits3();
	this.instance_4.setTransform(-25,-42);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.instance_4},{t:this.instance_3},{t:this.instance_2}]}).wait(165));

	this._renderFirstFrame();

}).prototype = p = new lib.AnMovieClip();
p.nominalBounds = new cjs.Rectangle(-60.2,52.6,1405,1291.7);
// library properties:
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/donde cayo_atlas_1.png?1757348277362", id:"donde cayo_atlas_1"},
		{src:"sounds/checkpoint.mp3?1757348277640", id:"checkpoint"},
		{src:"sounds/click.mp3?1757348277640", id:"click"},
		{src:"sounds/click2.mp3?1757348277640", id:"click2"},
		{src:"sounds/CORNETAPERDIO.mp3?1757348277640", id:"CORNETAPERDIO"},
		{src:"sounds/CORNETAUNAVEZ.mp3?1757348277640", id:"CORNETAUNAVEZ"},
		{src:"sounds/moneda2.mp3?1757348277640", id:"moneda2"},
		{src:"sounds/sonidofindeltiempoterminoeltiempobuzzercornetamalCORTA.mp3?1757348277640", id:"sonidofindeltiempoterminoeltiempobuzzercornetamalCORTA"},
		{src:"https://code.jquery.com/jquery-3.4.1.min.js?1757348277640", id:"lib/jquery-3.4.1.min.js"},
		{src:"components/sdk/anwidget.js?1757348277640", id:"sdk/anwidget.js"},
		{src:"components/video/src/video.js?1757348277640", id:"an.Video"}
	],
	preloads: []
};
