...
lib.ssMetadata = [
		{name:"TIK TOK CHALLENGE8_atlas_", frames: [[1609,1225,82,82],[1810,1295,164,40],[1810,1225,206,68],[1401,1225,206,115],[1401,1342,407,58],[1401,1082,523,141],[0,1082,1399,802],[1401,1402,470,50],[0,0,1920,1080]]}
];
...
(lib.Bitmap10 = function() {
	this.spriteSheet = ss["TIK TOK CHALLENGE8_atlas_"];
	this.gotoAndStop(0);
...
(lib.EditableTIKTOKEXPERIENCERecreaUsa = function() {
	this.spriteSheet = ss["TIK TOK CHALLENGE8_atlas_"];
	this.gotoAndStop(8);
}).prototype = p = new cjs.Sprite();
// helper functions:
...
(lib.Symbol12 = function(mode,startPosition,loop) {
	...
	// Layer 1
	this.etiketa = new cjs.Text("", "66px 'Impact'");
	this.etiketa.name = "etiketa";
	this.etiketa.textAlign = "center";
	this.etiketa.lineHeight = 83;
	this.etiketa.lineWidth = 119;
	this.etiketa.parent = this;
	this.etiketa.setTransform(7.3,-15.1,1.777,1.246);
	this.etiketa.shadow = new cjs.Shadow("rgba(0,209,212,1)",-4,-3,0);
...
}).prototype = getMCSymbolPrototype(lib.Symbol12, new cjs.Rectangle(-107.5,-30,227,120.4), null);
...
// stage content:
(lib.TIKTOKCHALLENGE8 = function(mode,startPosition,loop) {
	this.initialize(mode,startPosition,loop,{});
	...
	this.bt25.setTransform(299.5,386,0.767,0.767,0,0,0,-0.2,0);

	this.bt24 = new lib.Symbol12();
	this.bt24.parent = this;
	this.bt24.setTransform(760.3,193.5,0.767,0.767,0,0,0,-0.2,0);

	this.bt23 = new lib.Symbol12();
	this.bt23.parent = this;
	this.bt23.setTransform(104.5,37.2,0.767,0.767,0,0,0,-0.3,0.1);

	this.bt22 = new lib.Symbol12();
	this.bt22.parent = this;
	this.bt22.setTransform(629.6,304.6,0.767,0.767,0,0,0,-0.3,0.1);

	this.bt21 = new lib.Symbol12();
	this.bt21.parent = this;
	this.bt21.setTransform(1154.4,137,0.767,0.767,0,0,0,-0.2,0.1);

	this.bt20 = new lib.Symbol12();
	this.bt20.parent = this;
	this.bt20.setTransform(95.2,487.7,0.767,0.767,0,0,0,-0.2,0.1);

	this.bt19 = new lib.Symbol12();
	this.bt19.parent = this;
	this.bt19.setTransform(495.9,444.9,0.767,0.767,0,0,0,-0.2,0);

	this.bt18 = new lib.Symbol12();
	this.bt18.parent = this;
	this.bt18.setTransform(112.4,260.9,0.767,0.767,0,0,0,-0.2,0);

	this.bt17 = new lib.Symbol12();
	this.bt17.parent = this;
	this.bt17.setTransform(1175.4,448.6,0.767,0.767,0,0,0,-0.3,0.1);

	this.bt16 = new lib.Symbol12();
	this.bt16.parent = this;
	this.bt16.setTransform(456.2,648.6,0.665,0.665,0,0,0,-0.3,0.1);

	this.bt15 = new lib.Symbol12();
	this.bt15.parent = this;
	this.bt15.setTransform(682.1,37.2,0.767,0.767,0,0,0,-0.2,0.1);

	this.bt14 = new lib.Symbol12();
	this.bt14.parent = this;
	this.bt14.setTransform(872.8,340.8,0.767,0.767,0,0,0,-0.2,0.1);

	this.bt13 = new lib.Symbol12();
	this.bt13.parent = this;
	this.bt13.setTransform(81.7,373,0.767,0.767,0,0,0,-0.2,0);

	this.bt12 = new lib.Symbol12();
	this.bt12.parent = this;
	this.bt12.setTransform(955.3,471.7,1.043,1.043,0,0,0,-0.2,0.1);

	this.bt11 = new lib.Symbol12();
	this.bt11.parent = this;
	this.bt11.setTransform(521.7,153.5,0.767,0.767,0,0,0,-0.3,0.1);
	...
	this.bt10.setTransform(618.7,586.2,0.767,0.767,0,0,0,-0.3,0.1);

	this.bt9 = new lib.Symbol12();
	this.bt9.parent = this;
	this.bt9.setTransform(1125.7,273.1,1.168,1.168,0,0,0,-0.1,0.1);

	this.bt8 = new lib.Symbol12();
	this.bt8.parent = this;
	this.bt8.setTransform(812,639.7,0.767,0.767,0,0,0,-0.2,0.1);

	this.bt7 = new lib.Symbol12();
	this.bt7.parent = this;
	this.bt7.setTransform(346.2,278.9,0.767,0.767,0,0,0,2.5,25.7);

	this.bt6 = new lib.Symbol12();
	this.bt6.parent = this;
	this.bt6.setTransform(394.4,56.9,0.846,0.846,0,0,0,2.5,28.5);

	this.bt5 = new lib.Symbol12();
	this.bt5.parent = this;
	this.bt5.setTransform(1010,609.2,0.95,0.95,0,0,0,-0.2,0.1);

	this.bt4 = new lib.Symbol12();
	this.bt4.parent = this;
	this.bt4.setTransform(306.8,528.7,1.036,1.036,0,0,0,-0.1,0.2);

	this.bt3 = new lib.Symbol12();
	this.bt3.parent = this;
	this.bt3.setTransform(951.4,112,0.767,0.767,0,0,0,-0.2,0);

	this.bt2 = new lib.Symbol12();
	this.bt2.parent = this;
	this.bt2.setTransform(709.7,447.5,0.734,0.734,0,0,0,-0.1,0);

	this.bt1 = new lib.Symbol12();
	this.bt1.parent = this;
	this.bt1.setTransform(211.8,139.7,0.868,0.868,0,0,0,-0.1,0.1);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.fsbtn}]}).to({state:[{t:this.bt1},{t:this.bt2},{t:this.bt3},{t:this.bt4},{t:this.bt5},{t:this.bt6},{t:this.bt7},{t:this.bt8},{t:this.bt9},{t:this.bt10},{t:this.reini},{t:this.btfull},{t:this.bt11},{t:this.bt12},{t:this.bt13},{t:this.bt14},{t:this.bt15},{t:this.bt16},{t:this.bt17},{t:this.bt18},{t:this.bt19},{t:this.bt20},{t:this.bt21},{t:this.bt22},{t:this.bt23},{t:this.bt24},{t:this.bt25},{t:this.instance_2},{t:this.instance_1}]},1).wait(1));

	// Layer 3
	this.instance_3 = new lib.EditableTIKTOKEXPERIENCERecreaUsa();
	this.instance_3.parent = this;
	this.instance_3.setTransform(-1,-3,0.669,0.675);
