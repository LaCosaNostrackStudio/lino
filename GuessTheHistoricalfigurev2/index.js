...
lib.ssMetadata = [
		{name:"index_atlas_1", frames: [[0,0,1500,1000],[1912,143,82,82],[1704,213,164,40],[1704,143,206,68],[1502,293,407,58],[1502,0,523,141],[0,1002,1399,802],[1502,353,470,50],[1502,143,200,148],[1401,1002,626,571]]}
];
...
if (reversed == null) { reversed = false; }
	...
	this.etiketa = new cjs.Text("", "bold 55px 'Arial Black'", "#FFFFFF");
	this.etiketa.name = "etiketa";
	this.etiketa.textAlign = "center";
	this.etiketa.lineHeight = 80;
	this.etiketa.lineWidth = 119;
	this.etiketa.parent = this;
	this.etiketa.setTransform(6.1953,-12.0568,1.777,1.6799);
	...
	this.instance.setTransform(-142,209.7,0.5474,0.5474,-90);
...
p.nominalBounds = new cjs.Rectangle(-142,-133,313.4,342.7);
...
if (reversed == null) { reversed = false; }
	...
	this.bt12.name = "bt12";
	this.bt12.setTransform(1131.2,487.9,0.8676,0.8676,0,0,0,-0.1,0.1);

	this.bt11 = new lib.Symbol12();
	this.bt11.name = "bt11";
	this.bt11.setTransform(891.45,487.9,0.8676,0.8676,0,0,0,-0.1,0.1);

	this.bt10 = new lib.Symbol12();
	this.bt10.name = "bt10";
	this.bt10.setTransform(631.3,487.9,0.8676,0.8676,0,0,0,-0.1,0.1);

	this.bt9 = new lib.Symbol12();
	this.bt9.name = "bt9";
	this.bt9.setTransform(382.2,487.25,0.8676,0.8676,0,0,0,-0.1,0.1);

	this.bt8 = new lib.Symbol12();
	this.bt8.name = "bt8";
	this.bt8.setTransform(144.8,487.25,0.8676,0.8676,0,0,0,-0.1,0.1);

	this.bt7 = new lib.Symbol12();
	this.bt7.name = "bt7";
	this.bt7.setTransform(1061.05,290.4,0.8676,0.8676,0,0,0,-0.1,0.1);

	this.bt6 = new lib.Symbol12();
	this.bt6.name = "bt6";
	this.bt6.setTransform(764.6,290.4,0.8676,0.8676,0,0,0,-0.1,0.1);

	this.bt5 = new lib.Symbol12();
	this.bt5.name = "bt5";
	this.bt5.setTransform(488.55,281.95,0.8676,0.8676,0,0,0,-0.1,0.1);

	this.bt4 = new lib.Symbol12();
	this.bt4.name = "bt4";
	this.bt4.setTransform(203.5,281.95,0.8676,0.8676,0,0,0,-0.1,0.1);

	this.bt3 = new lib.Symbol12();
	this.bt3.name = "bt3";
	this.bt3.setTransform(930.15,78.5,0.8676,0.8676,0,0,0,-0.1,0.1);

	this.bt2 = new lib.Symbol12();
	this.bt2.name = "bt2";
	this.bt2.setTransform(627.9,78.5,0.8676,0.8676,0,0,0,-0.1,0.1);
	...
	this.bt1.name = "bt1";
	this.bt1.setTransform(318.95,78.5,0.8676,0.8676,0,0,0,-0.1,0.1);
	...
	// Layer 3
	this.instance_2 = new lib._182851();
	this.instance_2.setTransform(-188,-37);
...
p.nominalBounds = new cjs.Rectangle(-439.9,-231.8,1784.6999999999998,1194.8);
// library properties:
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/index_atlas_1.png?1773360547187", id:"index_atlas_1"},
		{src:"sounds/CORNETAPERDIO.mp3?1773360547302", id:"CORNETAPERDIO"},
		{src:"sounds/CORNETAUNAVEZ.mp3?1773360547302", id:"CORNETAUNAVEZ"},
		{src:"https://code.jquery.com/jquery-3.4.1.min.js?1773360547302", id:"lib/jquery-3.4.1.min.js"},
		{src:"components/sdk/anwidget.js?1773360547302", id:"sdk/anwidget.js"},
		{src:"components/video/src/video.js?1773360547302", id:"an.Video"}
	],
	preloads: []
};
