...
lib.ssMetadata = [
		{name:"index_atlas_1", frames: [[0,0,1119,681],[0,683,1035,383],[1918,0,117,365],[1535,234,381,214],[1037,683,794,307],[1121,234,412,240],[1381,580,379,12],[1121,0,756,232],[1535,450,128,128],[1121,476,128,128],[1251,476,128,128]]}
];
...
p.nominalBounds = new cjs.Rectangle(-0.2,25.9,756,271);
...
if (reversed == null) { reversed = false; }
	...
	this.instance.setTransform(626.4,-316.15,1,1,0,0,0,150.6,29);
...
if (reversed == null) { reversed = false; }
	...
	this.instance_1.setTransform(917.35,75,1,1,0,0,0,64,64);
	var instance_1Filter_1 = new cjs.ColorFilter(0,0,0,1,23,182,249,0);
	this.instance_1.filters = [instance_1Filter_1];
	this.instance_1.cache(-2,-2,132,132);

	this.instance_2 = new lib.Symbol24();
	this.instance_2.setTransform(336.55,-76.1,1,1,0,0,0,64,64);
	...
	this.instance_3.setTransform(-385.9,-81.65,1.716,1.716,0,0,0,63.7,64);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.instance_3},{t:this.instance_2},{t:this.instance_1}]}).wait(60));
	this.timeline.addTween(cjs.Tween.get(instance_1Filter_1).wait(60));
	this.timeline.addTween(cjs.Tween.get(instance_2Filter_2).wait(60));

	this._renderFirstFrame();

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(-535.6,-248,1517,387);
...
p.nominalBounds = new cjs.Rectangle(-199,-249.5,1502.9,1371.7);
...
if (reversed == null) { reversed = false; }
	...
	this.instance.setTransform(310,1823);

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(99));

	// Layer 7
	this.instance_1 = new lib.Symbol114();
	this.instance_1.setTransform(190.15,280.2,1,1,0,0,0,299.8,102);

	this.instance_2 = new lib.Symbol111();
	this.instance_2.setTransform(372.75,244.2,1,1,0,0,0,344.4,210.1);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[]}).to({state:[{t:this.instance_2},{t:this.instance_1}]},53).wait(46));

	// Layer 2
	this.instance_3 = new lib.Symbol109();
	this.instance_3.setTransform(502.45,-349.35,1,1,0,0,0,559.6,340.7);

	this.timeline.addTween(cjs.Tween.get(this.instance_3).to({y:317.85},59,cjs.Ease.get(1)).wait(40));

	// Layer 3
	this.instance_4 = new lib.Tween2("synched",0);
	this.instance_4.setTransform(493.5,2052.55);
	this.instance_4._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_4).wait(39).to({_off:false},0).to({y:1683.5},59,cjs.Ease.get(1)).wait(1));

	this._renderFirstFrame();

}).prototype = p = new lib.AnMovieClip();
p.nominalBounds = new cjs.Rectangle(329.4,235,732.5000000000001,2009.1);
// library properties:
lib.properties = {
	id: '553CDE4779DC9F41ABD389BC16E99031',
	width: 1000,
	height: 1850,
	fps: 60,
	color: "#FFFFFF",
	opacity: 1.00,
	manifest: [
		{src:"images/index_atlas_1.png?1658827226350", id:"index_atlas_1"}
	],
	preloads: []
};
...
an.compositions['553CDE4779DC9F41ABD389BC16E99031'] = {
