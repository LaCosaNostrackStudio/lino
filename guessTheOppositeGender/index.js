...
lib.ssMetadata = [
		{name:"index_atlas_1", frames: [[1603,1514,82,82],[1810,1584,164,40],[1810,1514,206,68],[1401,1664,407,58],[1401,1371,523,141],[0,973,1399,802],[1401,1724,470,50],[0,0,1619,971],[1401,1514,200,148],[1401,973,406,396]]}
];
...
(lib.ChatGPTImage15abr202609_51_17pm = function() {
	this.initialize(ss["index_atlas_1"]);
	this.gotoAndStop(7);
}).prototype = p = new cjs.Sprite();
...
if (reversed == null) { reversed = false; }
	...
	// Capa_1
	this.instance = new lib.ChatGPTImage15abr202609_51_17pm();
	this.instance.setTransform(0,0,0.8575,0.8575);

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(1));

	this._renderFirstFrame();

}).prototype = getMCSymbolPrototype(lib.Símbolo7, new cjs.Rectangle(0,0,1388.3,832.6), null);
...
if (reversed == null) { reversed = false; }
	...
	this.etiketa = new cjs.Text("", "bold 72px 'Arial Black'", "#FFFFFF");
	...
	this.etiketa.setTransform(-5.7047,-25.0068,1.777,1.6799);
	...
	this.instance.setTransform(-149,-106,0.701,0.701);

	this.shape = new cjs.Shape();
	this.shape.graphics.f("#000000").s().p("AsoMpQlOlPgBnaQABnYFOlQQFQlPHYABQHZgBFPFPQFQFQgBHYQABHalQFPQlPFOnZABQnYgBlQlOg");
	this.shape.setTransform(-7.5,34.5);
...
p.nominalBounds = new cjs.Rectangle(-149,-106,320.4,277.6);
...
if (reversed == null) { reversed = false; }
	...
	this.shape_1.setTransform(13.775,16.475);
...
if (reversed == null) { reversed = false; }
	...
	this.instance_2.setTransform(650.1,404.3,1,1,0,0,0,694.1,416.3);
	this.instance_2.filters = [new cjs.BlurFilter(10, 10, 3)];
	this.instance_2.cache(-2,-2,1392,837);
...
p.nominalBounds = new cjs.Rectangle(-446,-231.8,1808,1143.9);
// library properties:
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/index_atlas_1.png?1776305103066", id:"index_atlas_1"},
		{src:"sounds/CORNETAPERDIO.mp3?1776305103202", id:"CORNETAPERDIO"},
		{src:"sounds/CORNETAUNAVEZ.mp3?1776305103202", id:"CORNETAUNAVEZ"},
		{src:"https://code.jquery.com/jquery-3.4.1.min.js?1776305103202", id:"lib/jquery-3.4.1.min.js"},
		{src:"components/sdk/anwidget.js?1776305103202", id:"sdk/anwidget.js"},
		{src:"components/video/src/video.js?1776305103202", id:"an.Video"}
	],
	preloads: []
};
