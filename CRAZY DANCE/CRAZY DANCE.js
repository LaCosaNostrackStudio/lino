...
lib.ssMetadata = [
		{name:"CRAZY DANCE_atlas_", frames: [[0,0,1920,1080],[1401,1407,82,82],[1810,1225,164,40],[1401,1337,206,68],[1401,1225,407,58],[1401,1082,523,141],[0,1082,1399,802],[1401,1285,470,50]]}
];
...
(lib.bgrekrea2022dance = function() {
	this.spriteSheet = ss["CRAZY DANCE_atlas_"];
	this.gotoAndStop(0);
...
(lib.Symbol48 = function(mode,startPosition,loop) {
	...
	// Layer 2
	this.shape = new cjs.Shape();
	this.shape.graphics.f("#0099FF").s().p("");
	this.shape.setTransform(79.6,65.8);

	this.shape_1 = new cjs.Shape();
	this.shape_1.graphics.f("#000066").s().p("");
	this.shape_1.setTransform(79.6,65.8);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.shape_1},{t:this.shape}]}).wait(1));

}).prototype = getMCSymbolPrototype(lib.Symbol48, new cjs.Rectangle(0.2,0,159,131.6), null);
...
(lib.Symbol48_1 = function(mode,startPosition,loop) {
	...
	this.shape_2.graphics.f("#FF6600").s().p("EhR1A89MAAAh55MCjrAAAMAAAB55g");
	this.shape_2.setTransform(523.8,390.1);
...
(lib.Symbol12_1 = function(mode,startPosition,loop) {
	...
	this.shape_1 = new cjs.Shape();
	this.shape_1.graphics.f("#FF6600").s().p("AoYLrQhWgygahhIjVsZQgahiAxhXQAzhXBhgaIQSkYQBhgZBXAxQBXAzAaBiIDVMZQAaBhgyBXQgyBXhiAbIwREXQghAIggAAQg+AAg6ghg");
	this.shape_1.setTransform(7,24.5);

	this.shape_2 = new cjs.Shape();
	this.shape_2.graphics.f("#FF66CC").s().p("AD1MsIvimhQhdgngnhdQglhdAnhdIE9r1QAnhdBdgnQBdgmBdAnIPjGhQBdAnAlBcQAnBegoBdIk9L1QgnBehdAlQgvATguAAQgvAAgugTg");
	this.shape_2.setTransform(7,24.5);

	this.shape_3 = new cjs.Shape();
	this.shape_3.graphics.f("#33FF00").s().p("AoYLrQhWgygahhIjVsZQgahiAxhXQAzhXBhgaIQSkYQBhgZBXAxQBXAzAaBiIDVMZQAaBhgyBXQgyBXhiAbIwREXQghAIggAAQg+AAg6ghg");
	this.shape_3.setTransform(7,24.5);

	this.shape_4 = new cjs.Shape();
	this.shape_4.graphics.f("#33FFFF").s().p("AFgMEIwRkXQhhgbgzhXQgyhXAahhIDVsZQAahiBWgyQBYgyBhAaIQSEXQBhAaAyBXQAyBXgaBhIjUMZQgaBihXAyQg6Ahg+AAQggAAghgIg");
	this.shape_4.setTransform(7,24.5);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.shape_1},{t:this.instance}]}).to({state:[{t:this.shape_2},{t:this.instance}]},1).to({state:[{t:this.shape_3},{t:this.instance}]},1).to({state:[{t:this.shape_4},{t:this.instance}]},1).wait(1));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(-102.6,-53.6,274,156.1);
...
(lib.Symbol2 = function(mode,startPosition,loop) {
	...
	this.instance_1.parent = this;
	this.instance_1.setTransform(518.3,129.7,1.149,0.724,0,0,0,523.8,390);
...
// stage content:
(lib.CRAZYDANCE = function(mode,startPosition,loop) {
	this.initialize(mode,startPosition,loop,{});
	...
	this.bt10.setTransform(1085.4,427.5,0.986,0.986,0,0,0,-0.2,0.1);

	this.bt9 = new lib.Symbol12_1();
	this.bt9.parent = this;
	this.bt9.setTransform(745.3,494.3,0.888,0.888,0,0,0,0,0.3);

	this.bt8 = new lib.Symbol12_1();
	this.bt8.parent = this;
	this.bt8.setTransform(436.9,410.8,1.06,1.06,0,0,0,-0.1,0.1);

	this.bt7 = new lib.Symbol12_1();
	this.bt7.parent = this;
	this.bt7.setTransform(184.2,423.8,0.767,0.767,0,0,0,2.5,25.7);

	this.bt6 = new lib.Symbol12_1();
	this.bt6.parent = this;
	this.bt6.setTransform(1090.5,146.5,0.772,0.772);

	this.bt5 = new lib.Symbol12_1();
	this.bt5.parent = this;
	this.bt5.setTransform(926.4,269.9,0.821,0.821,0,0,0,-0.1,0.2);

	this.bt4 = new lib.Symbol12_1();
	this.bt4.parent = this;
	this.bt4.setTransform(709.5,211.9,0.886,0.886,0,0,0,0,0.3);

	this.bt3 = new lib.Symbol12_1();
	this.bt3.parent = this;
	this.bt3.setTransform(539.2,87.2,1.061,1.061,0,0,0,-0.1,0.1);

	this.bt2 = new lib.Symbol12_1();
	this.bt2.parent = this;
	this.bt2.setTransform(398.3,230,0.906,0.906);

	this.bt1 = new lib.Symbol12_1();
	this.bt1.parent = this;
	this.bt1.setTransform(236.7,92.6,0.868,0.868,0,0,0,-0.1,0.1);
	...
	// Layer 3
	this.instance_1 = new lib.bgrekrea2022dance();
	this.instance_1.parent = this;
...
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/CRAZY DANCE_atlas_.png?1652905188195", id:"CRAZY DANCE_atlas_"},
		{src:"sounds/CORNETAPERDIO.mp3?1652905188271", id:"CORNETAPERDIO"},
		{src:"sounds/CORNETAUNAVEZ.mp3?1652905188271", id:"CORNETAUNAVEZ"},
		{src:"https://code.jquery.com/jquery-2.2.4.min.js?1652905188271", id:"lib/jquery-2.2.4.min.js"},
		{src:"components/sdk/anwidget.js?1652905188271", id:"sdk/anwidget.js"},
		{src:"components/video/src/video.js?1652905188271", id:"an.Video"}
	],
	preloads: []
};
