...
lib.ssMetadata = [
		{name:"Bg_Baby_Shower_atlas_", frames: [[0,1886,1280,720],[1448,1956,82,82],[1448,2040,164,40],[1282,1886,206,68],[0,2608,772,620],[774,2608,263,287],[1039,2608,407,58],[774,2897,523,141],[0,1082,1399,802],[1039,2668,470,50],[0,0,1920,1080]]}
];
...
(lib.BgBabyShower_1 = function() {
	this.spriteSheet = ss["Bg_Baby_Shower_atlas_"];
	this.gotoAndStop(0);
...
(lib.Symbol12_1 = function(mode,startPosition,loop) {
	...
	this.shape_2.setTransform(-38,-81.9);
	...
	this.shape_3.setTransform(3.3,13.1);

	this.instance_1 = new lib.Bitmap48();
	this.instance_1.parent = this;
	this.instance_1.setTransform(-59,69,0.453,0.453);
	...
	this.instance_2.parent = this;
	this.instance_2.setTransform(3.9,39.5,1,1,0,0,0,79.5,78.9);
...
// stage content:
(lib.BgBabyShower = function(mode,startPosition,loop) {
	this.initialize(mode,startPosition,loop,{});
	...
	this.bt12.setTransform(1179.4,508.9,0.915,0.915,0,0,0,-0.1,0.1);

	this.bt11 = new lib.Symbol12_1();
	this.bt11.parent = this;
	this.bt11.setTransform(960.4,509.1,0.999,0.999,0,0,0,-0.3,0.1);
	...
	this.bt10.setTransform(746.8,510.4,0.986,0.986,0,0,0,-0.2,0.1);

	this.bt9 = new lib.Symbol12_1();
	this.bt9.parent = this;
	this.bt9.setTransform(1173.7,239.7,0.952,0.952,0,0,0,0.1,0.3);

	this.bt8 = new lib.Symbol12_1();
	this.bt8.parent = this;
	this.bt8.setTransform(950.1,239.5,0.924,0.924,0,0,0,-0.1,0.1);

	this.bt7 = new lib.Symbol12_1();
	this.bt7.parent = this;
	this.bt7.setTransform(743.6,265.8,0.93,0.93,0,0,0,2.6,25.8);

	this.bt6 = new lib.Symbol12_1();
	this.bt6.parent = this;
	this.bt6.setTransform(521.2,395.8,0.896,0.896,0,0,0,0.1,0.1);

	this.bt5 = new lib.Symbol12_1();
	this.bt5.parent = this;
	this.bt5.setTransform(309.6,396.8,0.913,0.913,0,0,0,-0.1,0.3);

	this.bt4 = new lib.Symbol12_1();
	this.bt4.parent = this;
	this.bt4.setTransform(97.8,393.7,0.886,0.886,0,0,0,0,0.3);

	this.bt3 = new lib.Symbol12_1();
	this.bt3.parent = this;
	this.bt3.setTransform(531.5,128,0.884,0.884,0,0,0,-0.3,0.1);

	this.bt2 = new lib.Symbol12_1();
	this.bt2.parent = this;
	this.bt2.setTransform(301.7,125.7,0.906,0.906,0,0,0,-0.1,0.1);

	this.bt1 = new lib.Symbol12_1();
	this.bt1.parent = this;
	this.bt1.setTransform(107,129.6,0.868,0.868,0,0,0,-0.1,0.1);
...
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/Bg_Baby_Shower_atlas_.png?1654211842970", id:"Bg_Baby_Shower_atlas_"},
		{src:"sounds/CORNETAPERDIO.mp3?1654211843043", id:"CORNETAPERDIO"},
		{src:"sounds/CORNETAUNAVEZ.mp3?1654211843043", id:"CORNETAUNAVEZ"},
		{src:"https://code.jquery.com/jquery-2.2.4.min.js?1654211843043", id:"lib/jquery-2.2.4.min.js"},
		{src:"components/sdk/anwidget.js?1654211843043", id:"sdk/anwidget.js"},
		{src:"components/video/src/video.js?1654211843043", id:"an.Video"}
	],
	preloads: []
};
