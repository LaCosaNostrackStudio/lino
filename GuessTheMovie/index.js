...
lib.ssMetadata = [
		{name:"index_atlas_1", frames: [[0,0,1000,1500],[1527,594,82,82],[1527,678,164,40],[1204,789,206,68],[1002,887,407,58],[1002,594,523,141],[0,1502,1399,802],[1204,737,470,50],[1002,0,740,592],[1002,737,200,148]]}
];
...
if (reversed == null) { reversed = false; }
	...
	this.etiketa = new cjs.Text("", "bold 72px 'Arial Black'", "#FF0000");
	...
	// Layer 4
	this.instance = new lib.imagePhotoroom87();
	this.instance.setTransform(-169,-128,0.5682,0.5682);
...
p.nominalBounds = new cjs.Rectangle(-169,-128,420.5,336.4);
...
if (reversed == null) { reversed = false; }
	...
	// Layer 3
	this.instance_2 = new lib._2149876006();
	this.instance_2.setTransform(-66,912,1,1,-90);
...
p.nominalBounds = new cjs.Rectangle(-463.4,-231.8,1897.4,1143.9);
// library properties:
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/index_atlas_1.png?1779405727583", id:"index_atlas_1"},
		{src:"sounds/CORNETAPERDIO.mp3?1779405727692", id:"CORNETAPERDIO"},
		{src:"sounds/CORNETAUNAVEZ.mp3?1779405727692", id:"CORNETAUNAVEZ"},
		{src:"https://code.jquery.com/jquery-3.4.1.min.js?1779405727692", id:"lib/jquery-3.4.1.min.js"},
		{src:"components/sdk/anwidget.js?1779405727692", id:"sdk/anwidget.js"},
		{src:"components/video/src/video.js?1779405727692", id:"an.Video"}
	],
	preloads: []
};
