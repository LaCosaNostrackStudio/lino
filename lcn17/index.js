...
lib.ssMetadata = [
		{name:"index_atlas_", frames: [[1584,941,231,201],[758,683,229,227],[808,1157,291,112],[1191,1066,248,174],[1650,1144,163,172],[1441,1144,207,198],[0,0,1119,681],[1917,0,117,365],[808,941,381,214],[1121,632,794,307],[394,917,412,240],[394,1229,379,12],[0,683,756,232],[1191,941,391,123],[394,1159,154,68],[1817,941,192,221],[0,917,392,425],[2036,0,12,39],[989,683,103,54],[1917,367,128,128],[1121,0,794,630],[1917,497,128,128],[1917,627,128,128]]}
];
...
}).prototype = getMCSymbolPrototype(lib.Symbol161, new cjs.Rectangle(-52,-27,103,54), null);
...
(lib.Symbol159 = function(mode,startPosition,loop) {
	...
	this.timeline.addTween(cjs.Tween.get(this.instance).wait(1).to({scaleX:0.02,scaleY:0.03,rotation:129,x:0.1,y:-63.1},13).to({_off:true},1).wait(2));
...
(lib.Symbol155 = function(mode,startPosition,loop) {
	...
	this.shape = new cjs.Shape();
	this.shape.graphics.bf(cjs.SpriteSheetUtils.extractFrame(ss["index_atlas_"],20), null, new cjs.Matrix2D(1,0,0,1,-784.2,-629.7)).s().p("AhhADIAAgFIDDAAIAAAFg");
	this.shape.setTransform(784.2,942.6);

	this.shape_1 = new cjs.Shape();
	this.shape_1.graphics.bf(cjs.SpriteSheetUtils.extractFrame(ss["index_atlas_"],20), null, new cjs.Matrix2D(1,0,0,1,-397,-315)).s().p("Eg+BAxOIAAgKUA8gAAFA8gAAAIAAAFgEAtYgxJIAAgEIQqAAIAAAFIwqgBg");
	this.shape_1.setTransform(397,590);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.shape_1},{t:this.shape},{t:this.disparo},{t:this.nave},{t:this.mivar},{t:this.btl},{t:this.btr}]}).wait(1));

}).prototype = getMCSymbolPrototype(lib.Symbol155, new cjs.Rectangle(0,275,2032.2,745.6), null);
...
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/index_atlas_.png?1659132282348", id:"index_atlas_"}
	],
	preloads: []
};
