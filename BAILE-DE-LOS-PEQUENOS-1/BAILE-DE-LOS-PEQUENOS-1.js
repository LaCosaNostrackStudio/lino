...
lib.ssMetadata = [
		{name:"BAILE_DE_LOS_PEQUENOS_1_atlas_", frames: [[0,0,1920,1080],[1401,1407,82,82],[1810,1225,164,40],[1401,1337,206,68],[1401,1225,407,58],[1401,1082,523,141],[0,1082,1399,802],[1401,1285,470,50]]}
];
...
(lib.bgrekrea2022 = function() {
	this.spriteSheet = ss["BAILE_DE_LOS_PEQUENOS_1_atlas_"];
	this.gotoAndStop(0);
...
// stage content:
(lib.BAILEDELOSPEQUENOS1 = function(mode,startPosition,loop) {
	this.initialize(mode,startPosition,loop,{});
	...
	this.bt10.setTransform(1081.6,497.7,0.986,0.986,0,0,0,-0.2,0.1);

	this.bt9 = new lib.Symbol12_1();
	this.bt9.parent = this;
	this.bt9.setTransform(723.9,507.9,0.888,0.888,0,0,0,0,0.3);

	this.bt8 = new lib.Symbol12_1();
	this.bt8.parent = this;
	this.bt8.setTransform(462.4,465.9,1.06,1.06,0,0,0,-0.1,0.1);

	this.bt7 = new lib.Symbol12_1();
	this.bt7.parent = this;
	this.bt7.setTransform(211.7,423.8,0.767,0.767,0,0,0,2.5,25.7);

	this.bt6 = new lib.Symbol12_1();
	this.bt6.parent = this;
	this.bt6.setTransform(1193.7,135,0.772,0.772);

	this.bt5 = new lib.Symbol12_1();
	this.bt5.parent = this;
	this.bt5.setTransform(1007,112.8,0.821,0.821,0,0,0,-0.1,0.2);

	this.bt4 = new lib.Symbol12_1();
	this.bt4.parent = this;
	this.bt4.setTransform(761.6,228.7,0.886,0.886,0,0,0,0,0.3);

	this.bt3 = new lib.Symbol12_1();
	this.bt3.parent = this;
	this.bt3.setTransform(592.3,103.4,0.767,0.767,0,0,0,-0.2,0);

	this.bt2 = new lib.Symbol12_1();
	this.bt2.parent = this;
	this.bt2.setTransform(460.7,260.8,0.734,0.734,0,0,0,-0.1,0);

	this.bt1 = new lib.Symbol12_1();
	this.bt1.parent = this;
	this.bt1.setTransform(236.7,143.6,0.868,0.868,0,0,0,-0.1,0.1);
...
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/BAILE_DE_LOS_PEQUENOS_1_atlas_.png?1654198123913", id:"BAILE_DE_LOS_PEQUENOS_1_atlas_"},
		{src:"sounds/CORNETAPERDIO.mp3?1654198123995", id:"CORNETAPERDIO"},
		{src:"sounds/CORNETAUNAVEZ.mp3?1654198123995", id:"CORNETAUNAVEZ"},
		{src:"https://code.jquery.com/jquery-2.2.4.min.js?1654198123995", id:"lib/jquery-2.2.4.min.js"},
		{src:"components/sdk/anwidget.js?1654198123995", id:"sdk/anwidget.js"},
		{src:"components/video/src/video.js?1654198123995", id:"an.Video"}
	],
	preloads: []
};
