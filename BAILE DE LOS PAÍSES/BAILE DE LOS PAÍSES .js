...
lib.ssMetadata = [
		{name:"BAILE DE LOS PAÍSES _atlas_", frames: [[0,0,1920,1080],[1401,1407,82,82],[1810,1225,164,40],[1401,1337,206,68],[1401,1225,407,58],[1401,1082,523,141],[0,1082,1399,802],[1401,1285,470,50]]}
];
...
(lib.bgrekrea2022banderas = function() {
	this.spriteSheet = ss["BAILE DE LOS PAÍSES _atlas_"];
	this.gotoAndStop(0);
...
(lib.Symbol48 = function(mode,startPosition,loop) {
	...
	// Layer 4
	this.shape = new cjs.Shape();
	this.shape.graphics.lf(["#FFFFFF","#94C7F5","#FFFFFF","#D7ADF7","#FFFFFF"],[0,0.247,0.494,0.784,1],-98.4,0,98.5,0).s().p("AvYICIAAxYQGXDpH0ieQHyieI0BTIAARYQmihapCCPQj2A8jTAAQkiAAjihxg");
	this.shape.setTransform(79.3,65.5);

	this.timeline.addTween(cjs.Tween.get(this.shape).wait(1));

}).prototype = getMCSymbolPrototype(lib.Symbol48, new cjs.Rectangle(-19.1,2.8,197,125.5), null);
...
(lib.Symbol12_1 = function(mode,startPosition,loop) {
	...
	this.etiketa = new cjs.Text("", "55px 'Impact'", "#660099");
	...
	this.etiketa.setTransform(6.2,-11.6,1.777,1.246);
	...
	this.shape_1 = new cjs.Shape();
	this.shape_1.graphics.f("#33CCFF").s().p("AvYICIAAxYQGXDpH0ieQHyieI0BTIAARYQmihapCCPQj2A8jTAAQkiAAjihxg");
	this.shape_1.setTransform(11.9,33.6);

	this.shape_2 = new cjs.Shape();
	this.shape_2.graphics.f("#CC33CC").s().p("AvYICIAAxYQGXDpH0ieQHyieI0BTIAARYQmihapCCPQj2A8jTAAQkiAAjihxg");
	this.shape_2.setTransform(11.9,33.6);

	this.shape_3 = new cjs.Shape();
	this.shape_3.graphics.f("#66CC00").s().p("AvYICIAAxYQGXDpH0ieQHyieI0BTIAARYQmihapCCPQj2A8jTAAQkiAAjihxg");
	this.shape_3.setTransform(11.9,33.6);

	this.shape_4 = new cjs.Shape();
	this.shape_4.graphics.f("#FFFF33").s().p("AvYICIAAxYQGXDpH0ieQHyieI0BTIAARYQmihapCCPQj2A8jTAAQkiAAjihxg");
	this.shape_4.setTransform(11.9,33.6);
...
p.nominalBounds = new cjs.Rectangle(-102.6,-36.6,274,133);
...
// stage content:
(lib.BAILEDELOSPAÍSES = function(mode,startPosition,loop) {
	this.initialize(mode,startPosition,loop,{});
	...
	this.bt13.setTransform(1091.3,483.9,0.984,0.984,0,0,0,-0.1,0);

	this.bt12 = new lib.Symbol12_1();
	this.bt12.parent = this;
	this.bt12.setTransform(858.9,417.1,0.974,0.974,0,0,0,-0.1,0.1);

	this.bt11 = new lib.Symbol12_1();
	this.bt11.parent = this;
	this.bt11.setTransform(648.2,488.1,0.942,0.942,0,0,0,-0.2,0.1);
	...
	this.bt10.setTransform(425.3,445.1,0.986,0.986,0,0,0,-0.2,0.1);

	this.bt9 = new lib.Symbol12_1();
	this.bt9.parent = this;
	this.bt9.setTransform(192.2,425.6,0.888,0.888,0,0,0,0,0.3);

	this.bt8 = new lib.Symbol12_1();
	this.bt8.parent = this;
	this.bt8.setTransform(1017.6,246.9,1.06,1.06,0,0,0,-0.1,0.1);

	this.bt7 = new lib.Symbol12_1();
	this.bt7.parent = this;
	this.bt7.setTransform(709.4,287.5,0.767,0.767,0,0,0,2.5,25.7);

	this.bt6 = new lib.Symbol12_1();
	this.bt6.parent = this;
	this.bt6.setTransform(466.4,274.4,0.772,0.772);

	this.bt5 = new lib.Symbol12_1();
	this.bt5.parent = this;
	this.bt5.setTransform(203.5,269.9,0.821,0.821,0,0,0,-0.1,0.2);

	this.bt4 = new lib.Symbol12_1();
	this.bt4.parent = this;
	this.bt4.setTransform(915.4,94.2,0.886,0.886,0,0,0,0,0.3);

	this.bt3 = new lib.Symbol12_1();
	this.bt3.parent = this;
	this.bt3.setTransform(646.8,92.2,1.061,1.061,0,0,0,-0.1,0.1);

	this.bt2 = new lib.Symbol12_1();
	this.bt2.parent = this;
	this.bt2.setTransform(398.3,144.8,0.906,0.906);

	this.bt1 = new lib.Symbol12_1();
	this.bt1.parent = this;
	this.bt1.setTransform(179.4,95.7,0.868,0.868,0,0,0,-0.1,0.1);
	...
	// Layer 3
	this.instance_1 = new lib.bgrekrea2022banderas();
	this.instance_1.parent = this;
...
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/BAILE DE LOS PAÍSES _atlas_.png?1652906264038", id:"BAILE DE LOS PAÍSES _atlas_"},
		{src:"sounds/CORNETAPERDIO.mp3?1652906264116", id:"CORNETAPERDIO"},
		{src:"sounds/CORNETAUNAVEZ.mp3?1652906264116", id:"CORNETAUNAVEZ"},
		{src:"https://code.jquery.com/jquery-2.2.4.min.js?1652906264116", id:"lib/jquery-2.2.4.min.js"},
		{src:"components/sdk/anwidget.js?1652906264116", id:"sdk/anwidget.js"},
		{src:"components/video/src/video.js?1652906264116", id:"an.Video"}
	],
	preloads: []
};
