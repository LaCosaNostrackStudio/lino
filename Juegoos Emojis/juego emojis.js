...
lib.ssMetadata = [
		{name:"juego emojis_atlas_", frames: [[1401,1407,82,82],[1810,1225,164,40],[1401,1337,206,68],[1401,1225,407,58],[1401,1082,523,141],[0,1082,1399,802],[1401,1285,470,50],[0,0,1920,1080]]}
];
...
(lib.Bitmap10 = function() {
	this.spriteSheet = ss["juego emojis_atlas_"];
	this.gotoAndStop(0);
...
(lib.EditableBAILEDELOSEMOJISRecreaUsa = function() {
	this.spriteSheet = ss["juego emojis_atlas_"];
	this.gotoAndStop(7);
}).prototype = p = new cjs.Sprite();
// helper functions:
...
(lib.Symbol48 = function(mode,startPosition,loop) {
	...
	this.shape.graphics.f("#FFFFFF").s().p("Asbq2QABheBdAAIV7AAQBeAAAABeIAARnQAABdheAAI0JAAIjQEHg");
	this.shape.setTransform(79.6,78.9);

	this.timeline.addTween(cjs.Tween.get(this.shape).wait(1));

}).prototype = getMCSymbolPrototype(lib.Symbol48, new cjs.Rectangle(0,0,159.1,157.8), null);
...
(lib.Symbol12_1 = function(mode,startPosition,loop) {
	...
	this.etiketa = new cjs.Text("", "55px 'Impact'", "#FF6600");
	...
	this.shape_1 = new cjs.Shape();
	this.shape_1.graphics.f("#0099FF").s().p("Asaq2QAAheBdAAIV7AAQBdAAAABeIAARnQAABdhdAAI0JAAIjPEHg");
	this.shape_1.setTransform(14.9,30.5);

	this.shape_2 = new cjs.Shape();
	this.shape_2.graphics.f("#FF3300").s().p("Asaq2QAAheBdAAIV7AAQBdAAAABeIAARnQAABdhdAAI0JAAIjPEHg");
	this.shape_2.setTransform(14.9,30.5);

	this.shape_3 = new cjs.Shape();
	this.shape_3.graphics.f("#00CC00").s().p("Asaq2QAAheBdAAIV7AAQBdAAAABeIAARnQAABdhdAAI0JAAIjPEHg");
	this.shape_3.setTransform(14.9,30.5);

	this.shape_4 = new cjs.Shape();
	this.shape_4.graphics.f("#FF33CC").s().p("Asaq2QAAheBdAAIV7AAQBdAAAABeIAARnQAABdhdAAI0JAAIjPEHg");
	this.shape_4.setTransform(14.9,30.5);
...
p.nominalBounds = new cjs.Rectangle(-102.6,-48.4,274,166.8);
...
// stage content:
(lib.juegoemojis = function(mode,startPosition,loop) {
	this.initialize(mode,startPosition,loop,{});
	...
	this.bt10.setTransform(1144.4,427.5,0.986,0.986,0,0,0,-0.2,0.1);

	this.bt9 = new lib.Symbol12_1();
	this.bt9.parent = this;
	this.bt9.setTransform(784.7,509.6,0.888,0.888,0,0,0,0,0.3);

	this.bt8 = new lib.Symbol12_1();
	this.bt8.parent = this;
	this.bt8.setTransform(436.9,465.9,1.06,1.06,0,0,0,-0.1,0.1);
	...
	this.bt6.setTransform(1193.7,117.6,0.772,0.772);

	this.bt5 = new lib.Symbol12_1();
	this.bt5.parent = this;
	this.bt5.setTransform(973.6,269.9,0.821,0.821,0,0,0,-0.1,0.2);

	this.bt4 = new lib.Symbol12_1();
	this.bt4.parent = this;
	this.bt4.setTransform(761.6,211.1,0.886,0.886,0,0,0,0,0.3);
	...
	this.bt2.setTransform(398.2,203.5,0.734,0.734,0,0,0,-0.1,0);
	...
	// Layer 3
	this.instance_3 = new lib.EditableBAILEDELOSEMOJISRecreaUsa();
	this.instance_3.parent = this;
...
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/juego emojis_atlas_.png?1652708996598", id:"juego emojis_atlas_"},
		{src:"sounds/CORNETAPERDIO.mp3?1652708996670", id:"CORNETAPERDIO"},
		{src:"sounds/CORNETAUNAVEZ.mp3?1652708996670", id:"CORNETAUNAVEZ"},
		{src:"https://code.jquery.com/jquery-2.2.4.min.js?1652708996670", id:"lib/jquery-2.2.4.min.js"},
		{src:"components/sdk/anwidget.js?1652708996670", id:"sdk/anwidget.js"},
		{src:"components/video/src/video.js?1652708996670", id:"an.Video"}
	],
	preloads: []
};
