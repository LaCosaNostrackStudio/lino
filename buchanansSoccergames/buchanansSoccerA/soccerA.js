...
lib.ssMetadata = [
		{name:"soccerA_atlas_1", frames: [[0,804,1280,720],[1490,1007,82,82],[1282,1077,164,40],[1282,1007,206,68],[1743,947,203,179],[1282,947,407,58],[1282,804,523,141],[0,0,1399,802],[1282,1128,470,50],[0,1526,1741,233]]}
];
...
if (reversed == null) { reversed = false; }
	...
	// Layer 3
	this.instance_1 = new lib.buchananslogo();
	this.instance_1.setTransform(534,650,0.1232,0.1232);

	this.instance_2 = new lib.BackgroundSoccer1RecreaUsa();
	this.instance_2.setTransform(-117,-5,1.1833,1.1833);
...
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/soccerA_atlas_1.png?1757350360160", id:"soccerA_atlas_1"},
		{src:"sounds/CORNETAPERDIO.mp3?1757350360276", id:"CORNETAPERDIO"},
		{src:"sounds/CORNETAUNAVEZ.mp3?1757350360276", id:"CORNETAUNAVEZ"},
		{src:"https://code.jquery.com/jquery-3.4.1.min.js?1757350360276", id:"lib/jquery-3.4.1.min.js"},
		{src:"components/sdk/anwidget.js?1757350360276", id:"sdk/anwidget.js"},
		{src:"components/video/src/video.js?1757350360276", id:"an.Video"}
	],
	preloads: []
};
