...
lib.ssMetadata = [
		{name:"index_atlas_1", frames: [[1401,1082,1280,720],[2696,182,82,82],[3105,0,164,40],[2696,112,206,68],[1922,0,772,620],[1922,622,263,287],[2696,0,407,58],[2187,622,523,141],[0,1082,1399,802],[2696,60,470,50],[0,0,1920,1080]]}
];
...
if (reversed == null) { reversed = false; }
	...
	this.shape_2.setTransform(69.625,-42.275);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.shape_2},{t:this.shape_1},{t:this.shape}]}).wait(1));

	this._renderFirstFrame();

}).prototype = getMCSymbolPrototype(lib.Symbol48, new cjs.Rectangle(-10.9,-53.2,178.6,197.7), null);
...
if (reversed == null) { reversed = false; }
	...
	this.shape_3.setTransform(523.75,390.05);
...
if (reversed == null) { reversed = false; }
	...
	this.frame_0 = function() {
		...
		if (this.etiketa.text == 7)
			this.gotoAndStop("dos");
		
		if (this.etiketa.text == 8)
			this.gotoAndStop("dos");
		
		if (this.etiketa.text == 9)
			this.gotoAndStop("dos");
		
		if (this.etiketa.text == 10)
			this.gotoAndStop("dos");
		
		if (this.etiketa.text == 11)
			this.gotoAndStop("dos");
		
		if (this.etiketa.text == 12)
			this.gotoAndStop("dos");
	}
	this.frame_1 = function() {
		this.stop();
	...
	this.mivar.setTransform(127.35,13.8);

	this.etiketa = new cjs.Text("", "55px 'Impact'");
	...
	this.etiketa.setTransform(6.2453,-19.6136,1.777,1.2463);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.etiketa},{t:this.mivar}]}).wait(4));

	// Layer 2
	this.instance = new lib.Bitmap47();
	this.instance.setTransform(-83,72,0.241,0.241);

	this.shape_1 = new cjs.Shape();
	this.shape_1.graphics.f().s("#F67095").ss(14,1,1).p("ANkAAQAAFoj+D+Qj+D+loAAQlmAAj/j+Qj+j+AAloQAAlmD+j/QD/j+FmAAQFoAAD+D+QD+D/AAFmg");
	this.shape_1.setTransform(3.3,28.7);

	this.shape_2 = new cjs.Shape();
	this.shape_2.graphics.f().s("#FFFFFF").ss(6.6,1,1).p("AA4AAQAAAVgQAOQgQAPgYAAQgXAAgQgPQgQgOAAgVQAAgTAQgPQAQgPAXAAQAYAAAQAPQAQAPAAATg");
	this.shape_2.setTransform(-38,-81.95);

	this.shape_3 = new cjs.Shape();
	this.shape_3.graphics.f("#FFFFFF").s().p("AplMCQj+j+AAlnQAAlnD+j+QD+j/FnAAQFoAAD9D/QD/D+AAFnQAAFnj/D+Qj9D+loAAQlnAAj+j+gACxtoQgVgFgPgPQgYgWAAghQAAggAYgWQAYgWAjAAQAiAAAZAWQAYAWAAAhQAAAggYAWQgZAXgiAAQgMAAgLgDgAnEuRQgQgPgBgVQABgUAQgQQAQgOAXAAQAZAAAQAOQAQAQABAUQgBAVgQAPQgQAOgZAAQgXAAgQgOg");
	this.shape_3.setTransform(3.3,13.05);

	this.instance_1 = new lib.Bitmap48();
	this.instance_1.setTransform(-59,69,0.4533,0.4533);

	this.shape_4 = new cjs.Shape();
	this.shape_4.graphics.f().s("#00CCFF").ss(14,1,1).p("ANkAAQAAFoj+D+Qj+D+loAAQlmAAj/j+Qj+j+AAloQAAlmD+j/QD/j+FmAAQFoAAD+D+QD+D/AAFmg");
	this.shape_4.setTransform(3.3,28.7);

	this.shape_5 = new cjs.Shape();
	this.shape_5.graphics.f("#FFFFFF").s().p("AplJmQj+j+AAloQAAlmD+j/QD+j+FnAAQFoAAD9D+QD/D/AAFmQAAFoj/D+Qj9D+loAAQlnAAj+j+g");
	this.shape_5.setTransform(3.3,28.7);

	this.instance_2 = new lib.Symbol48();
	this.instance_2.setTransform(3.85,39.5,1,1,0,0,0,79.5,78.9);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.shape_3},{t:this.shape_2},{t:this.shape_1},{t:this.instance}]}).to({state:[{t:this.shape_5},{t:this.shape_4},{t:this.instance_1}]},1).to({state:[{t:this.instance_2}]},1).to({state:[{t:this.instance_2}]},1).wait(1));

	// Layer 3
	this.shape_6 = new cjs.Shape();
	this.shape_6.graphics.f("#CCFF00").s().p("AsWKEQiLqrCLqJQMahPMnBPQBiKbhiKZQmEBVmRAAQmPAAmdhVg");
	this.shape_6.setTransform(12.1,22.1875);

	this.shape_7 = new cjs.Shape();
	this.shape_7.graphics.f("#FF00F0").s().p("AsWKEQiLqrCLqJQMahPMnBPQBiKbhiKZQmEBVmRAAQmPAAmdhVg");
	this.shape_7.setTransform(12.1,22.1875);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[]}).to({state:[{t:this.shape_6}]},2).to({state:[{t:this.shape_7}]},1).wait(1));

	this._renderFirstFrame();

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(-102.6,-92.6,274,314);
...
if (reversed == null) { reversed = false; }
	...
	props.mode = mode;
	props.startPosition = startPosition;
	props.labels = {ini:0,ini2:1,resetear:7};
	props.loop = loop;
	props.reversed = reversed;
	cjs.MovieClip.apply(this,[props]);
	...
	this.miruta2.setTransform(1011.95,564.4);
	...
	this.timeline.addTween(cjs.Tween.get(this.movieClip_3).wait(5).to({scaleX:2.4462,scaleY:1.8859,x:14.25,y:-177.3},1).to({y:-801.3},1).wait(1));
	...
	this.instance_1.setTransform(530.6,129.65,1.1494,0.7243,0,0,0,523.8,390);
	this.instance_1.alpha = 0.0117;
	new cjs.ButtonHelper(this.instance_1, 0, 1, 1);

	this.instance_2 = new lib.Symbol24();
	this.instance_2.setTransform(500.55,105);
...
p.nominalBounds = new cjs.Rectangle(-380.4,-802,1513,1422);
...
// stage content:
(lib.BgBabyShower = function(mode,startPosition,loop,reversed) {
if (loop == null) { loop = true; }
if (reversed == null) { reversed = false; }
	var props = new Object();
	props.mode = mode;
	...
	this.bt21.name = "bt21";
	this.bt21.setTransform(-813.25,1014.05,0.7672,0.7672,0,0,0,-0.2,0.1);

	this.bt22 = new lib.Symbol12_1();
	this.bt22.name = "bt22";
	this.bt22.setTransform(-677.2,1024.7,0.6654,0.6654,0,0,0,-0.2,0.1);

	this.bt24 = new lib.Symbol12_1();
	this.bt24.name = "bt24";
	this.bt24.setTransform(-328,1014.05,0.7672,0.7672,0,0,0,-0.2,0.1);

	this.bt25 = new lib.Symbol12_1();
	this.bt25.name = "bt25";
	this.bt25.setTransform(-124.8,1005.35,0.9497,0.9497,0,0,0,-0.2,0.1);

	this.bt23 = new lib.Symbol12_1();
	this.bt23.name = "bt23";
	this.bt23.setTransform(-500.55,1027.9,0.7336,0.7336,0,0,0,-0.1,0);

	this.bt20 = new lib.Symbol12_1();
	this.bt20.name = "bt20";
	this.bt20.setTransform(-93.5,797.15,0.7672,0.7672,0,0,0,-0.2,0.1);

	this.bt19 = new lib.Symbol12_1();
	this.bt19.name = "bt19";
	this.bt19.setTransform(-326.85,809.55,0.7672,0.7672,0,0,0,-0.2,0);

	this.bt18 = new lib.Symbol12_1();
	this.bt18.name = "bt18";
	this.bt18.setTransform(-521.35,797.05,0.7672,0.7672,0,0,0,-0.2,0);

	this.bt17 = new lib.Symbol12_1();
	this.bt17.name = "bt17";
	this.bt17.setTransform(-737.85,809.65,0.7672,0.7672,0,0,0,-0.2,0.1);

	this.bt16 = new lib.Symbol12_1();
	this.bt16.name = "bt16";
	this.bt16.setTransform(-905.2,820.3,0.6654,0.6654,0,0,0,-0.2,0.1);

	this.bt15 = new lib.Symbol12_1();
	this.bt15.name = "bt15";
	this.bt15.setTransform(-148.55,666.7,0.7672,0.7672,0,0,0,-0.2,0.1);

	this.bt14 = new lib.Symbol12_1();
	this.bt14.name = "bt14";
	this.bt14.setTransform(-398.9,680.55,0.7672,0.7672,0,0,0,-0.2,0.1);

	this.bt13 = new lib.Symbol12_1();
	this.bt13.name = "bt13";
	this.bt13.setTransform(-595.6,666.6,0.7672,0.7672,0,0,0,-0.2,0);

	this.bt12 = new lib.Symbol12_1();
	this.bt12.name = "bt12";
	this.bt12.setTransform(1179.35,508.9,0.9153,0.9153,0,0,0,-0.1,0.1);

	this.bt11 = new lib.Symbol12_1();
	this.bt11.name = "bt11";
	this.bt11.setTransform(960.45,509.1,0.9989,0.9989,0,0,0,-0.2,0.1);
	...
	this.bt10.name = "bt10";
	this.bt10.setTransform(746.75,510.4,0.9861,0.9861,0,0,0,-0.2,0.1);

	this.bt9 = new lib.Symbol12_1();
	this.bt9.name = "bt9";
	this.bt9.setTransform(1173.65,239.6,0.9515,0.9515,0,0,0,0.1,0.2);

	this.bt8 = new lib.Symbol12_1();
	this.bt8.name = "bt8";
	this.bt8.setTransform(950.1,239.45,0.9238,0.9238,0,0,0,-0.1,0.1);

	this.bt7 = new lib.Symbol12_1();
	this.bt7.name = "bt7";
	this.bt7.setTransform(743.6,265.8,0.9297,0.9297,0,0,0,2.6,25.8);

	this.bt6 = new lib.Symbol12_1();
	this.bt6.name = "bt6";
	this.bt6.setTransform(521.15,395.8,0.8965,0.8965,0,0,0,0.1,0.1);

	this.bt5 = new lib.Symbol12_1();
	this.bt5.name = "bt5";
	this.bt5.setTransform(309.6,396.7,0.9132,0.9132,0,0,0,-0.1,0.2);

	this.bt4 = new lib.Symbol12_1();
	this.bt4.name = "bt4";
	this.bt4.setTransform(97.75,393.65,0.8855,0.8855,0,0,0,0,0.3);

	this.bt3 = new lib.Symbol12_1();
	this.bt3.name = "bt3";
	this.bt3.setTransform(531.5,127.95,0.8835,0.8835,0,0,0,-0.2,0.1);

	this.bt2 = new lib.Symbol12_1();
	this.bt2.name = "bt2";
	this.bt2.setTransform(301.65,125.65,0.9063,0.9063,0,0,0,-0.1,0.1);

	this.bt1 = new lib.Symbol12_1();
	this.bt1.name = "bt1";
	this.bt1.setTransform(106.95,129.6,0.8676,0.8676,0,0,0,-0.1,0.1);
	...
	// Layer 3
	this.instance_1 = new lib.logorekrea2022();
	this.instance_1.setTransform(28,68,0.632,0.632);

	this.instance_2 = new lib.BgBabyShower_1();
...
p.nominalBounds = new cjs.Rectangle(-333.3,-231.8,1678.1,1447.3);
// library properties:
lib.properties = {
	id: '3AE4F3501416E143A657F1E6270A212A',
	width: 1280,
	height: 720,
	fps: 60,
	color: "#FFFFFF",
	opacity: 1.00,
	manifest: [
		{src:"images/index_atlas_1.png?1776433020202", id:"index_atlas_1"},
		{src:"sounds/CORNETAPERDIO.mp3?1776433020318", id:"CORNETAPERDIO"},
		{src:"sounds/CORNETAUNAVEZ.mp3?1776433020318", id:"CORNETAUNAVEZ"},
		{src:"https://code.jquery.com/jquery-3.4.1.min.js?1776433020318", id:"lib/jquery-3.4.1.min.js"},
		{src:"components/sdk/anwidget.js?1776433020318", id:"sdk/anwidget.js"},
		{src:"components/video/src/video.js?1776433020318", id:"an.Video"}
	],
	preloads: []
};
...
an.compositions['3AE4F3501416E143A657F1E6270A212A'] = {
