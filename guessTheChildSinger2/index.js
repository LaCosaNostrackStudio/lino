...
lib.ssMetadata = [
		{name:"index_atlas_1", frames: [[1893,112,82,82],[1726,324,164,40],[1726,254,206,68],[1559,112,165,140],[1726,112,165,140],[1559,254,165,140],[1559,0,407,58],[1401,1611,523,141],[0,1040,1399,802],[1559,60,470,50],[1401,1040,569,569],[0,0,1557,1038]]}
];
...
if (reversed == null) { reversed = false; }
	...
	this.etiketa = new cjs.Text("", "bold 35px 'Arial Black'", "#0000FF");
	this.etiketa.name = "etiketa";
	this.etiketa.textAlign = "center";
	this.etiketa.lineHeight = 51;
	this.etiketa.lineWidth = 119;
	this.etiketa.parent = this;
	this.etiketa.setTransform(15.0453,11.6932,1.777,1.6799);
	this.etiketa.shadow = new cjs.Shadow("rgba(0,0,0,1)",3,3,0);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.etiketa},{t:this.mivar}]}).wait(4));

	// Layer 2
	this.instance = new lib.Mapadebits1();
	this.instance.setTransform(-148,-124,0.5831,0.5831);

	this.instance_1 = new lib.Bitmap24();
	this.instance_1.setTransform(-71,-32);

	this.shape = new cjs.Shape();
	this.shape.graphics.f("#35CCC5").s().p("An8NEIngs5IH9tOIPZAAIHjM+IoFNJgAs3AFIGPKzINBAAIGiqnImkrTIsnAAg");
	this.shape.setTransform(11.4,38.7);

	this.shape_1 = new cjs.Shape();
	this.shape_1.graphics.f("#FFF7F7").s().p("AowOVIoQuSIImuXIRTAAIIIObIo9OOgAvaAIIHgM6IPUAAIIFtJInjs+IvZAAg");
	this.shape_1.setTransform(11.2,38.925);

	this.instance_2 = new lib.Bitmap23();
	this.instance_2.setTransform(-71,-32);

	this.shape_2 = new cjs.Shape();
	this.shape_2.graphics.f("#CB6798").s().p("An8NEIngs5IH9tOIPZAAIHjM+IoFNJgAs3AFIGPKzINBAAIGiqnImkrTIsnAAg");
	this.shape_2.setTransform(11.4,38.7);

	this.instance_3 = new lib.Bitmap25();
	this.instance_3.setTransform(-71,-32);

	this.shape_3 = new cjs.Shape();
	this.shape_3.graphics.f("#FFCF32").s().p("An8NEIngs5IH9tOIPZAAIHjM+IoFNJgAs3AFIGPKzINBAAIGiqnImkrTIsnAAg");
	this.shape_3.setTransform(11.4,38.7);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.instance}]}).to({state:[{t:this.shape_1},{t:this.shape},{t:this.instance_1}]},1).to({state:[{t:this.shape_1},{t:this.shape_2},{t:this.instance_2}]},1).to({state:[{t:this.shape_1},{t:this.shape_3},{t:this.instance_3}]},1).wait(1));

	this._renderFirstFrame();

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(-148,-124,331.8,331.8);
...
if (reversed == null) { reversed = false; }
	...
	this.shape_4.graphics.f().s("#000000").ss(12.1,1,1).p("ACKClIkTAAIAAlJ");
	this.shape_4.setTransform(13.775,16.475);
...
// stage content:
(lib.AdivinaQuienEsChicos = function(mode,startPosition,loop,reversed) {
if (loop == null) { loop = true; }
if (reversed == null) { reversed = false; }
	var props = new Object();
	props.mode = mode;
	...
	this.instance_1.setTransform(511,662);
	...
	this.bt15.name = "bt15";
	this.bt15.setTransform(-525,-12.05,0.8676,0.8676,0,0,0,-0.1,0.1);

	this.bt14 = new lib.Symbol12();
	this.bt14.name = "bt14";
	this.bt14.setTransform(-744.4,-12.05,0.8676,0.8676,0,0,0,-0.1,0.1);

	this.bt13 = new lib.Symbol12();
	this.bt13.name = "bt13";
	this.bt13.setTransform(-940.35,-12.05,0.8676,0.8676,0,0,0,-0.1,0.1);

	this.bt12 = new lib.Symbol12();
	this.bt12.name = "bt12";
	this.bt12.setTransform(1016.7,539.8,0.8676,0.8676,0,0,0,-0.1,0.1);

	this.bt11 = new lib.Symbol12();
	this.bt11.name = "bt11";
	this.bt11.setTransform(770.6,520.05,0.8676,0.8676,0,0,0,-0.1,0.1);

	this.bt10 = new lib.Symbol12();
	this.bt10.name = "bt10";
	this.bt10.setTransform(483.35,520.05,0.8676,0.8676,0,0,0,-0.1,0.1);

	this.bt9 = new lib.Symbol12();
	this.bt9.name = "bt9";
	this.bt9.setTransform(232.3,520.05,0.8676,0.8676,0,0,0,-0.1,0.1);

	this.bt8 = new lib.Symbol12();
	this.bt8.name = "bt8";
	this.bt8.setTransform(1028.15,309.5,0.8676,0.8676,0,0,0,-0.1,0.1);

	this.bt7 = new lib.Symbol12();
	this.bt7.name = "bt7";
	this.bt7.setTransform(770.6,309.5,0.8676,0.8676,0,0,0,-0.1,0.1);

	this.bt6 = new lib.Symbol12();
	this.bt6.name = "bt6";
	this.bt6.setTransform(497.9,309.5,0.8676,0.8676,0,0,0,-0.1,0.1);

	this.bt5 = new lib.Symbol12();
	this.bt5.name = "bt5";
	this.bt5.setTransform(240.5,309.5,0.8676,0.8676,0,0,0,-0.1,0.1);

	this.bt4 = new lib.Symbol12();
	this.bt4.name = "bt4";
	this.bt4.setTransform(1033.75,97.6,0.8676,0.8676,0,0,0,-0.1,0.1);

	this.bt3 = new lib.Symbol12();
	this.bt3.name = "bt3";
	this.bt3.setTransform(770.6,97.6,0.8676,0.8676,0,0,0,-0.1,0.1);

	this.bt2 = new lib.Symbol12();
	this.bt2.name = "bt2";
	this.bt2.setTransform(497.9,97.6,0.8676,0.8676,0,0,0,-0.1,0.1);
	...
	this.bt1.name = "bt1";
	this.bt1.setTransform(247.95,97.6,0.8676,0.8676,0,0,0,-0.1,0.1);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.fsbtn}]}).to({state:[{t:this.bt1},{t:this.reini},{t:this.btfull},{t:this.bt2},{t:this.bt3},{t:this.bt4},{t:this.bt5},{t:this.bt6},{t:this.bt7},{t:this.bt8},{t:this.bt9},{t:this.bt10},{t:this.bt11},{t:this.bt12},{t:this.bt13},{t:this.bt14},{t:this.bt15},{t:this.bt16},{t:this.bt17},{t:this.bt18},{t:this.bt19},{t:this.bt20},{t:this.bt21},{t:this.bt22},{t:this.bt23},{t:this.bt24},{t:this.bt25},{t:this.myMC}]},1).wait(1));

	// Layer 3
	this.instance_2 = new lib.Mapadebits2();
	this.instance_2.setTransform(-16,-54,0.8442,0.7726);
...
p.nominalBounds = new cjs.Rectangle(-445.2,-231.8,1790,1143.9);
// library properties:
lib.properties = {
	id: '2219771A21F86E489D24EE1E3AE74D01',
	width: 1280,
	height: 720,
	fps: 60,
	color: "#FFFFFF",
	opacity: 1.00,
	manifest: [
		{src:"images/index_atlas_1.png?1776435392037", id:"index_atlas_1"},
		{src:"sounds/CORNETAPERDIO.mp3?1776435392144", id:"CORNETAPERDIO"},
		{src:"sounds/CORNETAUNAVEZ.mp3?1776435392144", id:"CORNETAUNAVEZ"},
		{src:"https://code.jquery.com/jquery-3.4.1.min.js?1776435392144", id:"lib/jquery-3.4.1.min.js"},
		{src:"components/sdk/anwidget.js?1776435392144", id:"sdk/anwidget.js"},
		{src:"components/video/src/video.js?1776435392144", id:"an.Video"}
	],
	preloads: []
};
...
an.compositions['2219771A21F86E489D24EE1E3AE74D01'] = {
