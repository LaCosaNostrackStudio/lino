...
lib.ssMetadata = [
		{name:"index_atlas_", frames: [[1753,861,231,201],[1753,632,229,227],[1555,1475,291,112],[796,935,248,174],[1848,1475,163,172],[1346,1376,207,198],[0,0,1119,681],[1917,0,117,365],[1566,1134,381,214],[0,683,794,307],[1152,1134,412,240],[130,1478,379,12],[0,992,756,232],[1566,1350,391,123],[1753,1064,154,68],[1152,1376,192,221],[758,1134,392,425],[2036,0,12,39],[1917,367,128,128],[796,683,315,250],[1121,0,794,630],[0,1226,315,250],[317,1226,315,250],[1121,632,630,500],[1917,497,128,128],[0,1478,128,128]]}
];
...
(lib.Symbol162 = function(mode,startPosition,loop) {
	...
	// Layer 1
	this.shape = new cjs.Shape();
	this.shape.graphics.f().s("#000000").ss(0.1,1,1).p("AlGlUIKNAAIAAKpIqNAAg");

	this.shape_1 = new cjs.Shape();
	this.shape_1.graphics.f("#CC57FB").s().p("AlGFUIAAqnIKNAAIAAKng");

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.shape_1},{t:this.shape}]}).wait(1));

}).prototype = getMCSymbolPrototype(lib.Symbol162, new cjs.Rectangle(-33.6,-35,67.3,70.1), null);
...
(lib.Symbol161 = function(mode,startPosition,loop) {
	...
	// Layer 1
	this.shape = new cjs.Shape();
	this.shape.graphics.f().s("#000000").ss(0.1,1,1).p("");

	this.shape_1 = new cjs.Shape();
	this.shape_1.graphics.f("#FFC91D").s().p("ABBEBIAAhKIBGAAIAABKgAh/D/IAAhIIBIAAIAABIgAnBCHIAAhFIBHAAIAABFgACHB/IkGAAIg4AAIAAg9IF5AAIAAA9gAF/B/IAAg9IBDAAIAAA9gADCBCIAAkDIl5AAIAAg/IF5AAIAAA/IBAAAIAABGIAAA+IAAA7IAABEgADCBCgAj3BCIAAhEIAAg6IAAg/IAAhGIBAAAIAAEDg");
	this.shape_1.setTransform(-0.3,0);

	this.shape_2 = new cjs.Shape();
	this.shape_2.graphics.f("#FFFFFF").s().p("AA8AgIAAg+IBGAAIAAA+gAiBAgIAAg+IBLAAIAAA+g");
	this.shape_2.setTransform(-0.1,-9.6);

	this.shape_3 = new cjs.Shape();
	this.shape_3.graphics.f("#280936").s().p("AA8AeIAAg7IBGAAIAAA7gAiBAeIAAg7IBLAAIAAA7g");
	this.shape_3.setTransform(-0.1,-3.5);

	this.shape_4 = new cjs.Shape();
	this.shape_4.graphics.f("#FF33CC").s().p("Ai8CCIAAkDIF5AAIAAEDgAA5AAIAAA6IBGAAIAAg6IAAg/IhGAAgAiDAAIAAA6IBLAAIAAg6IAAg/IhLAAg");
	this.shape_4.setTransform(0.2,-6.4);

	this.shape_5 = new cjs.Shape();
	this.shape_5.graphics.f("#CC57FB").s().p("ACEDaIAAg4IA7AAIAAA4gAi7DaIAAg4IA5AAIAAA4gAD/BlIAAhFIB9AAIAABFgAl9BlIAAhFICCAAIAABFgAl9gZIAAg/Ih8AAIAAh+IA/AAIAAA5IA9AAIAAg5IBBAAIAAB+IBBAAIAAA/gAD/gaIAAg+IA/AAIAAiBIA+AAIAAA9IBAAAIAAg9IA+AAIAACBIh+AAIAAA+g");
	this.shape_5.setTransform(0,-3.5);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.shape_5},{t:this.shape_4},{t:this.shape_3},{t:this.shape_2},{t:this.shape_1},{t:this.shape}]}).wait(1));

}).prototype = getMCSymbolPrototype(lib.Symbol161, new cjs.Rectangle(-51.6,-26.7,103.3,53.5), null);
...
(lib.Symbol160 = function(mode,startPosition,loop) {
	...
	// Layer 1
	this.shape = new cjs.Shape();
	this.shape.graphics.f("#66CC00").s().p("Ak9D0IAAnnIJ7AAIAAHng");

	this.timeline.addTween(cjs.Tween.get(this.shape).wait(1));

}).prototype = getMCSymbolPrototype(lib.Symbol160, new cjs.Rectangle(-31.7,-24.3,63.5,48.7), null);
...
(lib.Symbol154 = function(mode,startPosition,loop) {
	...
	this.instance.parent = this;
	this.instance.setTransform(0,0,0.431,0.431);
...
(lib.Symbol138 = function(mode,startPosition,loop) {
	...
	// Layer 1
	this.shape = new cjs.Shape();
	this.shape.graphics.f().s("#5E197B").ss(45.4,1,1).p("AnNi8IHNnOIABABIHNHNAABqJIghUT");
...
(lib.Symbol159 = function(mode,startPosition,loop) {
	this.initialize(mode,startPosition,loop,{muerto:15});
	...
	this.frame_0 = function() {
		...
		function update(evt)
		{
		var pt = this.localToLocal (this.sensor.x, 
				this.sensor.y, exportRoot.menu.juego.disparo.disparo.disparo);
		
		
		
			if (exportRoot.menu.juego.disparo.disparo.disparo.hitTest(pt.x , pt.y))
			{
	...
	// actions tween:
	this.timeline.addTween(cjs.Tween.get(this).call(this.frame_0).wait(15).call(this.frame_15).wait(1).call(this.frame_16).wait(1));

	// Layer 2
	this.sensor = new lib.Symbol160();
	this.sensor.parent = this;
	this.sensor.setTransform(0.3,-0.6,2.181,1.622,0,0,0,0.1,0);
	this.sensor.alpha = 0.012;

	this.timeline.addTween(cjs.Tween.get(this.sensor).to({_off:true},1).wait(16));

	// Layer 1
	this.shape = new cjs.Shape();
	this.shape.graphics.f("#FFC91D").s().p("ABBEBIAAhKIBGAAIAABKgAh/D/IAAhIIBIAAIAABIgAnBCHIAAhFIBHAAIAABFgACHB/IkGAAIg4AAIAAg9IhAAAIAAhEIAAg6IAAg/IAAhGIBAAAIAAEDIF5AAIAAA9gAF/B/IAAg9IBDAAIAAA9gADCBCIAAkDIl5AAIAAg/IF5AAIAAA/IBAAAIAABGIAAA+IAAA7IAABEgADCBCg");
	this.shape.setTransform(-0.3,0);

	this.shape_1 = new cjs.Shape();
	this.shape_1.graphics.f("#FFFFFF").s().p("AA8AgIAAg+IBGAAIAAA+gAiBAgIAAg+IBLAAIAAA+g");
	this.shape_1.setTransform(-0.1,-9.6);

	this.shape_2 = new cjs.Shape();
	this.shape_2.graphics.f("#280936").s().p("AA8AeIAAg7IBGAAIAAA7gAiBAeIAAg7IBLAAIAAA7g");
	this.shape_2.setTransform(-0.1,-3.5);

	this.shape_3 = new cjs.Shape();
	this.shape_3.graphics.f("#FF33CC").s().p("Ai8CCIAAkDIF5AAIAAEDgAA5AAIAAA6IBGAAIAAg6IAAg/IhGAAgAiDAAIAAA6IBLAAIAAg6IAAg/IhLAAg");
	this.shape_3.setTransform(0.2,-6.4);

	this.shape_4 = new cjs.Shape();
	this.shape_4.graphics.f("#CC57FB").s().p("ACEDaIAAg4IA7AAIAAA4gAi7DaIAAg4IA5AAIAAA4gAD/BlIAAhFIB9AAIAABFgAl9BlIAAhFICCAAIAABFgAl9gZIAAg/Ih8AAIAAh+IA/AAIAAA5IA9AAIAAg5IBBAAIAAB+IBBAAIAAA/gAD/gaIAAg+IA/AAIAAiBIA+AAIAAA9IBAAAIAAg9IA+AAIAACBIh+AAIAAA+g");
	...
	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.shape_4},{t:this.shape_3},{t:this.shape_2},{t:this.shape_1},{t:this.shape}]}).to({state:[{t:this.instance}]},1).to({state:[{t:this.instance}]},13).to({state:[]},1).wait(2));
	this.timeline.addTween(cjs.Tween.get(this.instance).wait(1).to({_off:false},0).to({scaleX:0.02,scaleY:0.03,rotation:129,x:0.1,y:-63.1},13).to({_off:true},1).wait(2));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(-69.1,-40.1,138.5,79);
...
(lib.Symbol3 = function(mode,startPosition,loop) {
	...
	this.disparo = new lib.Symbol162();
	this.disparo.parent = this;
	this.disparo.setTransform(0.3,-2.8);
	this.disparo.alpha = 0.012;

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.disparo},{t:this.instance}]}).wait(1));

}).prototype = getMCSymbolPrototype(lib.Symbol3, new cjs.Rectangle(-32.4,-36.9,65.4,68.2), null);
...
(lib.Symbol2 = function(mode,startPosition,loop) {
	...
	// Layer 2
	this.disparo = new lib.Symbol3();
	this.disparo.parent = this;

	this.timeline.addTween(cjs.Tween.get(this.disparo).to({y:-340},42).to({_off:true},1).wait(1));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(-32.4,-36.9,65.4,68.2);
...
(lib.Symbol155 = function(mode,startPosition,loop) {
	...
	this.frame_0 = function() {
		...
		//////////////////////////////////////
		this.btr.on("mousedown", onMouseDownr.bind(this));
		this.btr.on("pressmove", onMouseMover.bind(this));
		this.btr.on("pressup", onMouseUpr.bind(this));
			...
			document.addEventListener("keydown", hacer1 => 
		{
		   ...
		   if(hacer1.keyCode == 37){
		      this.mivar.text = "1";
		   }
		   
		   if(hacer1.keyCode == 39){
		      this.mivar.text = "2";
		   }
		...
		document.addEventListener("keyup", hacer2 => 
		{
		   ...
		   if(hacer2.keyCode == 37){
		      this.mivar.text = "0";
		   }
		   if(hacer2.keyCode == 39){
		      this.mivar.text = "0";
		   }
		}
	...
	this.instance.parent = this;
	this.instance.setTransform(1090,526,0.793,0.793);

	this.instance_1 = new lib.Symbol159();
	this.instance_1.parent = this;
	this.instance_1.setTransform(1225.7,526,0.793,0.793);

	this.instance_2 = new lib.Symbol159();
	this.instance_2.parent = this;
	this.instance_2.setTransform(1371.9,526,0.793,0.793);

	this.instance_3 = new lib.Symbol159();
	this.instance_3.parent = this;
	this.instance_3.setTransform(1507.6,526,0.793,0.793);

	this.instance_4 = new lib.Symbol159();
	this.instance_4.parent = this;
	this.instance_4.setTransform(1649.9,526,0.793,0.793);

	this.instance_5 = new lib.Symbol159();
	this.instance_5.parent = this;
	this.instance_5.setTransform(1785.7,526,0.793,0.793);

	this.instance_6 = new lib.Symbol159();
	this.instance_6.parent = this;
	this.instance_6.setTransform(1858.6,443,0.793,0.793);

	this.instance_7 = new lib.Symbol159();
	this.instance_7.parent = this;
	this.instance_7.setTransform(1028.9,443,0.793,0.793);

	this.instance_8 = new lib.Symbol159();
	this.instance_8.parent = this;
	this.instance_8.setTransform(1157,443,0.793,0.793);

	this.instance_9 = new lib.Symbol159();
	this.instance_9.parent = this;
	this.instance_9.setTransform(1303.2,443,0.793,0.793);

	this.instance_10 = new lib.Symbol159();
	this.instance_10.parent = this;
	this.instance_10.setTransform(1438.9,443,0.793,0.793);

	this.instance_11 = new lib.Symbol159();
	this.instance_11.parent = this;
	this.instance_11.setTransform(1581.2,443,0.793,0.793);

	this.instance_12 = new lib.Symbol159();
	this.instance_12.parent = this;
	this.instance_12.setTransform(1717,443,0.793,0.793);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.instance_12},{t:this.instance_11},{t:this.instance_10},{t:this.instance_9},{t:this.instance_8},{t:this.instance_7},{t:this.instance_6},{t:this.instance_5},{t:this.instance_4},{t:this.instance_3},{t:this.instance_2},{t:this.instance_1},{t:this.instance}]}).wait(1));

	// Layer 1
	this.btr = new lib.Symbol156();
	this.btr.parent = this;
	this.btr.setTransform(1529.6,973,0.224,0.224,0,0,180,196,212.5);

	this.btl = new lib.Symbol156();
	this.btl.parent = this;
	this.btl.setTransform(1322.7,973,0.224,0.224,0,0,0,196,212.5);

	this.mivar = new cjs.Text("", "39px 'Arial'", "#FF0000");
	this.mivar.name = "mivar";
	this.mivar.textAlign = "center";
	this.mivar.lineHeight = 46;
	this.mivar.lineWidth = 73;
	this.mivar.parent = this;
	this.mivar.setTransform(1993.8,322.3);

	this.instance_13 = new lib.Bitmap89();
	this.instance_13.parent = this;
	this.instance_13.setTransform(-373,180);

	this.instance_14 = new lib.Bitmap88();
	this.instance_14.parent = this;
	this.instance_14.setTransform(139,-55);

	this.instance_15 = new lib.Bitmap86();
	this.instance_15.parent = this;
	this.instance_15.setTransform(2356,195);

	this.nave = new lib.Symbol154();
	this.nave.parent = this;
	this.nave.setTransform(1425.3,844.3,1,1,0,0,0,41.4,47.6);

	this.instance_16 = new lib.Bitmap83();
	this.instance_16.parent = this;
	this.instance_16.setTransform(2356,482);

	this.text = new cjs.Text("La industria de los videojuegos es el sector económico involucrado en el desarrollo, la distribución, la mercadotecnia, la venta de videojuegos y del hardware asociado.", "19px 'Dogica Pixel'", "#65327C");
	this.text.lineHeight = 21;
	this.text.lineWidth = 467;
	this.text.parent = this;
	this.text.setTransform(998.1,209.5);

	this.disparo = new lib.Symbol2();
	this.disparo.parent = this;
	this.disparo.setTransform(1425.2,789.3);

	this.shape = new cjs.Shape();
	this.shape.graphics.f("#65327C").s().p("");
	this.shape.setTransform(1234.4,270.5);

	this.shape_1 = new cjs.Shape();
	this.shape_1.graphics.bf(cjs.SpriteSheetUtils.extractFrame(ss["index_atlas_"],20), null, new cjs.Matrix2D(1,0,0,1,-784.2,-629.7)).s().p("AhhADIAAgFIDDAAIAAAFg");
	this.shape_1.setTransform(784.2,942.6);

	this.shape_2 = new cjs.Shape();
	this.shape_2.graphics.bf(cjs.SpriteSheetUtils.extractFrame(ss["index_atlas_"],20), null, new cjs.Matrix2D(1,0,0,1,-397,-315)).s().p("Eg+BAxOIAAgKUA8gAAFA8gAAAIAAAFgEAtYgxJIAAgEIQqAAIAAAFIwqgBg");
	this.shape_2.setTransform(397,590);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.shape_2},{t:this.shape_1},{t:this.shape},{t:this.disparo},{t:this.text},{t:this.instance_16},{t:this.nave},{t:this.instance_15},{t:this.instance_14},{t:this.instance_13},{t:this.mivar},{t:this.btl},{t:this.btr}]}).wait(1));

}).prototype = getMCSymbolPrototype(lib.Symbol155, new cjs.Rectangle(-373,-55,3044,1075.6), null);
...
// stage content:
(lib.index5 = function(mode,startPosition,loop) {
	this.initialize(mode,startPosition,loop,{});
...
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/index_atlas_.png?1659130709069", id:"index_atlas_"}
	],
	preloads: []
};
